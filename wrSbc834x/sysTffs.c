...
--------------------
01g,07aug09,my_  undef INCLUDE_TFFS_BOOT_IMAEG_PUT by default (WIND00118762)
01f,05aug09,my_  Modified tffs format parameter (WIND00133437)
01e,06apr07,l_z  Remove priority setting code in sysTffsFormat(). (WIND00066633)
01d,13feb07,y_w  Fix the boot failure error after calling sysTffsFormat() 
                 (CQ:WIND0062975)
01c,10aug05,j_b  include local cfiscs.c; clean up warnings
01b,28jun05,j_b  fix TFFS address range out of reset configuration word and
                 boot image area
01a,07feb05,dtr  created from ads8540
*/
...
#undef  INCLUDE_TFFS_BOOT_IMAGE /* Do not support tffsBootImagePut() by default, see also target.ref */
...
*
* RETURNS: flOK, or flTooManyComponents if there are too many drives
*
* ERRNO
*/
...
void flDelayLoop
    ...
    )
    {
      ...
      for (counter = 0; counter < (cycles *10); counter++)
      WRS_ASM("nop");
    }
...
STATUS sysTffsFormat (void)
    ...
    {
    {0x20000l, 99, 1, 0x10000l, NULL, {0,0,0,0}, NULL, 2, 0, NULL},
