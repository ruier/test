...
--------------------
01b,10dec09,x_z  code clean.
01a,06may08,z_l  created, routines are derived from version 01d
                 of ads834x/sysTffs.c.
*/
...
STATUS sysTffsFormat (void)
    ...
    {S29GL_RESERVED_SIZE, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2, 0, NULL},
