/* sysALib.s - PPC750CL Evaluation Board system-dependent assembly routines */
...
--------------------
01a,17may07,jjm  Initial version, based on IBM 750GX/GL EVB BSP, added max
                 pipeline depth configuration for 750CL processor
*/
...
ifpdrValue:
	...
	cmpli	0, 0, r28, CPU_TYPE_750CL
	bne	cpuIs750

	/* set max bus pipeline depth */
	mfspr	r3,1011		/* HID4 */
	oris	r3,r3,0x1000	/* BPD = 4 */
	isync
	mtspr	1011,r3		/* HID4 */
	isync
...
*
* NOTE:  
* The Tsi110 host bridge causes machine check exceptions to
