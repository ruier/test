...
/* mux methods */
 ...
 void	teiMuxConnect (VXB_DEVICE_ID, void *);
...
#error IPCOM_MAX_FORWARDERS is too large.
   ...
   /* pDrvCtrl->teiAddr[0] = core.tei_addr[0];
	...
	pDrvCtrl->teiAddr[2] = 0x22;
	pDrvCtrl->teiAddr[3] = 0x44;
	pDrvCtrl->teiAddr[4] = 0x66;
	pDrvCtrl->teiAddr[5] = 0x88;
    switch (devId)
        {
...
LOCAL void teiEndInt
    ...
    if (vxAtomicCas (&pDrvCtrl->teiIntPending, FALSE, TRUE))
        {
