#ifndef __RIO_HAL_H__
#define __RIO_HAL_H__

#define RIO_SUCCESS           0
#define RIO_ERR_INVALID_PARM  1
#define RIO_ERR_RESP          2
#define RIO_ERR_ACCESS        3
#define RIO_ERR_RIO           4
#define RIO_ERROR             -1
...
#define RIO_HOP_LOCAL       0xffffffff              					   

#define SRIO_CSR            0x13c
#define SRIO_CSR_M_D        ((1 << 30) | (1 << 29))

#define SPBC_ROUTE_CFG_DESTID	0x00070
#define SPBC_ROUTE_CFG_PORT	    0x00074

#define RIO_EXTENDED_FEATURE_PTR  0x100
#define RIO_ANY_DEV_ID            0xff

#define RIO_SP_LM_REQ(port)      (0x140 + port*0x20)
#define RIO_SP_LM_RESP(port)     (0x144 + port*0x20)
#define RIO_SP_ACKID_STAT(port)  (0x148 + port*0x20)
#define RIO_SP_ERR_STAT(port)    (0x158 + port*0x20)
#define RIO_SP_ERR_CTRL(port)    (0x15C + port*0x20)

#define RIO_SP_CS_TX(port)       (0x13014 + port*0x100)
#define RIO_TSI578_CLK_SEL(port) (0x130c8 + port*0x100)

#define RIO_REQ_MAX_RETRY        10
#define RIO_1848_CTL1_CSR(port)	 		 (0x15c + port*0x20)
#define RIO_1848_PLL_CTL1_REG(pllNum) 	 (0xff0000 + (pllNum)*0x10)
#define RIO_1848_LANE_CTL_REG(laneNum) 	 (0xff8000 + (laneNum)*0x100)
#define RIO_1848_DEVICE_RESET_CTL_REG    (0xf20300)
#define RIO_PORT_SPEED125      0x0      /*1.25Gbps*/
#define RIO_PORT_SPEED25       0x1      /*2.5Gbps*/
#define RIO_PORT_SPEED3125     0x2      /*3.125Gbps*/
#define RIO_PORT_SPEED5        0x3      /*5Gbps*/
#define RIO_PORT_SPEED625      0x4      /*6.25Gbps*/
