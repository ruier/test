...
--------------------
01b,05aug11,swu  Fix annotation error.
01a,08may10,syt  derived from version 01b of fsl_p2020_rdb/usbPciStub.c.
*/
...
void ehci1Init (void)
    {
    /* set GPIO7 at high level to select USB2 */

    *((VUINT32 *)GPDIR) |= USB_PORT_EN;
    *((VUINT32 *)GPDAT) |= USB_PORT_EN;
    ...
    *(volatile UINT32 *)EHCI_SNOOP1(USB2_BASE) = (LOCAL_MEM_LOCAL_ADRS + \
                                                  EHCI_SNOOP_SIZE);
