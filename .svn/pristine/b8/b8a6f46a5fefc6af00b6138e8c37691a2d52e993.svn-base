...
--------------------
01a,05sep12,d_l  adapted from fsl_p5020_ds version 01b
*/
...
LOCAL UINT8 glbEnetAddr[MAX_MAC_ADRS][MAC_ADRS_LEN + 1] = {
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_0, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec0 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_1, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec1 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_2, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec2 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_3, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec3 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_4, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec4 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_0, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec5 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_1, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec6 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_2, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec7 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_3, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec8 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_4, CUST_ENET4, CUST_ENET5, 0 }, /* dtsec9 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_5, CUST_ENET4, CUST_ENET5, 0 }, /* tgec0 */
    { WR_ENET0, WR_ENET1, WR_ENET2, CUST_ENET3_5, CUST_ENET4, CUST_ENET5, 0 }  /* tgec1 */
};
...
STATUS sysMacOffsetGet
    ...
    *ppEnet  = (char*)glbEnetAddr[(index * DTSEC_NUM) + ifUnit];
    *pOffset = ((index * DTSEC_NUM) + ifUnit) * (MAC_ADRS_LEN + 1);
