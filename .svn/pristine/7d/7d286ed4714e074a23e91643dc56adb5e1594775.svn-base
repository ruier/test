...
#define BSP_VERSION     "20150909-1533"
...
"dtsec(3,0)host:vxWorks h=192.168.4.252 e=192.168.4.240:0XFFFFFF00 u=5020 pw=5020 f=0x0"
...
#define S29GL_FLASH_SIZE     0x04000000  /* only 8MB used for TrueFFS */
