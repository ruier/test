...
--------------------
01b,17jan12,y_y  changed the Parameter MIPC_SM_SYSTEM_POOL_BASE_PHYS 
                 from 0x40010000 to 0x60010000
01a,24nov11,y_y  adapted from fsl_p5020_ds version 01a
*/
...
Parameter MIPC_SM_SYSTEM_POOL_BASE_PHYS {
    ...
    SYNOPSIS    The base address on the fsl_p3041_ds is at 0x60010000. The \
