...
--------------------
01i,30nov07,x_s  Change to use INCLUDE_MTD_USR macro.
01h,25mar07,x_s  Modified to support amcc_taishan board.
01f,18jan07,b_m  Add Lite5200B TFFS support.
...
#undef TFFS_FORMAT_PRINT           /* print the tffs format process */
...
STATUS sysTffsFormat (void)
    ...
    {
        {0x2000000, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2, 0, NULL},
