/* sysBusPci.c - Tsi108 PCI autoconfig support */
...
/* Interrupt routing for Freescale HPC-II platform */

static UCHAR intLine [][4] =
    {
    /*    IntA          IntB          IntC          IntD   */
    { IRQ_PCI_INTA, IRQ_PCI_INTB, IRQ_PCI_INTC, IRQ_PCI_INTD }, /* SLOT 1 */
    { IRQ_PCI_INTB, IRQ_PCI_INTC, IRQ_PCI_INTD, IRQ_PCI_INTA }, /* SLOT 2 */
    { IRQ_PCI_INTC, IRQ_PCI_INTD, IRQ_PCI_INTA, IRQ_PCI_INTB }, /* SATA */
    { IRQ_PCI_INTD, IRQ_PCI_INTA, IRQ_PCI_INTB, IRQ_PCI_INTC }  /* USB */
    };
...
LOCAL UCHAR sysPciAutoConfigIntAsgn
    ...
    /* This prevents an interrupt being assigned to the Tsi108 bridge */
