...
const char *sysNetDevName[MAX_MAC_DEVS] = {"motfcc"};
/* globals */
...
LOCAL UINT8 glbEnetAddr[MAX_MAC_ADRS][MAC_ADRS_LEN + 1] = {
    {  CUST_ENET5, CUST_ENET4, CUST_ENET3_0, WR_ENET2, WR_ENET1, WR_ENET0, 0},
    {  CUST_ENET5, CUST_ENET4, CUST_ENET3_1, WR_ENET2, WR_ENET1, WR_ENET0, 0}
};
