/* romInit_nand.s - Freescale MPC8313ERDB nand boot initialization module */
...
--------------------
01a,16sep07,l_g  initial creation for nand boot
*/

/*
DESCRIPTION
This module contains the entry code for the nand bootloader.
...
romInit:
	...
	WRITEADR(r6,r7,QUICC_BR0(CCSBAR),0xFFF00C21)
	
	WRITEADR(r6,r7,QUICC_OR0(CCSBAR),0xFFFF8396) 



	WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,0), 0xFFF00000)
	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,0),  0x8000000E)
...
delayddr1:
	...
	lis	r10, HIADJ(0x7fff000)
	addi r10, r10, LO(0x7fff000)
...
/* if return from romStart, loop forever */
trapforever:
      bl trapforever
