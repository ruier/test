/* ads85xx.h - Motorola MPC85xx ADS board header */

/* Copyright 2002-2004,2006 Wind River Systems, Inc. */

/*
modification history
--------------------
01x,08dec06,y_w  Add timer clock divider ratios define, CQ:#63379,#63385
01w,16aug04,dtr  Merge from T2.2.1.
01v,05aug04,dtr  Add support for RevA of ADS board.
01u,09jun04,mil  Added defines for VIRT_ADDR/PHYS_ADDR.
01t,01apr04,dtr  Add defines for branch prediction.
01s,12feb04,dtr  Add new PCI device ID for Bridge.
...
01m,04aug03,dtr  Changing allocation of LAWBAR/LAWAR registers to accomdate
                 LBC SDRAM.
 ...
 * 12-31 Base address - Most significan 20 bits 
 *
 * LAWARx
 * 0   Enable window
 * 1-7 Reserved
