/* romInit.s - Freescale MPC8360 RDK ROM initialization module */
...
--------------------
01b,26dec07,z_l  Initialize floating point regs
01a,15aug07,z_l  Created from mds8360/romInit.s
*/
...
start:
	...
	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,0), (LAWAR_ENABLE | LAWAR_SIZE_8MB ))
...
tlb_write_loop:
	...
	WRITEOFFSET(r6,r7,TIMING_CFG_1, 0x3835a322)
	WRITEOFFSET(r6,r7,TIMING_CFG_2, 0x00104909)
	WRITEOFFSET(r6,r7,DDR_SDRAM_CFG, 0x43000000)
	WRITEOFFSET(r6,r7,DDR_SDRAM_MODE_CFG, 0x47800432)
