/* romInit.s - Freescale MDS8360 and MDS8360EA ROM initialization module */
...
--------------------
01h,07oct09,jc0  Fixed typo (WIND00185237)
01g,29jul08,z_l  Support MDS8360EA.
01f,07jun07,dtr  Initialize floating point regs.
01e,12oct06,dtr  Fix defect 60694.
...
#define WRITEOFFSET(regbase,reg2,offset,val) \
    ...
    .text
/* 
Hard Reset Configuration Word (HRCW) See config.h/mds8360.h/target.ref for 
more info
*/
...
cold:
    ...
    isync            /* synchronize */
#ifdef MPC8360EA_MDS
    WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,1), 0xe0000000)

    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), (LAWAR_ENABLE | LAWAR_SIZE_512MB))
    ...
    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), (LAWAR_ENABLE | LAWAR_SIZE_2GB ))
...
start:
    ...
    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,0), (LAWAR_ENABLE | LAWAR_SIZE_32MB))
    ...
    WRITEADR(r6,r7,QUICC_OR0(CCSBAR),0xFF006FF7) 

    WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,0), ROM_BASE_ADRS)

    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,0), (LAWAR_ENABLE | LAWAR_SIZE_16MB))

    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), 0x00000000)
    WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,1), 0x10000000)    
#endif
        
    WRITEADR(r6,r7, M83XX_SICRL(CCSBAR),0xC0000000)
    isync
...
tlb_write_loop:
    ...
    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,2), (LAWAR_ENABLE | LAWAR_SIZE_64KB))
    
    WRITEADR(r6,r7,QUICC_OR1 (CCSBAR), 0xffffe9f7)

    /* load BR2 */
    WRITEADR(r6,r7,QUICC_BR1 (CCSBAR), (BCSR_BASE_ADRS & 0xffff0000) | 0x801)

    isync
    sync
    
    /* Make sure flash unprotected */    
    lis    r6, HIADJ (BCSR10)    
    lbz    r5, LO(BCSR10)(r6)    
    andi.   r5, r5, 0xfb
    stb     r5, LO(BCSR10)(r6)
    ...
    WRITEADR(r6,r7,M83XX_DDRLAWBARn(CCSBAR,0), DDR_SDRAM_LOCAL_ADRS)
     
    WRITEADR(r6,r7,M83XX_DDRLAWARn(CCSBAR,0), LAWAR_ENABLE | LAWAR_SIZE_256MB) 
    nop
    nop
    nop
    nop
    ...
    WRITEOFFSET(r6,r7,CS0_CONFIG, 0x80330102)
    ...
    WRITEOFFSET(r6,r7,DDR_SDRAM_MODE_CFG, 0x07940432)
    ...
    WRITEOFFSET(r6,r7,(CS1_BNDS), 0x0008000f)
    WRITEOFFSET(r6,r7,(CS2_BNDS), 0x00000000)
    WRITEOFFSET(r6,r7,(CS3_BNDS), 0x00000000)
    WRITEOFFSET(r6,r7,(CS0_CONFIG), 0x80000101)
    WRITEOFFSET(r6,r7,(CS1_CONFIG), 0x80000101)
    WRITEOFFSET(r6,r7,(CS2_CONFIG), 0x00000101)
    WRITEOFFSET(r6,r7,(CS3_CONFIG), 0x00000101)     
    WRITEOFFSET(r6,r7,(TIMING_CFG_1), 0x36332321)
    WRITEOFFSET(r6,r7,(TIMING_CFG_2), 0x00000800)
#ifdef USE_32BIT_DDR
    WRITEOFFSET(r6,r7,(DDR_SDRAM_CFG), 0x420c8000)
#else
    WRITEOFFSET(r6,r7,(DDR_SDRAM_CFG), 0x42008000)
#endif /* USE_32BIT_DDR */
    WRITEOFFSET(r6,r7,(DDR_SDRAM_MODE_CFG), 0x00000022)
    WRITEOFFSET(r6,r7,(DDR_SDRAM_INTERVAL), 0x04060100)
    WRITEOFFSET(r6,r7,(DDR_SDRAM_CLK_CNTRL), 0x82000000)
#endif /* MPC8360EA_MDS*/
    lis  r7,0x0004
    mtctr r7
delayddr1:
...
#else  /* MPC8360EA_MDS */
#ifdef USE_32BIT_DDR
     WRITEOFFSET(r6,r7,(DDR_SDRAM_CFG), 0xc20c8000)
#else
...
SdramInit:
    ...
    WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), (LAWAR_ENABLE | LAWAR_SIZE_64MB))
    ...
    WRITEADR(r6,r7,QUICC_BR2 (CCSBAR), \
                     (LBC_SDRAM_LOCAL_ADRS & 0xffff0000) | 0x1861)
