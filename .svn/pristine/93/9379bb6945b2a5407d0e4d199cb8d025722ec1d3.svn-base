...
LOCAL void rmanRxHandle
    ...
    if ((type == RIO_TYPE10) || (type == RIO_TYPE11))
		...
		sid = ibDesc->sid; 
		did = ibDesc->did; 
        /*logMsg("ibDesc = 0x%x..sid = 0x%x..did = 0x%x\n",
			    ibDesc, sid, did, 0, 0, 0);*/
        ...
        bufdesc[0].next = NULL;
        RMAN_LOG(DBG_INTR, "rmanRxHandle():bufdesc[0].buf = 0x%x bufdesc[0].len = 0x%x \r\n",
