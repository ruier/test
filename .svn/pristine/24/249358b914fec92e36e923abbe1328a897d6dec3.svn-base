/* mpc8641.h - Register definitions for mpc8641 Integrated Host Processor */
...
--------------------
01b,29apr08,mdg Corrected issues with LAWBAR macros and diab
...
mpc8641 Integrated Host Processor.  Registers which are in the memory
mapped Command Control and Status Register space have mnemonics which
are prepended with "CCSR_".
*/

#ifndef __INCmpc8641h
#define __INCmpc8641h
...
#define CCSR_LAWBAR8                       0x00D08
#define CCSR_LAWAR8                        0x00D10
#define CCSR_LAWBAR9                       0x00D28
#define CCSR_LAWAR9                        0x00D30

/* MCM Registers */

#define CCSR_MCM_ABCR                      0x01000
#define CCSR_MCM_DBCR                      0x01008
#define CCSR_MCM_PCR                       0x01010
#define CCSR_MCM_REV1                      0x01BF8
#define CCSR_MCM_REV2                      0x01BFC
#define CCSR_MCM_EDR                       0x01E00
#define CCSR_MCM_EER                       0x01E08
#define CCSR_MCM_EATR                      0x01E0C
#define CCSR_MCM_ELADR                     0x01E10
#define CCSR_MCM_EHADR                     0x01E14


/* DDR Memory Controller Memory Map */

#define CCSR_DDR0_BASE          0x02000
#define CCSR_DDR_INCR           0x04000
#define CCSR_DDR_BASE(unit)     (CCSR_DDR0_BASE + (unit) * CCSR_DDR_INCR)

#define CCSR_CS0_BNDS(unit)                (CCSR_DDR_BASE(unit) + 0x0000)
#define CCSR_CS1_BNDS(unit)                (CCSR_DDR_BASE(unit) + 0x0008)
#define CCSR_CS2_BNDS(unit)                (CCSR_DDR_BASE(unit) + 0x0010)
#define CCSR_CS3_BNDS(unit)                (CCSR_DDR_BASE(unit) + 0x0018)
#define CCSR_CS0_CONFIG(unit)              (CCSR_DDR_BASE(unit) + 0x0080)
#define CCSR_CS1_CONFIG(unit)              (CCSR_DDR_BASE(unit) + 0x0084)
#define CCSR_CS2_CONFIG(unit)              (CCSR_DDR_BASE(unit) + 0x0088)
#define CCSR_CS3_CONFIG(unit)              (CCSR_DDR_BASE(unit) + 0x008C)
#define CCSR_TIMING_CFG_3(unit)            (CCSR_DDR_BASE(unit) + 0x0100)
#define CCSR_TIMING_CFG_0(unit)            (CCSR_DDR_BASE(unit) + 0x0104)
#define CCSR_TIMING_CFG_1(unit)            (CCSR_DDR_BASE(unit) + 0x0108)
#define CCSR_TIMING_CFG_2(unit)            (CCSR_DDR_BASE(unit) + 0x010C)
#define CCSR_DDR_SDRAM_CFG(unit)           (CCSR_DDR_BASE(unit) + 0x0110)
#define CCSR_DDR_SDRAM_CFG_2(unit)         (CCSR_DDR_BASE(unit) + 0x0114)
#define CCSR_DDR_SDRAM_MODE(unit)          (CCSR_DDR_BASE(unit) + 0x0118)
#define CCSR_DDR_SDRAM_MODE_2(unit)        (CCSR_DDR_BASE(unit) + 0x011c)
#define CCSR_DDR_SDRAM_MD_CNTL(unit)       (CCSR_DDR_BASE(unit) + 0x0120)
#define CCSR_DDR_SDRAM_INTERVAL(unit)      (CCSR_DDR_BASE(unit) + 0x0124)
#define CCSR_DDR_DATA_INIT(unit)           (CCSR_DDR_BASE(unit) + 0x0128)
#define CCSR_DDR_SDRAM_CLK_CTRL(unit)      (CCSR_DDR_BASE(unit) + 0x0130)
#define CCSR_DDR_INIT_ADDR(unit)           (CCSR_DDR_BASE(unit) + 0x0148)
#define CCSR_DDR_INIT_EXT_ADDR(unit)       (CCSR_DDR_BASE(unit) + 0x014C)
#define CCSR_DDR_DSR1(unit)                (CCSR_DDR_BASE(unit) + 0x0B20)
#define CCSR_DDR_DSR2(unit)                (CCSR_DDR_BASE(unit) + 0x0B24)
#define CCSR_DDR_CDR1(unit)                (CCSR_DDR_BASE(unit) + 0x0B28)
#define CCSR_DDR_CDR2(unit)                (CCSR_DDR_BASE(unit) + 0x0B2C)
#define CCSR_DDR_IP_REV1(unit)             (CCSR_DDR_BASE(unit) + 0x0BF8)
#define CCSR_DDR_IP_REV2(unit)             (CCSR_DDR_BASE(unit) + 0x0BFC)
#define CCSR_DATA_ERR_INJECT_HI(unit)      (CCSR_DDR_BASE(unit) + 0x0E00)
#define CCSR_DATA_ERR_INJECT_LO(unit)      (CCSR_DDR_BASE(unit) + 0x0E04)
#define CCSR_ECC_ERR_INJECT(unit)          (CCSR_DDR_BASE(unit) + 0x0E08)
#define CCSR_CAPTURE_DATA_HI(unit)         (CCSR_DDR_BASE(unit) + 0x0E20)
#define CCSR_CAPTURE_DATA_LO(unit)         (CCSR_DDR_BASE(unit) + 0x0E24)
#define CCSR_CAPTURE_ECC(unit)             (CCSR_DDR_BASE(unit) + 0x0E28)
#define CCSR_ERR_DETECT(unit)              (CCSR_DDR_BASE(unit) + 0x0E40)
#define CCSR_ERR_DISABLE(unit)             (CCSR_DDR_BASE(unit) + 0x0E44)
#define CCSR_ERR_INT_EN(unit)              (CCSR_DDR_BASE(unit) + 0x0E48)
#define CCSR_CAPTURE_ATTRIBUTES(unit)      (CCSR_DDR_BASE(unit) + 0x0E4C)
#define CCSR_CAPTURE_ADDRESS(unit)         (CCSR_DDR_BASE(unit) + 0x0E50)
#define CCSR_DDR_CAPTURE_EXT_ADDRESS(unit) (CCSR_DDR_BASE(unit) + 0x0e54)
#define CCSR_ERR_SBE(unit)                 (CCSR_DDR_BASE(unit) + 0x0E58)

#define CCSR_I2CADR                        0x3000
#define CCSR_I2CFDR                        0x3004
#define CCSR_I2CCR                         0x3008
#define CCSR_I2CSR                         0x300C
#define CCSR_I2CDR                         0x3010
#define CCSR_I2CDFSRR                      0x3014
...
/* PCIE0 Configuration Access Registers */

#define CCSR_PCIE0_CFG_ADDR                0x08000
#define CCSR_PCIE0_CFG_DATA                0x08004


/* PCIE0 ATMU Registers - Outbound and Inbound */

#define CCSR_PCIE0_POTAR0                  0x08C00
#define CCSR_PCIE0_POTEAR0                 0x08C04

/* Note POWBAR0 is read-only (not programmable) */

#define CCSR_PCIE0_POWBAR0                 0x08C08
#define CCSR_PCIE0_POWAR0                  0x08C10

/* Outbound window 1 */

#define CCSR_PCIE0_POTAR1                  0x08C20
#define CCSR_PCIE0_POTEAR1                 0x08C24
#define CCSR_PCIE0_POWBAR1                 0x08C28
#define CCSR_PCIE0_POWAR1                  0x08C30

/* Outbound window 2 */

#define CCSR_PCIE0_POTAR2                  0x08C40
#define CCSR_PCIE0_POTEAR2                 0x08C44
#define CCSR_PCIE0_POWBAR2                 0x08C48
#define CCSR_PCIE0_POWAR2                  0x08C50

/* Outbound window 3 */

#define CCSR_PCIE0_POTAR3                  0x08C60
#define CCSR_PCIE0_POTEAR3                 0x08C64
#define CCSR_PCIE0_POWBAR3                 0x08C68
#define CCSR_PCIE0_POWAR3                  0x08C70

/* Outbound window 4 */

#define CCSR_PCIE0_POTAR4                  0x08C80
#define CCSR_PCIE0_POTEAR4                 0x08C84
#define CCSR_PCIE0_POWBAR4                 0x08C88
#define CCSR_PCIE0_POWAR4                  0x08C90

/* Inbound window 3 */

#define CCSR_PCIE0_PITAR3                  0x08DA0
#define CCSR_PCIE0_PIWBAR3                 0x08DA8
#define CCSR_PCIE0_PIWBEAR3                0x08DAC
#define CCSR_PCIE0_PIWAR3                  0x08DB0

/* Inbound window 2 */

#define CCSR_PCIE0_PITAR2                  0x08DC0
#define CCSR_PCIE0_PIWBAR2                 0x08DC8
#define CCSR_PCIE0_PIWBEAR2                0x08DCC
#define CCSR_PCIE0_PIWAR2                  0x08DD0

/* Inbound window 1 */

#define CCSR_PCIE0_PITAR1                  0x08DE0
#define CCSR_PCIE0_PIWBAR1                 0x08DE8
#define CCSR_PCIE0_PIWAR1                  0x08DF0

/* PCIE0 Error Management Registers */

#define CCSR_PCIE0_ERR_DR                  0x08E00
#define CCSR_PCIE0_ERR_EN                  0x08E08
#define CCSR_PCIE0_ERR_DIS                 0x08E10
#define CCSR_PCIE0_ERR_CAP_STAT            0x08E20
#define CCSR_PCIE0_ERR_CAP_R0              0x08E28
#define CCSR_PCIE0_ERR_CAP_R1              0x08E2C
#define CCSR_PCIE0_ERR_CAP_R2              0x08E30
#define CCSR_PCIE0_ERR_CAP_R3              0x08E34

/* PCIE1 Configuration Access Registers */

#define CCSR_PCIE1_CFG_ADDR                0x09000
#define CCSR_PCIE1_CFG_DATA                0x09004

/* PCIE1 ATMU Registers - Outbound and Inbound */

#define CCSR_PCIE1_POTAR0                  0x09C00
#define CCSR_PCIE1_POTEAR0                 0x09C04

/* Note POWBAR0 is read-only (not programmable) */

#define CCSR_PCIE1_POWBAR0                 0x09C08
#define CCSR_PCIE1_POWAR0                  0x09C10

/* Outbound window 1 */

#define CCSR_PCIE1_POTAR1                  0x09C20
#define CCSR_PCIE1_POTEAR1                 0x09C24
#define CCSR_PCIE1_POWBAR1                 0x09C28
#define CCSR_PCIE1_POWAR1                  0x09C30

/* Outbound window 2 */

#define CCSR_PCIE1_POTAR2                  0x09C40
#define CCSR_PCIE1_POTEAR2                 0x09C44
#define CCSR_PCIE1_POWBAR2                 0x09C48
#define CCSR_PCIE1_POWAR2                  0x09C50

/* Outbound window 3 */

#define CCSR_PCIE1_POTAR3                  0x09C60
#define CCSR_PCIE1_POTEAR3                 0x09C64
#define CCSR_PCIE1_POWBAR3                 0x09C68
#define CCSR_PCIE1_POWAR3                  0x09C70

/* Outbound window 4 */

#define CCSR_PCIE1_POTAR4                  0x09C80
#define CCSR_PCIE1_POTEAR4                 0x09C84
#define CCSR_PCIE1_POWBAR4                 0x09C88
#define CCSR_PCIE1_POWAR4                  0x09C90

/* Inbound window 3 */

#define CCSR_PCIE1_PITAR3                  0x09DA0
#define CCSR_PCIE1_PIWBAR3                 0x09DA8
#define CCSR_PCIE1_PIWBEAR3                0x09DAC
#define CCSR_PCIE1_PIWAR3                  0x09DB0

/* Inbound window 2 */

#define CCSR_PCIE1_PITAR2                  0x09DC0
#define CCSR_PCIE1_PIWBAR2                 0x09DC8
#define CCSR_PCIE1_PIWBEAR2                0x09DCC
#define CCSR_PCIE1_PIWAR2                  0x09DD0

/* Inbound window 1 */

#define CCSR_PCIE1_PITAR1                  0x09DE0
#define CCSR_PCIE1_PIWBAR1                 0x09DE8
#define CCSR_PCIE1_PIWAR1                  0x09DF0

/* PCIE1 Error Management Registers */

#define CCSR_PCIE1_ERR_DR                  0x09E00
#define CCSR_PCIE1_ERR_EN                  0x09E08
#define CCSR_PCIE1_ERR_DIS                 0x09E10
#define CCSR_PCIE1_ERR_CAP_STAT            0x09E20
#define CCSR_PCIE1_ERR_CAP_R0              0x09E28
#define CCSR_PCIE1_ERR_CAP_R1              0x09E2C
#define CCSR_PCIE1_ERR_CAP_R2              0x09E30
#define CCSR_PCIE1_ERR_CAP_R3              0x09E34
...
#define CCSR_PTR(base,reg)          (volatile UINT32 *)(CCSR_ADDR(base,reg))
#define CCSR_PTR08(base,reg)        (volatile UINT8 *)(CCSR_ADDR(base,reg))
...
/* Size of an MCP8641 register */

#define MPC8641_REG_SIZE        4

/*
 * Many of the registers in the MCP8641 are initialized statically via
 * a table-driven procedure.
 *
 * Let's define the table entry discriminators and end marker:
 */

#define MPC8641_INTERNAL        0            /* Mark register as direct access */
#define END_INIT_MPC8641_REG    0xffffffff   /* End of register list */

/* Now define the essentials for direct register write access: */

#define YES_INIT_MPC8641_REG(offset,val)  (MPC8641_INTERNAL),(offset),(val),
#define MPC8641_INTERNAL_INIT_SIZE        3  /* # of elements in above macro */

/*
 * Some of these MPC8641 registers are not initialized at all via the
...
#define NOT_INIT_MPC8641_REG(offset,x)    /* No code for this macro */

/* LAWBAR/LAWAR related */

#define CCSR_LAWBAR_BASE_ADDR_BIT (0)
#define CCSR_LAWBAR_BASE_ADDR_MASK (0xfffff)
#define CCSR_LAWBAR_ADRS_SHIFT (12)
#define CCSR_LAWBAR_BASE_ADDR_ENCODE(x) \
         ((x >> CCSR_LAWBAR_ADRS_SHIFT) & CCSR_LAWBAR_BASE_ADDR_MASK)
#define CCSR_LAWBAR_BASE_ADDR_DECODE(x) (x << CCSR_LAWBAR_ADRS_SHIFT)
...
#define CCSR_LAWAR_TGTIF_VAL_PCIE0    (0 << CCSR_LAWAR_TRGT_IF_BIT)
#define CCSR_LAWAR_TGTIF_VAL_PCIE1    (1 << CCSR_LAWAR_TRGT_IF_BIT)
...
#define CCSR_POWAR_EN_MASK      (1 << CCSR_POWAR_EN_BIT)
...
#define CCSR_PIWAR_EN_MASK      (1 << CCSR_PIWAR_EN_BIT)
#define CCSR_PIWAR_EN_VAL(x)    ((x & CCSR_PIWAR_EN_MASK) >> \
                                 CCSR_PIWAR_EN_BIT)

/*
 * MPC8641_PCI_SIZE_ENCODE takes a power of two number and computes
 * the MCP8641 size encoding value - of the type that would appear
 * in the POWAR1 register.  It's DECODE counterpart does the inverse.
 */

#define MPC8641_PCI_SIZE_ENCODE(x)  (WHAT_2POWER(x) - 1)
#define MPC8641_PCI_SIZE_DECODE(x)  (1 << (x + 1))

/* POR PLL Status Register Related */

#define CCSR_PORPLLSR_E600_RATIO_BIT  (16)
#define CCSR_PORPLLSR_E600_RATIO_MASK (0x3f << CCSR_PORPLLSR_E600_RATIO_BIT)
#define CCSR_PORPLLSR_E600_RATIO_VAL(x) ((x & CCSR_PORPLLSR_E600_RATIO_MASK) \
                      >> CCSR_PORPLLSR_E600_RATIO_BIT)
...
/* POR DEV Status Register Related */

#define CCSR_PORDEVSR_CORE1TE_BIT  (7)
#define CCSR_PORDEVSR_CORE1TE_MASK (1 << CCSR_PORDEVSR_CORE1TE_BIT)
#define CCSR_PORDEVSR_CORE1TE_VAL(x)    ((x & CCSR_PORDEVSR_CORE1TE_MASK) \
                      >> CCSR_PORDEVSR_CORE1TE_BIT)
...
#define MPC8641_DDR_SDRAM_TRAS_DFLT  0xF     /* tRAS default - 15 clocks */
#define MPC8641_DDR_SDRAM_TRP_DFLT   7       /* tRP default - 7 clocks */
#define MPC8641_DDR_SDRAM_TRCD_DFLT  7       /* tRCD default - 7 clocks */
#define MPC8641_DDR_SDRAM_TRRD_DFLT  4       /* tRRD default - 4 clocks */
#define MPC8641_DDR_SDRAM_TCL_DFLT   4       /* tCL default - 2.5 clocks */
#define MPC8641_DDR_SDRAM_TRFC_DFLT  0xF     /* tRFC default - 23 clocks */
