...
--------------------
01l,06apr07,l_z  Remove priority setting code in sysTffsFormat(). (WIND00066633)
01k,22jun05,pcm  removed #include "dosFsLib.h"
01j,29oct04,mdo  Documentation fixes for apigen
...
#else
	{0x000000l, 10, 1, 0x10000l, NULL, {0,0,0,0}, NULL, 2, 0, NULL},
#endif  /* HALF_FORMAT */
