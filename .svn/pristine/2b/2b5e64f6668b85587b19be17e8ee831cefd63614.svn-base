...
--------------------
01d,05mar12,y_y  remove I2C related component for vxBus I2C support.
01c,31jan12,agf  CQ329621: Remove SYSTEM_GLOBALS, superceded by
                 RESERVED_ATOMICS
01b,31jan12,y_y  changed the default RAM_LOW_ADRS of INCLUDE_BOOT_RAM_IMAGE from 
                 0x02000000 to 0x101000000.
01a,19aug11,y_y  created from fsl_p5020_ds 20bsp.cdf version 01d
*/
...
Parameter RAM_HIGH_ADRS {
    ...
    DEFAULT         (INCLUDE_BOOT_RAM_IMAGE)::(0x11000000)  \
                    ...
                    (INCLUDE_AMP_CPU_03)::(0x62000000)      \
                    (INCLUDE_AMP_CPU_02)::(0x52000000)      \
...
Parameter DTSEC3_IN_RGMII  {
    ...
    SYNOPSIS        DTSEC3 on the P3041DS target is configurable based on  \
