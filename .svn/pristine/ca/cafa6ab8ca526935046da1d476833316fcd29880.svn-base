...
IMPORT void ads5121eCpldIntCtlrRegister (void);
    ...
    extern void vxbAhciStorageRegister (void);
#endif /* INCLUDE_DRV_STORAGE_AHCI */


#ifdef INCLUDE_ALT_SOC_GEN5_DW_END
IMPORT void vxbAltSocGen5DwEndRegister (void);
#endif /* INCLUDE_ALT_SOC_GEN5_DW_END */

#ifdef INCLUDE_ALT_SOC_GEN5_DW_I2C
IMPORT void vxbAltSocGen5DwI2cRegister (void);
#endif /* INCLUDE_ALT_SOC_GEN5_DW_I2C */
#ifdef DRV_STORAGE_ALT_SOC_GEN5_DW_MSHC
IMPORT void altSocGen5DwMshcRegister (void);
...
IMPORT void vxbAltSocGen5WdtDrvRegister (void);
#endif /* INCLUDE_ALT_SOC_GEN5_WDT */

IMPORT void vxbAlteraIntCtlrRegister(void);

IMPORT void alteraJtagSioRegister(void);

IMPORT void alteraTimerRegister (void);

IMPORT void alteraTseRegister (void);

IMPORT void altUartSioRegister(void);

#ifdef DRV_I2C_AM35XX
IMPORT void am35xxI2cRegister ();
#endif /* DRV_I2C_AM35XX */

#ifdef DRV_I2C_AM38XX
IMPORT void am38xxI2cRegister ();
...
IMPORT void vxbApmPProMacEndRegister (void);
#endif /* DRV_VXBEND_APM_PPRO_MAC */

#ifdef DRV_APM_PPRO_QMAN
IMPORT void vxbApmPProQmanRegister (void);
#endif /* DRV_APM_PPRO_QMAN */
IMPORT void apmPciExRegister (void);
...
#ifdef DRV_TIMER_ARM_SP804
extern void vxbArmSP804TimerDrvRegister (void);
#endif


IMPORT void at91I2cRegister (void);
IMPORT void at91MciRegister (void);
...
IMPORT void comcertoGemacRegister (void);

IMPORT void comcertoIntCtlrRegister (void);

IMPORT void comcertoPciRegister (void);

IMPORT void comcertoTimerRegister (void);

#ifdef DRV_VXBEND_TI_CPSW
IMPORT void  vxbCpswEndRegister (); 
#endif
...
IMPORT void fslRioRegister (void);
...
#ifdef DRV_I2C_GENERIC_DEV
IMPORT void vxbI2cGenericDevRegister (void);
#endif /* DRV_I2C_GENERIC_DEV */

IMPORT void imRegister(void);

IMPORT void vxbI2cPcfRtcRegister (void);
...
IMPORT void vxbI2cVsc3316Register (void);
#endif /* DRV_I2C_VSC3316 */
...
#ifdef DRV_TIMER_IA_HPET
extern void vxbIaHpetTimerDrvRegister(void);
#endif
...
IMPORT void vxbFwOhciDrvRegister(void);
...
extern void vxbImx51IntCtlrRegister (void);

IMPORT void imxSdmaRegister (void);
...
#ifdef INCLUDE_LSI_MAC_VXB_END
IMPORT void lsiMacVxbEndRegister (void);
#endif /* INCLUDE_LSI_MAC_VXB_END */

#ifdef INCLUDE_LSI_MDIO
#   include "../src/hwif/h/mii/vxbLsiMdio.h"
#endif /* INCLUDE_LSI_MDIO */

IMPORT void lsiPciExRegister (void);

IMPORT void lsiRioRegister (void);

#ifdef DRV_TIMER_LSI
extern void vxbLsiTimerRegister (void);
#endif /* DRV_TIMER_LSI */
...
IMPORT   void vxbMipsCavIntCtlrRegister();
...
#ifdef DRV_INTCTLR_MIPS_XLP
IMPORT void xlpIntCtlrRegister(void); 
#endif /* DRV_INTCTLR_MIPS_XLP */
...
#ifdef DRV_INTCTLR_MPIC
IMPORT void mpicIntCtlrRegister (void);
#endif /* DRV_INTCTLR_MPIC */
...
#include "../src/hwif/h/mii/vxbOcteonMdio.h"
#endif
...
IMPORT void octeonSioRegister(void);
...
#ifdef DRV_GPIO_OMAP35XX
extern void vxbOmap35xxGpioDrvRegister (void);
#endif /* DRV_GPIO_OMAP35XX */

#ifdef DRV_I2C_OMAP35XX
extern void vxbOmap35xxI2cDrvRegister (void);
#endif /* DRV_I2C_OMAP35XX */

#ifdef DRV_INTCTLR_OMAP35XX
extern void vxbOmap35xxIntCtlrRegister (void);
...
#ifdef DRV_I2C_OMAPL13X
IMPORT void omapl13xI2cRegister ();
#endif /* DRV_I2C_OMAPL13X */
...
IMPORT void openPicTimerDrvRegister(void);
    ...
    extern void vxbPiixStorageRegister (void);
#endif /* INCLUDE_DRV_STORAGE_PIIX */


IMPORT void pl330DmaRegister(void);
...
IMPORT void quiccTimer64DrvRegister (void);
...
IMPORT void vxbMemacEndRegister(void);
...
IMPORT void rioCpuRegister (void);

IMPORT void rioGenSwRegister (void);
...
#ifdef DRV_SPI_EEPROM
IMPORT void vxbSpiEepromRegister(void);
#endif /* DRV_SPI_EEPROM */

IMPORT void stmSpear13xxGmacRegister (void);

#ifdef DRV_PCIBUS_SPEAR13XX_EX
IMPORT void spear13xxPcieRegister (void);
#endif /* DRV_PCIBUS_SPEAR13XX_EX */

IMPORT void spear13xxPcieV2Register (void);
...
#ifdef DRV_TI_AM335X_SPI
IMPORT void tiAm335xSpiRegister(void);
#endif /* DRV_TI_AM335X_SPI */

#ifdef DRV_PCIBUS_DM81XX_EX
IMPORT void vxbTi81xxPcieRegister(void);
#endif /* DRV_PCIBUS_DM81XX_EX */

IMPORT void tiEdma3Register(void);
...
#ifdef DRV_SIO_UCC
extern void uccSioRegister (void);
#endif /* DRV_SIO_UCC */
...
IMPORT void vxbUsbTcdRegister (void);
#endif

#ifdef INCLUDE_USB
IMPORT void usbHcdInstantiate (void);
#endif

#ifdef INCLUDE_USBTGT_FUNC_BUS
IMPORT void usrUsbTgtFuncVxbRegister (void);
#endif



IMPORT void amioSioRegister(void);
...
#ifdef DRV_DMA_XLNX
extern void xlnxDmaRegister(void);
#endif /* DRV_DMA_XLNX */
IMPORT void xlnxIntCtlrRegister (void);
IMPORT void xlnxTemacRegister(void);
IMPORT void xlnxUartLiteRegister (void);
#ifdef DRV_RESOURCE_FMN_XLP
IMPORT void fmnRegister();
#endif /* DRV_RESOURCE_FMN_XLP */

#ifdef DRV_VXBEND_XLPGMAC
IMPORT void xlpGmacRegister(void);
#endif

#ifdef DRV_PCIBUS_XLP_IO_MGMT
IMPORT void xlpIoMgmtRegister(void); 
#endif /* DRV_PCIBUS_XLP_IO_MGMT */


#ifdef DRV_PCIBUS_XLP_PCIEX
IMPORT void xlpPciExRegister(void); 
#endif /* DRV_PCIBUS_XLP_PCIEX */
...
IMPORT void zynq7kI2cRegister(void);

IMPORT void vxbZynqSioRegister (void);

IMPORT void vxbZynqTimerDrvRegister (void);

IMPORT void zynq7kDevCfgRegister (void);
...
--------------------
01x,28mar13,j_z  fix MSI-X show failed issue.
01w,15jan13,j_z  add PCIe extend capability show routines.
01v,29nov12,l_z  config the bridge when no device behind it. (WIND00390879)
01u,08may12,cwl  set flag vxbPciBusAllocFirstTime as TRUE when PCI begin 
                 the scanning process at [0,0,0]. (WIND00346868)
01t,01may12,jjk  WIND00343781 - Add PCI_INT_LINES range check and increase
                 allowed PCI_INT_LINES
01s,29mar12,cwl  Set limit address registers refer to the changes of base 
                 address. (WIND00338741)
01r,17oct11,h_k  updated the start bus arg to vxbPciConfigForeachFunc()
                 configurable. (CQ:288091)
                 removed vxbPciIterate() which is a dead code.
01q,24jun11,sye  Correct typo of PCIe Power Controller. (WIND00267528)
01p,08apr11,y_c  updated vxbPciAutoDevProbe() to inherit bus attributes
                 from their bridge when the pciclass of the devices is
                 PCI_CLASS_PROCESSOR. (WIND00265094)
01o,04feb11,pch  CQ253875: exclude "disconnect" functionality in
		 small-footprint builds
01n,11jun10,y_c  correct Memory Limit Registers setting in
		 vxbPciAutoCardBusConfig().(WIND00201700)
01m,18mar10,h_k  moved vxbPciAccessCookieSet() and vxbAccessFree() to
		 vxbPci.c.
01l,22feb10,h_k  removed extra 0x from pciDevShow.
01k,20jan10,wqi  correct message output of vxbMsiCapabShow. (WIND00179515)
01j,05may09,e_d  updated vxbPciAutoMemAlloc() to return 1 if PCI 64 bit
		 address autoconfiguration failed. Then the next base
		 address register will be skipped. (CQ:WIND00164350)
01i,28may09,h_k  further updated for LP64.
01h,22apr09,h_k  updated for LP64 support.
		 removed extern vxbPciIntDisconnect2.
...
LOCAL STATUS    pciBusIntConnect
    ...
    pInterruptInfo->intVecInfo[pPciIntrInfo->intIndex].intVector,
    pPciIntrInfo->pISR,
    (_Vx_usr_arg_t)pPciIntrInfo->pParameter);
    }
...
pVXB_ACCESS_LIST vxbPciAccessInit
    ...
    *pAccessList = pciBusAccessList;
    ...
    pFuncAccessOverride = vxbDevMethodGet (pDev,
				  PCI_CONTROLLER_METHOD_BUS_ACCESS_OVERRIDE);
...
void pciDevShow
    ...
    printf("pDev @ %018p   [%d,%d,%d]\n",
#else
    printf("pDev @ %010p   [%d,%d,%d]\n",
...
LOCAL UINT vxbPciAutoIoAlloc
	...
	*pAlloc = NO_ALLOCATION;
    ...
    PCI_AUTO_DEBUG_MSG("vxbPciAutoIoAlloc: Pre/Post alloc: \n",
		       0, 0, 0, 0, 0, 0);
#ifdef	_WRS_CONFIG_LP64
    PCI_AUTO_DEBUG_MSG("  Pre: pBase[0x%16lx], pAvail[0x%16lx]\n",
		       (long)(*pBase), (long)(*pAvail), 0, 0, 0, 0);
#else
...
#ifdef	_WRS_CONFIG_LP64
    PCI_AUTO_DEBUG_MSG("  Post: pBase[0x%16lx], pAvail[0x%16lx]\n",
		       (long)(*pBase), (long)(*pAvail), 0, 0, 0, 0);
#else
...
LOCAL void vxbPciAutoBusConfig
    ...
    if (ioBase  &&  ioBase <= pSystem->pciIo16)
	{
    ...
    if (memIoBase  &&  memIoBase <= pSystem->pciMemIo32)
	{
    ...
    if ( (pPciLoc->attribute & PCI_AUTO_ATTR_BUS_PREFETCH) &&
	 (memBase && memBase <= pSystem->pciMem32) )
	{
...
LOCAL STATUS vxbPciAutoConfigFBBEnable
    ...
    method = vxbDevMethodGet (pSystem->busCtrlID,
			      PCI_CONTROLLER_METHOD_CFG_INFO);

    if ((method == NULL) ||
	((status = (*method) (pSystem->busCtrlID, &pPciConfig)) == ERROR))
	return (ERROR);

    status = vxbPciConfigForeachFunc (pSystem->busCtrlID,
				      pPciConfig->pciMinBus,
				      TRUE,
				      (VXB_PCI_FOREACH_FUNC)vxbPciFBBFuncCheck,
				      NULL);
    ...
    status = vxbPciConfigForeachFunc (pSystem->busCtrlID,
				      pPciConfig->pciMinBus,
				      TRUE,
				      (VXB_PCI_FOREACH_FUNC)vxbPciFBBFuncSet,
				      NULL);
...
LOCAL STATUS vxbPciAutoConfigFBBDisable
    ...
    status = vxbPciConfigForeachFunc (pSystem->busCtrlID,
				      pPciConfig->pciMinBus,
				      TRUE,
				      (VXB_PCI_FOREACH_FUNC)vxbPciFBBFuncClear,
				      NULL);
...
LOCAL void vxbPcieMsixCapabShow
    ...
    int i;
    VXB_DEVICE_ID pDevServ;
    ULONG tableAddr, pbaAddr, temp;
    void  * msixBarHandle;

    printf ("MSI-X\n");

    vxbPciConfigInWord (busCtrlID, bus, device, function, offset + PCI_MSIX_CTL, &ctlReg);
    tableSize = (ctlReg & PCI_MSIX_CTL_TABLE_SIZE) + 1;

    vxbPciConfigInLong (busCtrlID, bus, device, function, offset + PCI_MSIX_TABLE, &table);
    tableOffset = (table & PCI_MSIX_TABLE_OFFSET_MASK);

    pDevServ = vxbPciGetDevInstance (busCtrlID, bus, device, function);
    if (pDevServ == NULL)
        return;

    tableAddr = (ULONG)pDevServ->pRegBase[(table & PCI_MSIX_TABLE_BIR_MASK)];
    if (vxMemProbe(tableAddr, VX_READ, 4, &temp) != OK)
        {
        vxbRegMap (pDevServ, table & PCI_MSIX_TABLE_BIR_MASK, &msixBarHandle);
        tableAddr = (ULONG)pDevServ->pRegBase[(table & PCI_MSIX_TABLE_BIR_MASK)];
        }

    tableEntry = (UINT32 *)((~PCI_BAR_ALL_MASK & tableAddr) + tableOffset);

    vxbPciConfigInLong (busCtrlID, bus, device, function, offset + PCI_MSIX_PBA, &pba);
    pbaOffset = (pba & PCI_MSIX_PBA_OFFSET_MASK);

    pbaAddr = (ULONG)pDevServ->pRegBase[pba & PCI_MSIX_PBA_BIR_MASK];
    if (vxMemProbe(pbaAddr, VX_READ, 4, &temp) != OK)
        {
        vxbRegMap (pDevServ, pba & PCI_MSIX_PBA_BIR_MASK, &msixBarHandle);
        pbaAddr = (ULONG)pDevServ->pRegBase[pba & PCI_MSIX_PBA_BIR_MASK];
        }

    pbaEntry = (ULONG*)(pbaAddr + pbaOffset);

    printf ("        MSI-X table @%p, pba @%p control 0x%x\n",
            tableEntry, pbaEntry, ctlReg);
...
LOCAL void vxbMsiCapabShow
    ...
    vxbPciConfigInWord (busCtrlID, bus, device, function, offset + PCI_MSI_CTL, &ctlReg);

    printf("Message Signaled Interrupts: 0x%x control 0x%x %s, %s, MME: %d MMC: %d\n", offset, ctlReg,
        ...
        printf("\tPer-vector Mask: %s ", (ctlReg & PCI_MSI_CTL_MASK) ? "Support" : "Unsupported");
        if (ctlReg & PCI_MSI_CTL_MASK)
            {
            vxbPciConfigInLong (busCtrlID, bus, device, function, offset + maskOffset, &maskBit);
            vxbPciConfigInLong (busCtrlID, bus, device, function, offset + maskOffset + 4, &pendBit);
            printf ("Mask Bit: 0x%x, Pending Bit: 0x%x \n", maskBit, pendBit);
            }
        printf ("\n");
    }
...
LOCAL void vxbPcieExtCapAerShow
    ...
    {
    UINT32 i;
    UINT32 uncErrStatus, uncErrMask, uncErrSeverity, rootErrCmd, rootErrSts;
    UINT32 cErrStatus, cErrMask;
    UINT8 aerLog[16];
    UINT32 tempValue,aerControl;

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_CONTROL, &aerControl);

    printf ("AER Control: 0x%x \r\n", aerControl);

    printf ("	Uncorrectable : ");

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_UNCRERR_MASK, &uncErrMask);

    printf ("Mask 0x%X. ", uncErrMask);

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_UNCRERR_SEVERITY, &uncErrSeverity);

    printf ("Severity 0x%X \r\n", uncErrSeverity);

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_UNCRERR_STATUS, &uncErrStatus);

    printf ("	Uncorrectable Status: \r\n", uncErrStatus);

    if (uncErrStatus & (1<<4))
        printf ("	  - Data Link Protocol Error \r\n");
    if (uncErrStatus & (1<<5))
        printf ("	  - Surprise Down Error \r\n");
    if (uncErrStatus & (1<<12))
        printf ("	  - Poisoned TLP \r\n");
    if (uncErrStatus & (1<<13))
        printf ("	  - Flow Control Protocol Error \r\n");
    if (uncErrStatus & (1<<14))
        printf ("	  - Completion Timeout \r\n");
    if (uncErrStatus & (1<<15))
        printf ("	  - Completer Abort \r\n");
    if (uncErrStatus & (1<<16))
        printf ("	  - Unexpected Completion \r\n");
    if (uncErrStatus & (1<<17))
        printf ("	  - Receiver Overflow \r\n");
    if (uncErrStatus & (1<<18))
        printf ("	  - Malformed TLP \r\n");
    if (uncErrStatus & (1<<19))
        printf ("	  - ECRC Error \r\n");
    if (uncErrStatus & (1<<20))
        printf ("	  - Unsupported Request Error \r\n");
    if (uncErrStatus & (1<<21))
        printf ("	  - ACS Violation \r\n");
    if (uncErrStatus & (1<<22))
        printf ("	  - Uncorrectable Internal Error \r\n");
    if (uncErrStatus & (1<<23))
        printf ("	  - MC Blocked TLP \r\n");
    if (uncErrStatus & (1<<24))
        printf ("	  - AtomicOp Egress Blocked \r\n");
    if (uncErrStatus & (1<<25))
        printf ("	  - TLP Prefix Blocked Error \r\n");

    printf ("	Correctable : ");

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_CRERR_MASK, &cErrMask);

    printf ("Mask 0x%X. \r\n", cErrMask);

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_CRERR_STATUS, &cErrStatus);

    printf ("	Correctable Status: ", cErrStatus);
    ...
    if (uncErrStatus & (1<<7))
        printf ("	  - Bad DLLP \r\n");
    if (uncErrStatus & (1<<8))
        printf ("	  - REPLAY_NUM Rollover \r\n");
    if (uncErrStatus & (1<<12))
        printf ("	  - Replay Timer Timeout \r\n");
    if (uncErrStatus & (1<<13))
        printf ("	  - Advisory Non-Fatal Error \r\n");
    if (uncErrStatus & (1<<14))
        printf ("	  - Corrected Internal Error \r\n");
    if (uncErrStatus & (1<<15))
        printf ("	  - Header Log Overflow \r\n");

    printf ("\r\n");

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_HEADER_LOG, (UINT32 *)&aerLog[0]);
    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_HEADER_LOG + 4, (UINT32 *)&aerLog[4]);
    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_HEADER_LOG + 8, (UINT32 *)&aerLog[8]);
    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_HEADER_LOG + 12, (UINT32 *)&aerLog[12]);

    printf ("	HeaderLog: ");
    if (uncErrStatus != 0)
        {
        for (i = 0; i < 32; i++)
            printf ("0x%x ", aerLog[i]);
        }
    ...
    if ((type == PCI_EXP_TYPE_RC_INTR_EP) || (type == PCI_EXP_TYPE_RC_EVEN_COLE))
        {
        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_ROOT_ERR_COMMAND, &rootErrCmd);
        printf ("	Root Error Enable: ");

        if (rootErrCmd & 0x1)
            printf ("Correctable Error Reporting Enable, ");
        if (rootErrCmd & 0x2)
            printf ("Non-Fatal Error Reporting Enable, ");
        if (rootErrCmd & 0x4)
            printf ("Fatal Error Reporting Enable, ");
        printf ("\r\n");

        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_ROOT_ERR_STATUS, &rootErrSts);

        printf ("	Message Index: %d\r\n", (rootErrSts >> 27) & 0x1f);

        printf ("	Root Error Status: \r\n");

        if (rootErrSts & (1 << 0))
            printf ("	  - ERR_COR Received, ");
        if (rootErrSts & (1 << 1))
            printf ("	  - Multiple ERR_COR Received, ");
        if (rootErrSts & (1 << 2))
            printf ("	  - ERR_FATAL/NONFATAL Received, ");
        if (rootErrSts & (1 << 3))
            printf ("	  - Multiple ERR_FATAL/NONFATAL Received, ");
        if (rootErrSts & (1 << 4))
            printf ("	  - First Uncorrectable Fatal, ");
        if (rootErrSts & (1 << 5))
            printf ("	  - Non-Fatal Error Messages Received, ");
        if (rootErrSts & (1 << 6))
            printf ("	  - Fatal Error Messages Received, ");

        printf ("\r\n");
        }

    vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_ROOT_CESIR, &tempValue);

    printf ("	Error Source Identification: 0x%x 0x%x \r\n", tempValue & 0xffff, (tempValue >> 15) & 0xffff);

    if (aerControl & (1<<11))
        {
        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_TLP_LOG, (UINT32 *)&aerLog[0]);
        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_TLP_LOG + 4, (UINT32 *)&aerLog[4]);
        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_TLP_LOG + 8, (UINT32 *)&aerLog[8]);
        vxbPciConfigInLong (busCtrlID, bus, device, function, pos + PCIE_AER_TLP_LOG + 12, (UINT32 *)&aerLog[12]);

        printf ("	TLP Prefix HeaderLog: ");
...
LOCAL void vxbPcieExtCapShow
    ...
    vxbPciConfigInWord (busCtrlID, bus, device, function, pos, &capId);
    ...
    vxbPciConfigInWord (busCtrlID, bus, device, function, pos + 2 , &nextCap);
    version = nextCap & 0xf;
    nextCap = nextCap >> 4;
    ...
    while (capId)
        ...
        switch(capId)
            ...
            case  PCIE_EXT_CAP_ID_ERR:
                printf ("Advanced Error Reporting. 0x%x. Version %d. ", pos, version);
                vxbPcieExtCapAerShow (busCtrlID, bus, device, function, pos, type);
                break;
            case  PCIE_EXT_CAP_ID_VC2:
            case  PCIE_EXT_CAP_ID_VC:
                printf ("Virtual Channel. 0x%x. Version %d \r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_DSN:
                printf ("Device Serial Number. 0x%x. Version %d \r\n", pos, version);

                vxbPciConfigInLong (busCtrlID, bus, device, function, pos + 4 ,
                    (UINT32 *)&serialNum[0]);
                vxbPciConfigInLong (busCtrlID, bus, device, function, pos + 8 ,
                    (UINT32 *)&serialNum[4]);

                printf ("	Serial Number:");
                for (i = 0; i < 8; i++)
                    printf (" 0x%x ", serialNum[i]);
                printf ("\r\n");
                break;
            case  PCIE_EXT_CAP_ID_RC_LINKD:
                printf ("RC Link Declaration. 0x%x. Version %d \r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_RCI_LINKD:
                printf ("RC Internal Declaration. 0x%x. Version %d \r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_PWR:
                printf ("Power Budgeting. 0x%x. Version %d \r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_RC_ECEA:
                printf ("Root Complex Event Collector Endpoint Association. 0x%x. Version %d\r\n", pos, version);
                break;
            case PCIE_EXT_CAP_ID_MFVC:
                printf ("MFVC. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_VNDR:
                printf ("Vendor-Specific. 0x%x. Version %d\r\n", pos, version);
                break;
            case PCIE_EXT_CAP_ID_RCRB:
                printf ("RCRB. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_ACS:
                printf ("ACS. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_ARI:
                printf ("ARI. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_ATS:
                printf ("ATS. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_SRIOV:
                printf ("SRIOV. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_MULCAST:
                printf ("Multicast. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_RSIZEBAR:
                printf ("Resizable BAR. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_DPA:
                printf ("Dynamic Power Allocation. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_TPH:
                printf ("TPH. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_LTR:
                printf ("Latency Tolerance Reporting. 0x%x. Version %d\r\n", pos, version);

                vxbPciConfigInWord (busCtrlID, bus, device, function, pos + 4 , (UINT16 *)&valueTemp);

                latencyTime = (valueTemp & 0x2ff) * latencyScale[(valueTemp >> 10) & 0x7];

                printf("	Max Snoop Latency: %ld ns, ", latencyTime);

                vxbPciConfigInWord (busCtrlID, bus, device, function, pos + 6 , (UINT16 *)&valueTemp);
                latencyTime = (valueTemp & 0x2ff) * latencyScale[(valueTemp >> 10) & 0x7];
                printf("Max No-Snoop Latency: %ld ns \r\n", latencyTime);
                break;

            case  PCIE_EXT_CAP_ID_SECOND_EXT:
                printf ("Secondary PCI Express Extended Capability. 0x%x. Version %d\r\n", pos, version);
                break;
            case  PCIE_EXT_CAP_ID_PMUX:
                printf ("PMUX Extended Capability. 0x%x. Version %d\r\n", pos, version);
                break;
            default:
                printf ("%d unKnown\r\n", capId);
                break;
        ...
        vxbPciConfigInWord (busCtrlID, bus, device, function, nextCap , &capId);

        if (nextCap != 0)
           pos = nextCap;

        vxbPciConfigInWord (busCtrlID, bus, device, function, nextCap + 2, &nextCap);
...
void vxbPciConfigTopoShow
    ...
    method = vxbDevMethodGet (busCtrlID,
			      PCI_CONTROLLER_METHOD_CFG_INFO);
    ...
    vxbPciConfigForeachFunc (busCtrlID,
			     pPciConfig->pciMinBus,
			     TRUE,
			     (VXB_PCI_FOREACH_FUNC) vxbPciConfigFuncShow,
			     NULL);
    }
...
#ifdef INCLUDE_SPI_BUS
IMPORT void spiRegister (void);
#endif /* INCLUDE_SPI_BUS */
...
#ifdef INCLUDE_TIMER_EARLY_VXB_DELAY
extern void vxbTimerEarlyDelayInit ();
#endif /* INCLUDE_TIMER_EARLY_VXB_DELAY */
...
void hardWareInterFaceBusInit (void)
   ...
   sccRegister();
...
#ifdef INCLUDE_DRV_STORAGE_AHCI
    vxbAhciStorageRegister ();
#endif /* INCLUDE_DRV_STORAGE_AHCI */

#ifdef INCLUDE_ALT_SOC_GEN5_DW_END
    vxbAltSocGen5DwEndRegister ();
#endif /* INCLUDE_ALT_SOC_GEN5_DW_END */

#ifdef INCLUDE_ALT_SOC_GEN5_DW_I2C
    vxbAltSocGen5DwI2cRegister ();
#endif /* INCLUDE_ALT_SOC_GEN5_DW_I2C */

#ifdef DRV_STORAGE_ALT_SOC_GEN5_DW_MSHC
    altSocGen5DwMshcRegister ();
#endif /* DRV_STORAGE_ALT_SOC_GEN5_DW_MSHC */

#ifdef INCLUDE_ALT_SOC_GEN5_TIMER
    vxbAltSocGen5TimerRegister ();
#endif /* INCLUDE_ALT_SOC_GEN5_TIMER */
#ifdef INCLUDE_ALT_SOC_GEN5_WDT
    vxbAltSocGen5WdtDrvRegister ();
#endif /* INCLUDE_ALT_SOC_GEN5_WDT */

#ifdef DRV_INTCTLR_ALTERA
    vxbAlteraIntCtlrRegister();
#endif /* DRV_INTCTLR_ALTERA */

#ifdef DRV_SIO_ALTERA_JTAG
    alteraJtagSioRegister();
#endif /* DRV_SIO_ALTERA_JTAG */

#ifdef DRV_TIMER_ALTERA
    alteraTimerRegister ();
#endif /* DRV_TIMER_ALTERA */

#ifdef DRV_VXBEND_ALTERA_TSE
    alteraTseRegister ();
#endif /* DRV_VXBEND_ALTERA_TSE */

#ifdef DRV_SIO_ALTERA_UART
    altUartSioRegister();
#endif /* DRV_SIO_ALTERA_UART */
...
#ifdef DRV_VXBEND_APM_PPRO_MAC
    vxbApmPProMacEndRegister ();
#endif /* DRV_VXBEND_APM_PPRO_MAC */

#ifdef DRV_APM_PPRO_QMAN
    vxbApmPProQmanRegister ();
#endif /* DRV_APM_PPRO_QMAN */
...
#ifdef DRV_TIMER_ARM_SP804
	vxbArmSP804TimerDrvRegister ();
#endif

#ifdef DRV_I2CBUS_AT91
    at91I2cRegister ();
#endif /* DRV_I2CBUS_AT91 */
#ifdef DRV_STORAGE_AT91_MCI
    at91MciRegister ();
#endif /* DRV_STORAGE_AT91_MCI */
...
#ifdef DRV_VXBEND_COMCERTO_GEMAC
    comcertoGemacRegister ();
#endif /* DRV_VXBEND_COMCERTO_GEMAC */

#ifdef DRV_INTCTLR_COMCERTO
    comcertoIntCtlrRegister ();
#endif /* DRV_INTCTLR_COMCERTO */

#ifdef DRV_PCIBUS_COMCERTO
    comcertoPciRegister ();
#endif /* DRV_PCIBUS_COMCERTO */

#ifdef DRV_TIMER_COMCERTO
    comcertoTimerRegister ();
#endif /* DRV_TIMER_COMCERTO */
...
#ifdef DRV_I2C_EEPROM
    vxbI2cEepromRegister();
#endif /* DRV_I2C_EEPROM */


#ifdef DRV_I2C_GENERIC_DEV
    vxbI2cGenericDevRegister();
#endif /* DRV_I2C_GENERIC_DEV */
...
#ifdef INCLUDE_IEEE1394_OHCI
    vxbFwOhciDrvRegister();
#endif /* INCLUDE_IEEE1394_OHCI */
...
#ifdef DRV_INTCTLR_IMX51
    vxbImx51IntCtlrRegister ();
#endif /* DRV_INTCTLR_IMX51 */
...
#ifdef DRV_VXB_NORFLASH_CMDSET_AMD
    vxbNorFlashAmdCmdSetRegister ();
#endif /* DRV_VXB_NORFLASH_CMDSET_AMD */

#ifdef DRV_VXB_NORFLASH_CMDSET_ITL
    vxbNorFlashItlCmdSetRegister ();
#endif /* DRV_VXB_NORFLASH_CMDSET_ITL */
...
#ifdef DRV_VXBEND_OCTEON_MGMT
    vxbOcteonMgmtEndRegister();
#endif /* DRV_VXBEND_OCTEON_MGMT */
...
#ifdef DRV_OMAP35XDPLL
    vxbOmap35xDpllDrvRegister ();
#endif
#ifdef DRV_OMAP35XSR
    vxbOmap35xSRDrvRegister ();
#endif
...
#ifdef DRV_GPIO_OMAP35XX
    vxbOmap35xxGpioDrvRegister ();
#endif /* DRV_GPIO_OMAP35XX  */

#ifdef DRV_I2C_OMAP35XX
    vxbOmap35xxI2cDrvRegister ();
#endif /* DRV_I2C_OMAP35XX  */
...
#ifdef INCLUDE_QCOM_AR8021PHY
    qcomAr8021PhyRegister ();
#endif /* INCLUDE_QCOM_AR8021PHY */
...
#ifdef DRV_SRIO_CPU_EP
    rioCpuRegister ();
#endif /* DRV_SRIO_CPU_EP */


#ifdef DRV_SRIO_GENERIC_SWITCH
    rioGenSwRegister ();
#endif /* DRV_SRIO_GENERIC_SWITCH */
...
#ifdef DRV_SPIFLASH_SP25
    vxbSp25SpiFlashRegister();
#endif /* DRV_SPIFLASH_SP25 */

#ifdef DRV_SPI_EEPROM
    vxbSpiEepromRegister();
#endif /* DRV_SPI_EEPROM */
...
#ifdef DRV_PCIBUS_SPEAR13XX_EX
    spear13xxPcieRegister ();
#endif /* DRV_PCIBUS_SPEAR13XX_EX */

#ifdef DRV_PCIBUS_SPEAR13XX_EX_V2
    spear13xxPcieV2Register ();
#endif /* DRV_PCIBUS_SPEAR13XX_EX_V2 */
    ...
    xlnxDmaRegister();
#endif /* DRV_DMA_XLNX */
#ifdef DRV_INTCTLR_XLNX
    xlnxIntCtlrRegister ();
#endif /* DRV_INTCTLR_XLNX */
#ifdef DRV_VXBEND_XLNX_TEMAC
    xlnxTemacRegister();
#endif /* DRV_VXBEND_XLNX_TEMAC */
#ifdef DRV_SIO_UART_LITE
    xlnxUartLiteRegister();
#endif /* DRV_SIO_UART_LITE */
#ifdef DRV_RESOURCE_FMN_XLP
    fmnRegister();
#endif /* DRV_RESOURCE_FMN_XLP */
...
#ifdef DRV_SIO_ZYNQ7K
    vxbZynqSioRegister();
#endif /* DRV_SIO_ZYNQ7K */

#ifdef DRV_TIMER_ZYNQ7K
    vxbZynqTimerDrvRegister ();
#endif /* DRV_TIMER_ZYNQ7K */

#ifdef DRV_RESOURCE_ZYNQ7K_DEVC
    zynq7kDevCfgRegister ();
