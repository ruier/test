/* romInit.s - ROM bootcode for fsl_p2020_ds BSP */
...
--------------------
01c,05apr12,syt  Modify the OR0 value to improve the flash performance.
                 (WIND00181515)
01b,29dec11,mpc  Initialized MMUCSR0 with value 0x06. (WIND00319727)
01a,05may09,syt  Created from ads8572/01e.
*/
...
FUNC_LABEL(_resetEntry)
    ...
    /*
     * TLB1 #1. Memeroy space: 0x0000000 -> 0x7FFFFFFF (2GB)
...
ccsrbarWait:
    ...
    WRITEADR(r6, r7, M85XX_OR0(CCSBAR), 0xf8000030)    /* Bit[24:27] - Cycle length in   */
                                                       /* bus clocks, this parameter     */
                                                       /* determines the number of wait  */
                                                       /* states inserted in the bus     */
                                                       /* cycle and affects the extended */
                                                       /* NOR flash's performance        */
    isync
    sync
    mbar 0
...
dllDelay4:
    ...
    WRITEADR(r6, r7, M85XX_BR3(CCSBAR), 0xf0000801)
...
#if MACRON_DDR_III_1G
    WRITEOFFSET(r6, r7, (CS0_BNDS),             0x0000003F)
    WRITEOFFSET(r6, r7, (CS0_CONFIG),           0x80044202)
    WRITEOFFSET(r6, r7, (TIMING_CFG_0),         0x00660804)
    WRITEOFFSET(r6, r7, (TIMING_CFG_1),         0x5c5bd523)
    WRITEOFFSET(r6, r7, (TIMING_CFG_2),         0x0fa888ca)
    WRITEOFFSET(r6, r7, (TIMING_CFG_3),         0x00010000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG_2),      0x24401001)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG),   0x00421222)
    ...
    WRITEOFFSET(r6, r7, (DDR_DDR_WRLVL_CNTL),   0x8645f607)
...
#endif  /* MACRON_DDR_III_1G */

#if DEFAULT_DDR_III_1G
    WRITEOFFSET(r6, r7, (CS0_BNDS),             0x0000003F)
    WRITEOFFSET(r6, r7, (CS0_CONFIG),           0x80014202)
    WRITEOFFSET(r6, r7, (TIMING_CFG_0),         0x00330804)
    WRITEOFFSET(r6, r7, (TIMING_CFG_1),         0x6f6b4846)
    WRITEOFFSET(r6, r7, (TIMING_CFG_2),         0x0fa890d4)
    WRITEOFFSET(r6, r7, (TIMING_CFG_3),         0x00020000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG_2),      0x24400011)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG),   0x00421422)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG_2), 0x00000000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MD_CNTL),    0x00000000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_INTERVAL),   0x61800100)
    WRITEOFFSET(r6, r7, (DDR_DATA_INIT),        0xdeadbeef)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CLK_CTRL),   0x02000000)
    WRITEOFFSET(r6, r7, (TIMING_CFG_4),         0x00220001)
    WRITEOFFSET(r6, r7, (TIMING_CFG_5),         0x03402400)
    WRITEOFFSET(r6, r7, (DDR_DDR_ZQ_CNTL),      0x89080600)
    WRITEOFFSET(r6, r7, (DDR_DDR_WRLVL_CNTL),   0x8655A608)
    WRITEOFFSET(r6, r7, (ERR_INT_EN),           0x00000000)
    WRITEOFFSET(r6, r7, (ERR_SBE),              0x00000000)
    WRITEOFFSET(r6, r7, (DDR_DDRCDR_1),         0x00000000)
    WRITEOFFSET(r6, r7, (DDR_DDRCDR_2),         0x00000000)
#endif  /* DEFAULT_DDRIII_TYPE */

#if ELPIDA_DDR_III_2G
    WRITEOFFSET(r6, r7, (CS0_BNDS),             0x0000003F)
    WRITEOFFSET(r6, r7, (CS1_BNDS),             0x0040007f)
    WRITEOFFSET(r6, r7, (CS0_CONFIG),           0x80044202)
    WRITEOFFSET(r6, r7, (CS1_CONFIG),           0x80004202)
    WRITEOFFSET(r6, r7, (CS0_CONFIG_2),         0x00000000)
    WRITEOFFSET(r6, r7, (CS1_CONFIG_2),         0x00000000)
    WRITEOFFSET(r6, r7, (TIMING_CFG_0),         0x00660804)
    WRITEOFFSET(r6, r7, (TIMING_CFG_1),         0x5d5bd533)
    WRITEOFFSET(r6, r7, (TIMING_CFG_2),         0x0fa888cd)
    WRITEOFFSET(r6, r7, (TIMING_CFG_3),         0x00010000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG_2),      0x24401001)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG),   0x00421222)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG_2), 0x04000000)
    ...
    WRITEOFFSET(r6, r7, (DDR_DDRCDR_1),         0x00000000)
    WRITEOFFSET(r6, r7, (DDR_DDRCDR_2),         0x00000000)
#endif /* ELPIDA_DDR_III_2G */

#if DEFAULT_DDR_III_2G
    WRITEOFFSET(r6, r7, (CS0_BNDS),             0x0000003F)
    WRITEOFFSET(r6, r7, (CS1_BNDS),             0x0040007f)
    WRITEOFFSET(r6, r7, (CS0_CONFIG),           0x80044202)
    WRITEOFFSET(r6, r7, (CS1_CONFIG),           0x80004202)
