...
--------------------
01d,03sep04,mdo  Documentation fixes for apigen
...
#define DMA_CR_CP_MEDL    0x000000C0    /* channel priority medium-low        */
#define DMA_CR_CP_MEDH    0x000000C0    /* channel priority medium-high       */
