...
--------------------
01a,04sep12,d_l  adapted from fsl_p5020_ds version 01i.
*/
...
IMPORT void sysMux2Ctrl (UINT32);
...
/*
 * The hardware devices on P5040 can be allocated to either core. Users just
...
#   if (SGMII_RISER_CARD_IN_USE == TRUE)
...
const struct hcfResource dtsec5Resources[] = {
    ...
    { "phyAddr",    HCF_RES_INT,    { (void *)DTSEC5_PHY_ADDR } },
    { "miiIfName",  HCF_RES_STRING, { (void *)"dtsecMdio" } },
    { "miiIfUnit",  HCF_RES_INT,    { (void *)0 } },
    { "dtsecNum",   HCF_RES_INT,    { (void *)0 } },
...
const struct hcfResource dtsec6Resources[] = {
    ...
    { "phyAddr",    HCF_RES_INT,    { (void *)DTSEC6_PHY_ADDR } },
    { "miiIfName",  HCF_RES_STRING, { (void *)"dtsecMdio" } },
    { "miiIfUnit",  HCF_RES_INT,    { (void *)0 } },
    { "dtsecNum",   HCF_RES_INT,    { (void *)1 } },
    { "fmanNum",    HCF_RES_INT,    { (void *)1 } },
...
const struct hcfResource dtsec7Resources[] = {
    ...
    { "phyAddr",    HCF_RES_INT,    { (void *)DTSEC7_PHY_ADDR } },
    { "miiIfName",  HCF_RES_STRING, { (void *)"dtsecMdio" } },
    { "miiIfUnit",  HCF_RES_INT,    { (void *)0 } },
    { "dtsecNum",   HCF_RES_INT,    { (void *)2 } },
    { "fmanNum",    HCF_RES_INT,    { (void *)1 } },
...
const struct hcfResource dtsec8Resources[] = {
    { "regBase",    HCF_RES_INT,    { (void *)(CCSBAR + 0x5E6000) } },
    { "phyAddr",    HCF_RES_INT,    { (void *)DTSEC8_PHY_ADDR } },
    { "miiIfName",  HCF_RES_STRING, { (void *)"dtsecMdio" } },
    { "miiIfUnit",  HCF_RES_INT,    { (void *)0 } },
    { "dtsecNum",   HCF_RES_INT,    { (void *)3 } },
    { "fmanNum",    HCF_RES_INT,    { (void *)1 } },
...
#   define dtsec8Num NELEMENTS(dtsec8Resources)

#   endif /* SGMII_RISER_CARD_IN_USE == TRUE */
...
const struct hcfResource dtsec9Resources[] = {
    { "regBase",    HCF_RES_INT,    { (void *)(CCSBAR + 0x5E8000) } },
    { "phyAddr",    HCF_RES_INT,    { (void *)DTSEC9_PHY_ADDR } },
    { "miiIfName",  HCF_RES_STRING, { (void *)"dtsecMdio" } },
    { "miiIfUnit",  HCF_RES_INT,    { (void *)0 } },
    { "dtsecNum",   HCF_RES_INT,    { (void *)4 } },
    { "fmanNum",    HCF_RES_INT,    { (void *)1 } },
...
#   define dtsec9Num NELEMENTS(dtsec9Resources)
...
/*
 * Each Frame manager include a 10 gigabit ethernet MAC (TGEC).
 * Use of the TGEC with the Freescale P5040 board requires the
 * purchase of a separate XAUI media expansion riser card. 
 */
...
const struct hcfResource tgec1Resources[] = {
    ...
    { "phyAddr",    HCF_RES_INT,    { (void *)TGEC1_PHY_ADDR } },
    { "fmanNum",    HCF_RES_INT,    { (void *)1 } },
#ifdef TGEC_FIBER
    { "fiberMedia", HCF_RES_INT,    { (void *)TRUE } }
#endif /* TGEC_FIBER */
...
const struct hcfResource tgecMdio0Resources[] = {
    ...
    { "muxEnable",  HCF_RES_ADDR,   { (void *)(sysMux2Ctrl) } },
#   ifdef INCLUDE_AMP
...
/*
 * The P5040 processor has three built-in PCIe host bridges.
 ...
 * in the P5040 requires a microcode patch in order for
 ...
 * fman instance, after a hard reset.
 */
...
struct hcfResource m85xxTimerResources[] =  {
    ...
    { "sysClockFreq",       HCF_RES_ADDR,   { (void *)&sysPlbClkFreqGet } }
};
 ...
 *     U30/0x57       24C02        2K-bit   System Id eeprom
 */
...
#   endif /* QORIQ_PCIEX3_ENABLE */
    ...
    { "dtsec",      9,  VXB_BUSID_PLB,  0,  dtsec9Num,      dtsec9Resources },
#endif
...
#endif
#if !defined (INCLUDE_AMP) || defined (INCLUDE_AMP_CPU_03)
    { "dtsec",      8,  VXB_BUSID_PLB,  0,  dtsec8Num,      dtsec8Resources },
#endif
#   endif /* SGMII_RISER_CARD_IN_USE == TRUE */
