...
--------------------
01q,26jun12,l_z  remove INCLUDE_AMP
01p,16sep08,l_z  Store cpuId to PIR for both SMP and AMP.
01o,14sep09,x_z  Remove sysSvrGet().
01n,11sep09,l_z  Store cpuId to PIR for AMP core1. (WIND00168704)
01m,14apr09,rgo  Store/Restore the startType in sysInit(wind00153195) 
...
bootCore1Start:
	...
	/* save the BOOT_COLD in r5 */

	li    r5, BOOT_COLD
#else
	/* save the startType in r5 */
...
ifpdrValue:
...
#if defined(_WRS_CONFIG_SMP) || defined(INCLUDE_WRLOAD_IMAGE_BUILD)
	mfspr	r3, MSSCR0
	isync
	andi.	r3, r3, 0x20
	srwi	r3, r3, 5
	...
	b	doneCpu0Stack
#endif	/* defined(_WRS_CONFIG_SMP) || defined(INCLUDE_WRLOAD_IMAGE_BUILD) */
