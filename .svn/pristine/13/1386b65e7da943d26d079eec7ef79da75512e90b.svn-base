...
/* define this MACRO to include MTD driver for MDS837x */
...
LOCAL void rfaRegister (void)
    ...
    vol.window.baseAddress              = S29GL_FLASH_BASE >> 12;
...
LOCAL void rfaSetWindow
    ...
    flSetWindowSize (&vol, (S29GL_FLASH_SIZE) >> 12);
    }
...
STATUS sysTffsFormat (void)
    ...
    {
        {S29GL_RESERVED_SIZE, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2,
         0, NULL},
