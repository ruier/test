...
#define MAC_OFFSET_QE_FCC       3

/* globals */

const char *sysNetDevName[MAX_MAC_DEVS] = {"motetsec", "qefcc"};
...
LOCAL UINT8 glbEnetAddr[MAX_MAC_ADRS][MAC_ADRS_LEN + 1] = {
    ...
    { FSL_ENET0, FSL_ENET1, FSL_ENET2, CUST_ENET3, CUST_ENET4, CUST_ENET5_2, 0},
    { FSL_ENET0, FSL_ENET1, FSL_ENET2, CUST_ENET3, CUST_ENET4, CUST_ENET5_3, 0},
    { FSL_ENET0, FSL_ENET1, FSL_ENET2, CUST_ENET3, CUST_ENET4, CUST_ENET5_4, 0}
};
...
int sysMacIndex2Unit
    ...
    if (index == 0 || index == 1 || index == 2)
        ...
        return (index - MAC_OFFSET_QE_FCC);
    }
...
STATUS sysMacOffsetGet
    ...
    if ((strcmp(ifName, "mottsec") == 0) || (strcmp(ifName, "motetsec") == 0))
        ...
        *ppEnet  = (char*)glbEnetAddr[ifUnit];
        ...
        {
        *pOffset = (ifUnit + MAC_OFFSET_QE_FCC) * (MAC_ADRS_LEN + 2);
        *ppEnet  = (char*)glbEnetAddr[ifUnit + MAC_OFFSET_QE_FCC];
        }
    else
        return ERROR;
