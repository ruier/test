/* p1020rdb.h - Freescale P1020RDB board header */
...
--------------------
01d,19apr12,d_l  update I2C definitions.
01c,30sep11,swu  Add macros for FIT clock and correct AUX clock rate.
                 (WIND00307247)
01b,21jul11,swu  Change _WRS_VX_AMP to INCLUDE_AMP
                 Remove DMA2 related macro.
01a,19mar10,syt  derived from version 01b of fsl_p2020_rdb/p2020rdb.h
*/

/*
 * This file contains I/O addresses and related constants for the
 * Freescale P1020RDB board.
*/

#ifndef __INCp1020rdbh
#define __INCp1020rdbh
...
#define FIT_CLK_RATE_MIN        (FREQ_400_MHZ / (1 << 24))
#define FIT_CLK_RATE_MAX        (FREQ_400_MHZ / (1 << 13))
