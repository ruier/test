...
#define I2C_CYCLE_START()    i2cCycleMpc8323Start()
#define I2C_CYCLE_STOP()     i2cCycleMpc8323Stop()
#define I2C_CYCLE_READ(ad,y) i2cCycleMpc8323Read(ad,y)
#define I2C_CYCLE_WRITE(wd)  i2cCycleMpc8323Write(wd)
#define I2C_CYCLE_ACKIN()    i2cCycleMpc8323AckIn()
#define I2C_CYCLE_ACKOUT()   i2cCycleMpc8323AckOut()
#define I2C_KNOWN_STATE()    i2cCycleMpc8323KnownState()
#define I2C_DELAY(d)         i2cCycleMpc8323Delay(d)
