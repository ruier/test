/* sysLib.c - Freescale P1020RDB board system-dependent library */
...
--------------------
01i,12nov12,x_s  Fix the AMP device filter. (WIND00387606)
01h,23apr12,d_l  Flush cache in sysCpu1ShutdownLoop
                 Reset PIR before non-CPU0 reset when AMP.
                 Remove legacy I2C functions.
                 Update SPI driver.
01g,10apr12,x_z  Added support for P1020RDB-PC Rev B board with DDR3;
                 replaced legacy driver with vxBus driver for NOR-Flash;
                 added new Flash NVRAM interface.
01f,04jan12,agf  Fix cast of NAND_BUFFER_BASE in sysPhysMemDesc (WIND00325308),
                 Correct value used to init L2CTL register (WIND00325436)
01e,19dec11,agf  Moved L1 parity handling to arch lib. (WIND00309426)
01d,31aug11,swu  Set ETSECx_CORE_NUM as device core number for 
                 etsec. (WIND00260801)
01c,20jul11,swu  Change DRV_STORAGE_FSL_SDHC to DRV_STORAGE_SDHC.
                 Change _WRS_VX_AMP to INCLUDE_AMP
                 Roll back LOCAL_MEM entry of sysPhysMemDesc.
01b,27dec10,syt  updated LOCAL_MEM entry of sysPhysMemDesc.(WIND00247805)
01a,23mar10,syt  derived from version 01b of fsl_p2020_rdb/sysLib.c
*/
...
TLB_ENTRY_DESC sysStaticTlbDesc [] = {
    ...
    _MMU_TLB_TS_0   | _MMU_TLB_SZ_256K  | _MMU_TLB_ATTR_I  |
    _MMU_TLB_ATTR_G | _MMU_TLB_PERM_W   | _MMU_TLB_IPROT
    },
...
LOCAL struct vxbDeviceMethod p1020PlbMethods[] = {
...
UINT32 sysClkFreqGet (void)
    ...
    sysClkSwitch = *((VUINT32 *)GPDAT) & SYS_CLK_SW_MASK;
    ...
    if (sysClkSwitch)
        ...
        switch (sysPcbRev())
            {
            case SYS_PCB_REV_B:
                systemFreq = FREQ_50_MHZ;
                break;
            case SYS_PCB_REV_C:
                systemFreq = FREQ_100_MHZ;
                break;
            default:
                systemFreq = DEFAULT_SYS_CLK_FREQ;
                break;
            }
        }
    else
...
#   endif /* INCLUDE_AMP_CPU_00 */
    ...
    pSysPlbMethods = p1020PlbMethods;
