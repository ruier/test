...
01c,07jun12,mpc  Fixed potential memory corruption caused by sysNvRamGet().
                 (WIND00101057)
01b,21jul11,e_d  modified tgec MAC address offset.(WIND00285088)
01a,11jan11,e_d  created from fsl_p4080_ds/sysNet.c version 01e
*/
...
#ifndef MAX_MAC_DEVS
#   define MAX_MAC_DEVS 6
#endif /* MAX_MAC_DEVS */

#define MAC_0FFSET_TGEC  5
...
STATUS sysMacOffsetGet
    ...
    if (strcmp (ifName, "dtsec") == 0)
        ...
        * pOffset = (ifUnit + MAC_0FFSET_TGEC) * (MAC_ADRS_LEN + 2);
        * ppEnet  = (char * )glbEnetAddr[(ifUnit + MAC_0FFSET_TGEC)];
        }
    else
        return(ERROR);
...
*
* This routine converts an index range 0..MAX_MAC_ADRS-1
* to a device string index e.g. dtsec.
*
