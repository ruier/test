/* romInit.s - Freescale MPC8313ERDB ROM initialization module */
...
--------------------
01c,12may10,dhy  add marco to control the I cache enable.
...
#define WRITEOFFSET(regbase,reg2,offset,val) \
	...
	.text
/* 
Hard Reset Configuration Word (HRCW) See config.h/target.ref for more info
*/
...
romInit:
	...
	.ascii   "Copyright 2007 Wind River Systems, Inc."
	.align 2
...
#if (!defined BOOT_FROM_UBOOT) && (!defined BOOT_FROM_NAND)
	lis	r4, HI (CCSBAR)	
	ori	r4, r4, LO (CCSBAR)
...
start:
    ...
    /* NOR flash*/
	WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,1), 0xfe000000)

	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), (LAWAR_ENABLE |  LAWAR_SIZE_8MB ))

	WRITEADR(r6,r7,QUICC_OR1 (CCSBAR),	(0xfe000193))

	WRITEADR(r6,r7,QUICC_BR1 (CCSBAR), (0xfe001001))

    /* VSC7385 */
	WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,2), (CS_VSC7385))

	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,2),  (0x80000010 ))

	WRITEADR(r6,r7,QUICC_OR2 (CCSBAR),	(0xFFFE09FF))

	WRITEADR(r6,r7,QUICC_BR2 (CCSBAR), (0xF0000801))
	...
	WRITEADR(r6,r7,QUICC_OR0(CCSBAR),ROM_BASE_ADRS|0x0193) 
	...
	WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,1), 0xE2800000)

	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,1), 0x8000000E)
	...
	WRITEADR(r6,r7, M83XX_SICRL(CCSBAR),0x00000800)
	isync
...
#ifdef REVA3_BOARD
	WRITEADR(r6,r7,QUICC_LCRR(CCSBAR),0x00010004) 
#else
...
tlb_write_loop:
	...
	lis r6, HI(LBC_REG_BA + CCSBAR)
	ori r6, r6, LO(LBC_REG_BA + CCSBAR) 	/* r6 = Local Bus Controller base */
	WRITEOFFSET(r6,r7,(0x018), 0xFA000801)
	WRITEOFFSET(r6,r7,(0x01C), 0xFFFF8FF7)
	
	
	WRITEADR(r6,r7,M83XX_LBLAWBARn(CCSBAR,3), CS_LED)
	WRITEADR(r6,r7,M83XX_LBLAWARn(CCSBAR,3), 0x8000000E)
	...
	WRITEADR(r6,r7,QUICC_OR1 (CCSBAR),	(0xFFFF8396))

	WRITEADR(r6,r7,QUICC_BR1 (CCSBAR), (0xE2800C21))
	...
	WRITEADR(r6,r7,M8313_DDRCDR(CCSBAR), 0x73000002)
...
delayddr1:
	...
	WRITEADR(r6,r7,M83XX_OCCR(CCSBAR),0xffffffff)
	isync
