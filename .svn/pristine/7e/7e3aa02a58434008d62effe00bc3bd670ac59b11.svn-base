...
#define FS_DOT             '.'
#define FS_SPACE           ' '
#define FS_MAX_DIR_LEVELS  64     /* max expected directory levels */
#define FS_MAX_ABS_NAME    512
...
extern STATUS fsDirPathParse(UINT8 *,FS_PATH_ARRAY_S *,UINT32);
