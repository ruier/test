...
#define FS_MAX_VOL             16
#define FS_MAX_PART_PER_DISK   4
...
typedef struct tagFS_FD_S
{
    ...
    CHAR            aucFullName[FS_MAX_NAME_LEN];
...
struct tagFS_VOL_S
{
    ...
    CHAR	      aucPartName[FS_PART_NAME_LEN]; /*partition name */
    ...
    UINT32        uiFDTCluCnt;                  /*fdt cluster count*/
    UINT32        uiFDTCnt;                     /*fdt count*/
    UINT32        uiVolClu;                     /*volume cluster*/

    CHAR         *pcFDTCache;                    /*FDT cache pointer*/
    UINT32        uiFDTCacheMinClu;              /*FDT cache minimal cluster*/
    UINT32        uiFDTCacheMaxClu;              /*FDT cache maximal cluster*/
    UINT32        uiFDTCacheLen; 
    ...
    UINT32        uiCacheDirty;               /* cache is dirty*/
    UINT32        uiCacheTaskRuning;
...
typedef struct tagFS_FDT_FUNC_S 
{
	...
	STATUS (*fsPrintFDT)(UINT8 *,UINT32);
	STATUS (*fsFindFDT)(FS_VOL_S*,CHAR*,FS_FDT_INFO_S*);
    STATUS (*fsGetModWrFDT)(FS_VOL_S *,CHAR *,FS_FDT_INFO_S *);
}FS_FDT_FUNC_S;
