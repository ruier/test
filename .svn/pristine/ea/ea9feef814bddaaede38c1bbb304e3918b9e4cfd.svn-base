...
#include "sysUsr.h"
/*jingzhong 2015-12-3*/
#define FS_VER          "R20161031-V2.9"

#define	FS_MAX_FULL_NAME_LEN 256
...
#define  FS_FDT_VALID      0
#define  FS_FDT_INVALID    0x55555555
#define  FS_FDT_CLONED     0xAAAAAAAA
...
typedef struct tagFS_FDT_S 
{
  ...
  UINT32     uiStartFrame;
  UINT32     uiEndFrame;
  UINT32     uiPartentHash;
  UINT32     uiHash;
  UINT32     uiHashKey;
  UINT64_S   ullFileCycle; /* circulate record position*/  
  UINT32	 uiCtime;
  UINT32	 uiMtime;
  UINT32	 uiAtime;
  UINT32     uiCoverFlag;
