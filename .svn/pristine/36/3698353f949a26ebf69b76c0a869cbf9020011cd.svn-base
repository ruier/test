...
/* BIT definition in L2CR  */
#define L2CR_EN_BIT        0
#define L2CR_GBL_INV_BIT  10

/* Define L2CR_CFG based on the configuration in config.h */

#if defined(L2_MODE_INST_AND_DATA)
#   define L2CR_CFG 0
#elif defined(L2_MODE_I_ONLY)
#   define L2CR_CFG L2IO_PPC750
#elif defined(L2_MODE_D_ONLY)
#   define L2CR_CFG L2DO_PPC750
#else
#   error must define one of L2_MODE_INST_AND_DATA, L2_MODE_I_ONLY, L2_MODE_D_ONLY
#endif
