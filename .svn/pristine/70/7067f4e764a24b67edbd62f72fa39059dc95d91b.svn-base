...
--------------------
01e,21oct08,j_z  change boot device to INCLUDE_TSEC_VXB_END(WIND00128640)
01d,24jun08,d_c  Auto-exclude tests for unsupported components
01c,23feb07,jmt  Defect 88750 - Fix problem with network boot device CDF
                 defines
01b,11dec06,rec  vxWorks 6.5 update
