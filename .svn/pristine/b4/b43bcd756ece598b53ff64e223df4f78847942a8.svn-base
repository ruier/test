...
--------------------
01d,16dec08,z_l  Define two start flags and provide accurate delay routine.
                 (WIND00121316)
...
int i2cCycleMpc834xStart 
    ...
    if ( I2CDoRepeatStart[unit] == 1 )
        ...
        I2CDoRepeatStart[unit] = 0;  /* one repeat start only, so clear this bit */
        return(0);
        }
...
*
* This routine will delay for the specified amount of time by calling sysMsDelay
*
* RETURNS: N/A
*
* ERRNO
...
void initPibBoard (void)
    ...
    i2cIOPortRegWrite(0, 0x23, 6, 0x0000) ;
    i2cIOPortRegWrite(0, 0x26, 6, 0x0a34) ;
    i2cIOPortRegWrite(0, 0x27, 6, 0x0000) ;
    ...
    #if 1
    /* 66MHz */
    i2cIOPortRegWrite(0, 0x26, 2, 0xf5ff);
    #else
    /* 33MHz */
    i2cIOPortRegWrite(0, 0x26, 2, 0xf5bf);
    #endif
    i2cIOPortRegWrite(0, 0x27, 2, 0xffef);
#endif
