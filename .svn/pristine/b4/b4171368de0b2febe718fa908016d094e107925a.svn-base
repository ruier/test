/* ads834x.h - Motorola MPC834x ADS board header */
...
01i,24jul08,z_l  VxWorks 6.7 update, support MDS8349EA.
01h,05sep07,dtr  WIND0045894 - Change INUM_CPIO1 to INUM_GPIO1.
01g,13jul07,dtr  Update for vxbus interrupt controller driver.
01f,04mar07,d_z  Add Freescale vendor code for the MAC address.(CQ:86932)
01e,12oct06,dtr  Mod for rev3 silicon.
01d,10oct06,sup  Changes for supporting vxBus complaint quicc timer driver

01c,16aug05,dtr  Remove comment.
01b,02aug05,dtr  Update for PCI2,USB and Mac in NVRam.
...
#ifndef __INCads834xh
#define __INCads834xh
...
/* Base Address of Memory Mapped Registers */
#define M834X_DR_CCSBAR                 (CCSBAR)

/* USB register memory map */
#define M834X_DR_USB_BASE               (CCSBAR | 0x23000)
...
/* 66MHz PCI. Must also flip CLKIN_DIV dip switch on board to 0 */
