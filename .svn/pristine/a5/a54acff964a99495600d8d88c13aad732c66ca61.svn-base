...
--------------------
01g,02jun09,e_d  code cleanup
01f,20sep07,pmr  fix apigen errors
01e,14jun06,dtr  Fix freq check.
...
Currently the file only supports the Mpc8323 I2C interface.
...
#include "sysMpc8323I2c.h"  /* Mpc8323 I2C Driver Header Module */
#include <stdio.h>
#include <logLib.h>
#include <stdlib.h>
...
STATUS i2cDrvInit (void)
    ...
    i2cBaseAdrs = M8323_I2C_BASE + CCSBAR;
    ...
    i2cIoctl(I2C_IOCTL_RMW_AND_OR,
             ...
             ((UINT8)~MPC8323_I2C_CONTROL_REG_MEN),
             MPC8323_I2C_CONTROL_REG_MSTA);

    /* initialize and enable the I2C interface */

    /*
     * I2C1/I2C2 - clock = csb_clk / 3. = 111MHz. -> need to get to 100KHz
     * div by 1024. gives 100+Khz.
     *
     */
    ...
    if(temp == 333000000)
    {
    divider = 0x7 ; /* 111000000 / 1024 */
    }
    else if(temp == 266000000)
    {
    divider = 0x6 ; /* 889000000 / 832 */
    }
    else
    {
    divider = 0x7 ; /* 111000000 / 1024 */
    ...
    i2cIoctl(I2C_IOCTL_RMW_AND_OR,
             (UINT32)(i2cBaseAdrs+MPC8323_I2C_FREQ_DIV_REG),
             ((UINT8)~MPC8323_I2C_FREQ_DIV_REG_MASK),
             divider);

    /* set the slave address */

    i2cIoctl(I2C_IOCTL_RMW_AND_OR,
             (UINT32)(i2cBaseAdrs+MPC8323_I2C_ADR_REG),
             ((UINT8)~MPC8323_I2C_ADDRESS_REG_MASK), 0x7e);

    /* enable the interface */

    i2cIoctl(I2C_IOCTL_RMW_OR,
             (UINT32)(i2cBaseAdrs+MPC8323_I2C_CONTROL_REG),
             MPC8323_I2C_CONTROL_REG_MEN, 0);
    ...
    i2cIoctl(I2C_IOCTL_RMW_AND,
             (UINT32)(i2cBaseAdrs+MPC8323_I2C_CONTROL_REG),
             ((UINT8)~MPC8323_I2C_CONTROL_REG_MSTA), 0);
...
int i2cRead
    ...
    if(i2cBaseAdrs == 0)
        {
        logMsg("I2C driver not initialized.\n", 1,2,3,4,5,6);
        return ERROR ;
        }
    ...
    localStatus = i2cDoOp(deviceAddress, (i2cCmdPckt_t *)&i2cCmdPacket);
...
int i2cDoOpAT24C256
    ...
    if ( pI2cCmdPacket->command == I2C_READOP )
        ...
        for ( byteCount = 0; byteCount < pI2cCmdPacket->nBlocks; byteCount++ )
            ...
            if ( I2C_CYCLE_WRITE((((pI2cCmdPacket->blockNumber+byteCount)>>8)&0x7f)) )
                {
                statusVariable = I2C_ERROR_CYCLE_WRITE;
                break;
                }
            ...
            if ( I2C_CYCLE_WRITE(((pI2cCmdPacket->blockNumber+byteCount)&0xff)) )
                {
                statusVariable = I2C_ERROR_CYCLE_WRITE;
                break;
                }
            ...
            if ( I2C_CYCLE_WRITE(i2cAddressMunge(deviceAddress)|0x1) )
                {
                statusVariable = I2C_ERROR_CYCLE_WRITE;
                break;
                }
            ...
            if ( I2C_CYCLE_READ((unsigned char *)pI2cCmdPacket->memoryAddress+byteCount,0) )
                {
...
* by the passed command packet.  Currently, the only device type
* that are recognized is the ATMEL AT24C256.
*
* RETURNS: OK, always.
*/
...
int i2cDoOp
    ...
    switch(pI2cCmdPacket->deviceType)
        ...
        if ( i2cDoOpAT24C256(deviceAddress, pI2cCmdPacket) != OK )
            return ERROR ;
        break;
        default :
        return ERROR ;
