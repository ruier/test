/* config.h - IBM750GX Evaluation Board BSP configuration header file */
...
--------------------
01m,30may13,d_l  update BSP_REV to "6.9/2"
01l,20mar12,l_z  update BSP version
01k,15apr10,clx  update BSP version for vxWorks 6.9
01j,29jul09,fao  revision update for VxWorks 6.8
01i,16oct08,y_w  fix the BootApp VTS test failure. (WIND00134573)
01h,20aug08,d_l  break default mac(ENET_DEFAULT) to three bytes.(WIND00121398)
01g,17jul08,y_w  set ROM_SIZE to 1M to fix the 'make release' error
01h,03jul08,y_w  add VxBus support and update revision for VxWorks 6.7
01g,08nov07,y_w  undef INCLUDE_SECONDARY_GIGE to increase the booting speed. 
...
01c,25jan07,y_w  modified based on Hickory (IBM750GX) Evaluation Board
01b,13jul06,avb  modified based on HPC-II BSP
01a,21jul05,avb  created based on templatePpc BSP
*/

/*
This file contains the configuration parameters for the IBM750GX EVB BSP.
*/
...
#undef BOOT_FROM_BIGFLASH   /* This is not support for Hickory */
...
#   define L2_MODE_INST_AND_DATA    /* Instruction & Data allowed */
#   undef  L2_MODE_I_ONLY           /* Instruction-only mode */
#   undef  L2_MODE_D_ONLY           /* Data-only mode */

#   define L2CACHE_MODE    L2CACHE_MODE_COPYBACK
#   define L2CACHE_SIZE    L2CACHE_SIZE_2M      /* 2MB defined in sysL2Cache.h */
