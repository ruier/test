...
#define RTC_GET_REG_1  (P5020_RTC_FPGA_ADDR + 0xd0) /*34*/
#define RTC_GET_REG_2  (P5020_RTC_FPGA_ADDR + 0xcc)/*2c*/

/****************** end ********************/

/******************************FPGA rtc2 reg *****************/

#define RTC_CONTROL_REG2  (P5020_RTC_FPGA_ADDR + 0XB0)
#define RTC_SET_REG2_1    (P5020_RTC_FPGA_ADDR + 0XB4)
#define RTC_SET_REG2_2    (P5020_RTC_FPGA_ADDR + 0XB8)

#define RTC_GET_REG2_1	  (P5020_RTC_FPGA_ADDR + 0XBC)
#define RTC_GET_REG2_2	  (P5020_RTC_FPGA_ADDR + 0XC0)

#define RTC_BUSY_REG2     (P5020_RTC_FPGA_ADDR + 0XC4)
