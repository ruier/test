...
/*
 * Copyright (c) 1993-1994, 1996-1998, 2000-2001, 2005-2006, 2009 Wind River Systems, Inc.
 *
...
--------------------
01r,14jul09,my_  made 1st param of sysSectorErase() volatile,
                 use (FLASH_DEF *) to cast 1st param passed to  sysFlashWrite()
                 (WIND173188)
01q,31mar06,dtr  Cleanup.
...
#if     (FLASH_WIDTH == 4)
#define DONE32_2X16	(0x80008000) /* assumes LUT set to byte swapping */
#define TO32_2X16	(0x20002000) /* assumes LUT set to byte swapping */
#undef Q7
#undef Q5
#define Q7(ix)		(ix & DONE32_2X16)
#define Q5(ix)		(ix & TO32_2X16)
#endif /* FLASH_WIDTH == 4 */
