...
/*
 * Copyright (c) 2006, 2010, 2011 Wind River Systems, Inc.
 *
...
--------------------
01d,31oct11,y_c  add fix for MPC8548 DDR20 errata. (WIND00292034)
01c,11may10,liu  remove DDR IO receiver biasing initialize. (WIND00186659)
...
Wind River SBC8548  board.
*/

#ifndef	INCwrSbc8548h
...
#define PCI_XINT1_LVL           0x2            /* PCI XINT1 routed to IRQ2  */
#define PCI_XINT2_LVL           0x3            /* PCI XINT2 routed to IRQ3 */
#define PCI_XINT3_LVL           0x4            /* PCI XINT3 routed to IRQ4 */
#define PCI_XINT4_LVL           0x5            /* PCI XINT3 routed to IRQ5 */
...
#define  EEBACR(base)            (CAST(VUINT32 *)((base) + 0x01000))
