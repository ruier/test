...
--------------------
01f,21aug12,l_z  Better implementation for sysPCGet. (WIND00076160)
01e,10apr12,x_z  Added support for P1020RDB-PC Rev B board with DDR3. 
01d,29dec11,mpc  Initialized MMUCSR0 with value 0x06. (WIND00319727)
01c,19dec11,agf  Moved L1 parity handling to arch lib. (WIND00309426)
01b,17aug11,swu  fix annotation error.
01a,22mar10,syt  derived from version fsl_p2020_rdb/01b.
*/
...
FUNC_BEGIN(sysInit)
    ...
    ori   r5, r5, _MMU_TLB_SZ_256M /* TS = 0, TSIZE = 256 MByte page size*/
    mtspr MAS1, r5
    addis r6, 0, HI(0x10000000) /* EPN */
    ori   r6, r6, 0x000a        /* WIMGE = 01010*/
    mtspr MAS2, r6
    addis r7, 0, HI(0x10000000)  /* RPN */
    ori   r7, r7, 0x003f        /* User/Supervisor XWR*/
    mtspr MAS3, r7
    isync
    msync
    ...
    /*
     * TLB1 #4.  ROM - non-cached 0xff000000 -> 0xffffffff.
     * 16MB
    ...
    /*
     * TLB1 #3.  ROM - non-cached 0xff000000 -> 0xffffffff.
     * 16MB
     * Attributes: SX/SW/SR **PROTECTED**
     */
