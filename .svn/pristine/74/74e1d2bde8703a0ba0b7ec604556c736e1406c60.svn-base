...
--------------------
01f,15nov12,d_l  fixed incompatible MAC address offset. (WIND00381792)
01e,01mar12,h_k  fixed memory corruption caused by a wrong offset calculation.
                 (WIND00336714).
                 fixed potential memory corruption caused by sysNvRamGet().
                 (WIND00101057)
01d,11apr08,dtr  Add in 2 missing ethernet devices.
...
/*
 * (MAC_ADRS_LEN + 1):
 * Reserve the 7th byte for sysNvRamGet() to store EOS. (CQ:WIND00101057)
 */
...
STATUS sysMacOffsetGet
	...
	/*
	 * Offset is (unit number) * (MAC_ADRS_LEN + 2).
	 * This makes it round up to 8 byte aligned in NVRAM and 
	 * is compatible with the previous BSP release.
	 */
