...
01g,04aug10,liu  clear mot83xxPci.h. (WIND00212294)
01f,23sep09,x_z  update quiccEngine configuration.
01e,15jul09,b_m  add QE IO port configuration table.
01d,07aug08,y_w  Add sysInstParam to support VxWorks 6.7
01c,22jun08,y_w  Switch from hEnd qeFcc driver to VxBus UCC driver
01b,26dec07,z_l  Updated to vxWorks6.6
01a,15aug07,z_l  Created from mds8360/hwconf.c
*/
...
#include <../src/hwif/h/mii/bcm54xxPhy.h>
...
const struct hcfResource qefcc2Resources[] = {
    { "regBase",        HCF_RES_INT,    { (void *)(CCSBAR + QUICC_ENGINE_BA + UCC7_BASE) } },
...
const QE_IOPORT_TABLE qeIoTable[] = {
    ...
    { QE_PORTE,  0, 1, 0, 1 },  /* TxD0 */
    { QE_PORTE,  1, 1, 0, 1 },  /* TxD1 */
    { QE_PORTE,  2, 1, 0, 1 },  /* TxD2 */
    { QE_PORTE,  3, 1, 0, 1 },  /* TxD3 */

    { QE_PORTE,  4, 1, 0, 1 },  /* TX_EN */
    { QE_PORTE,  5, 1, 0, 1 },  /* TX_ER */

    { QE_PORTE,  6, 2, 0, 1 },  /* RxD0 */
    { QE_PORTE,  7, 2, 0, 1 },  /* RxD1 */
    { QE_PORTE,  8, 2, 0, 1 },  /* RxD2 */
    { QE_PORTE,  9, 2, 0, 1 },  /* RxD3 */

    { QE_PORTE, 11, 2, 0, 1 },  /* CRS */
    { QE_PORTE, 12, 2, 0, 1 },  /* RX_DV */
    { QE_PORTE, 13, 2, 0, 1 },  /* RX_ER */

    { QE_PORTC, 19, 2, 0, 1 },  /* RX_CLK CLK20 */
    { QE_PORTC, 18, 2, 0, 1 },  /* TX_CLK CLK19 */

    /* UCC4 Ethernet */

    { QE_PORTB, 14, 1, 0, 1 },  /* TxD0 */
    { QE_PORTB, 15, 1, 0, 1 },  /* TxD1 */
    { QE_PORTB, 16, 1, 0, 1 },  /* TxD2 */
    { QE_PORTB, 17, 1, 0, 1 },  /* TxD3 */

    { QE_PORTB, 18, 1, 0, 1 },  /* TX_EN */
    { QE_PORTB, 19, 1, 0, 1 },  /* TX_ER */

    { QE_PORTB, 20, 2, 0, 1 },  /* RxD0 */
    { QE_PORTB, 21, 2, 0, 1 },  /* RxD1 */
    { QE_PORTB, 22, 2, 0, 1 },  /* RxD2 */
    { QE_PORTB, 23, 2, 0, 1 },  /* RxD3 */

    { QE_PORTB, 25, 2, 0, 1 },  /* CRS */
    { QE_PORTB, 26, 2, 0, 1 },  /* RX_DV */
    { QE_PORTB, 27, 2, 0, 1 },  /* RX_ER */

    { QE_PORTC,  7, 2, 0, 1 },  /* RX_CLK CLK8 */
    { QE_PORTC,  6, 2, 0, 1 },  /* TX_CLK CLK7 */

#ifdef INCLUDE_PCI_BUS

    { QE_PORTC,  5, 2, 0, 1 },  /* CLK6 */
    { QE_PORTF,  0, 1, 0, 2 },
    { QE_PORTF,  1, 2, 0, 3 },
    { QE_PORTF,  2, 1, 0, 1 },
    { QE_PORTF,  3, 2, 0, 2 },
...
#else
    { QE_INUM_UCC4,     "qefcc", 1, 0 },
    { QE_INUM_UCC7,     "qefcc", 0, 0 },
#endif /* ETH_OPTION_SUPPORT */
};
...
#   else    /* ETH_OPTION_SUPPORT */
    { "qefcc",              0, VXB_BUSID_PLB, 0, qefcc2Num,         qefcc2Resources },
    { "qefcc",              1, VXB_BUSID_PLB, 0, qefcc3Num,         qefcc3Resources },
#   endif   /* ETH_OPTION_SUPPORT */
#   endif   /* INCLUDE_UCC_VXB_END */
...
VXB_INST_PARAM_OVERRIDE sysInstParamTable[] = {
    { "bcm54xxPhy", 0,  "RxdToRxcSkewEnable", VXB_PARAM_INT32,  { (void *)TRUE } },
    { "bcm54xxPhy", 1,  "RxdToRxcSkewEnable", VXB_PARAM_INT32,  { (void *)TRUE } },
