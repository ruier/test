/* p5040ds.h - Freescale P5040DS board header */
...
--------------------
01b,22nov12,d_l  correct FREQ_33_MHZ. (WIND00389496)
01a,05sep12,d_l  Created from fsl_p5020_ds 01i
*/

/*
 * This file contains I/O addresses and related constants for the
 * FreeScale P5040DS board.
*/

#ifndef __INCp5040dsh
#define __INCp5040dsh
...
/* Two types ethernet controllers on P5040, DTSEC and TGEC  */
...
#define DTSEC0_PHY_ADDR         0x1c
#define DTSEC1_PHY_ADDR         0x1d
#define DTSEC2_PHY_ADDR         0x1c
#define DTSEC3_PHY_ADDR         0x1d
#define DTSEC4_PHY_ADDR         0x00
#define DTSEC5_PHY_ADDR         0x1c
#define DTSEC6_PHY_ADDR         0x1d
#define DTSEC7_PHY_ADDR         0x1c
#define DTSEC8_PHY_ADDR         0x1d
#define DTSEC9_PHY_ADDR         0x01
...
#define MII1_SLOT_3             6           /* SGMII SLOT3 */
...
#define MII_2_BUS_SEL           MII2_SLOT_1
...
#define TGEC0_PHY_ADDR          (0x0)
#define TGEC1_PHY_ADDR          (0x4)
...
/* p5040ds supports three PCIe controllers */
 ...
 * with those used by U-Boot on the P5040DS board.
 */
...
/*
 * The P5040 processor has three PCIe bridges, each bridges's interrupt supports
...
#define  P5_LAWBARH0(base)          (CAST(VUINT32 *)((base) + 0xc00))
#define  P5_LAWBARL0(base)          (CAST(VUINT32 *)((base) + 0xc04))
#define  P5_LAWAR0(base)            (CAST(VUINT32 *)((base) + 0xc08))

/* Used for DDR controller 1 */

#define  P5_LAWBARH1(base)          (CAST(VUINT32 *)((base) + 0xc10))
#define  P5_LAWBARL1(base)          (CAST(VUINT32 *)((base) + 0xc14))
#define  P5_LAWAR1(base)            (CAST(VUINT32 *)((base) + 0xc18))

/* Used for DDR controller 2 */

#define  P5_LAWBARH2(base)          (CAST(VUINT32 *)((base) + 0xc20))
#define  P5_LAWBARL2(base)          (CAST(VUINT32 *)((base) + 0xc24))
#define  P5_LAWAR2(base)            (CAST(VUINT32 *)((base) + 0xc28))

/* Used for LBC PIXIS */

#define  P5_LAWBARH3(base)          (CAST(VUINT32 *)((base) + 0xc30))
#define  P5_LAWBARL3(base)          (CAST(VUINT32 *)((base) + 0xc34))
#define  P5_LAWAR3(base)            (CAST(VUINT32 *)((base) + 0xc38))

/* Used for PCIEX1 */

#define  P5_LAWBARH4(base)          (CAST(VUINT32 *)((base) + 0xc40))
#define  P5_LAWBARL4(base)          (CAST(VUINT32 *)((base) + 0xc44))
#define  P5_LAWAR4(base)            (CAST(VUINT32 *)((base) + 0xc48))

/* Used for PCIEX2*/

#define  P5_LAWBARH5(base)          (CAST(VUINT32 *)((base) + 0xc50))
#define  P5_LAWBARL5(base)          (CAST(VUINT32 *)((base) + 0xc54))
#define  P5_LAWAR5(base)            (CAST(VUINT32 *)((base) + 0xc58))

/* Used for PCIEX3 */

#define  P5_LAWBARH6(base)          (CAST(VUINT32 *)((base) + 0xc60))
#define  P5_LAWBARL6(base)          (CAST(VUINT32 *)((base) + 0xc64))
#define  P5_LAWAR6(base)            (CAST(VUINT32 *)((base) + 0xc68))

/* Used for PCI */

#define  P5_LAWBARH7(base)          (CAST(VUINT32 *)((base) + 0xc70))
#define  P5_LAWBARL7(base)          (CAST(VUINT32 *)((base) + 0xc74))
#define  P5_LAWAR7(base)            (CAST(VUINT32 *)((base) + 0xc78))

/* Unused */

#define  P5_LAWBARH8(base)          (CAST(VUINT32 *)((base) + 0xc80))
#define  P5_LAWBARL8(base)          (CAST(VUINT32 *)((base) + 0xc84))
#define  P5_LAWAR8(base)            (CAST(VUINT32 *)((base) + 0xc88))

/* Used for DCSR registers  */

#define  P5_LAWBARH29(base)         (CAST(VUINT32 *)((base) + 0xDD0))
#define  P5_LAWBARL29(base)         (CAST(VUINT32 *)((base) + 0xDD4))
#define  P5_LAWAR29(base)           (CAST(VUINT32 *)((base) + 0xDD8))

/* Used for DDR SDRAM */

#define  P5_LAWBARH30(base)         (CAST(VUINT32 *)((base) + 0xDE0))
#define  P5_LAWBARL30(base)         (CAST(VUINT32 *)((base) + 0xDE4))
#define  P5_LAWAR30(base)           (CAST(VUINT32 *)((base) + 0xDE8))

#define  P5_LAWBARH31(base)         (CAST(VUINT32 *)((base) + 0xDF0))
#define  P5_LAWBARL31(base)         (CAST(VUINT32 *)((base) + 0xDF4))
#define  P5_LAWAR31(base)           (CAST(VUINT32 *)((base) + 0xDF8))
...
#define  P5_BR0(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x000))
#define  P5_OR0(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x004))
#define  P5_BR1(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x008))
#define  P5_OR1(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x00c))
#define  P5_BR2(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x010))
#define  P5_OR2(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x014))
#define  P5_BR3(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x018))
#define  P5_OR3(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x01c))
#define  P5_BR4(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x020))
#define  P5_OR4(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x024))
#define  P5_BR5(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x028))
#define  P5_OR5(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x02C))
#define  P5_BR6(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x030))
#define  P5_OR6(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x034))
#define  P5_BR7(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x038))
#define  P5_OR7(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x03C))

#define  P5_MAR(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x068))
#define  P5_MAMR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x070))
#define  P5_MBMR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x074))
#define  P5_MCMR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x078))
#define  P5_MRTPR(base)             (CAST(VUINT32 *)(base + LBC_BASE + 0x084))
#define  MRTPR_PTP_MASK             0xff000000
#define  MRTPR_PTP_WRITE(x)         ((x << 24) & MRTPR_PTP_MASK)
#define  P5_MDR(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x088))

#define  P5_LTESR(base)             (CAST(VUINT32 *)(base + LBC_BASE + 0x0B0))
#define  P5_LTEDR(base)             (CAST(VUINT32 *)(base + LBC_BASE + 0x0B4))
#define  P5_LTEIR(base)             (CAST(VUINT32 *)(base + LBC_BASE + 0x0B8))
#define  P5_LTEATR(base)            (CAST(VUINT32 *)(base + LBC_BASE + 0x0BC))
#define  P5_LTEAR(base)             (CAST(VUINT32 *)(base + LBC_BASE + 0x0C0))

/* LBC Clock Configuration */

#define  P5_LBCR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x0D0))
#define  P5_LCRR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x0D4))

/* LBC Flash Registers */

#define  P5_FMR(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x0E0))
#define  P5_FIR(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x0E4))
#define  P5_FCR(base)               (CAST(VUINT32 *)(base + LBC_BASE + 0x0E8))
#define  P5_FBAR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x0EC))
#define  P5_FPAR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x0F0))
#define  P5_FBCR(base)              (CAST(VUINT32 *)(base + LBC_BASE + 0x0F4))

#define  P5_DCR0(base)              (CAST(VUINT32 *)(base + 0xe0f1c))
#define  P5_DCR1(base)              (CAST(VUINT32 *)(base + 0xe0f20))
...
#define CS0_CONFIG_VALUE            0x80044202
#define CS1_CONFIG_VALUE            0x80004202
...
#define TIMING_CFG_1_VALUE          0x98910a45
#define TIMING_CFG_2_VALUE          0x0fb8a914
#define TIMING_CFG_4_VALUE          0x00000001
#define TIMING_CFG_5_VALUE          0x02401400
...
#define DDR_SDRAM_CFG_2_VALUE1      0x24401001
#define DDR_SDRAM_CFG_2_VALUE2      0x24401011
#define DDR_SDRAM_MODE_CFG_VALUE    0x00441a40
#define DDR_SDRAM_INTERVAL_VALUE    0x13ce0100
...
/* ngPIXIS Registers - see P5DS-revA.pdf $7.3 */
...
#define P5_CDOZSRL(base)            (CAST(VUINT32 *)(base + 0xE2004))
#define P5_CDOZCRL(base)            (CAST(VUINT32 *)(base + 0xE200C))
#define P5_CNAPSRL(base)            (CAST(VUINT32 *)(base + 0xE2014))
#define P5_CNAPCRL(base)            (CAST(VUINT32 *)(base + 0xE201C))

/* Processor reset register */

#define P5_EPICPRR(base)            (CAST(VUINT32 *)(base + 0x41098))

/* Feature Reporting Register (FRR) */

#define P5_EPICFRR(base)            (CAST(VUINT32 *)(base + 0x41000))

/* Processor initialization register */

#define P5_EPICPIR(base)            (CAST(VUINT32 *)(base + 0x41090))
#define P5_EPICWHOAMI(base)         (CAST(VUINT32 *)((base) + 0x40090))
...
#define P5_EPICCTPRn(base,n)        (CAST(VUINT32 *)((base) + 0x60080 + (n)*0x1000))
#define P5_EPICEOIn(base,n)         (CAST(VUINT32 *)((base) + 0x600b0 + (n)*0x1000))
#define EPIC_CTPR_MAX               15  /* maximum priority (mask) */
#define RESET_EOI_NUM               15  /* EOIs to send RM:31.5.1.3 */

#define P5_PVR(base)                (CAST(VUINT32 *)((base) + 0xE00A0))
#define P5_SVR(base)                (CAST(VUINT32 *)((base) + 0xE00A4))

#define P5_BRR(base)                (CAST(VUINT32 *)((base) + 0xE00E4))

/* Core reset status register */

#define P5_CRSTSR(base,n)           (CAST(VUINT32 *)((base) + 0xE0400 + (n)*4))
#define P5_CRSTSR_RST_WRT           0x08000000
#define P5_CRSTSR_RST_MPIC          0x00800000
#define P5_CRSTSR_RST_CORE          0x00080000
#define P5_CRSTSR_READY             0x00008000
#define P5_CRSTSR_RST_HRST          0x00000002
#define P5_CRSTSR_RST_PORST         0x00000001

/* reset configuration word status registers (0 <= n < 16) */

#define P5_RCWSR(base,n)            (CAST(VUINT32 *)((base) + 0xE0100 + (n)*4))
#define P5_MEM_PLL_RAT_MSK          0x003E0000
#define P5_MEM_PLL_RAT_SFT          17
#define P5_MEM_PLL_RAT(base)        \
        ((*P5_RCWSR(base,0) & P5_MEM_PLL_RAT_MSK) >> P5_MEM_PLL_RAT_SFT)

#define P5_SYS_PLL_RAT_MSK          0x3E000000
#define P5_SYS_PLL_RAT_SFT          25
#define P5_SYS_PLL_RAT(base)        \
        ((*P5_RCWSR(base,0) & P5_SYS_PLL_RAT_MSK) >> P5_SYS_PLL_RAT_SFT)

#define P5_CCN_PLL_RAT_MSK(n)       (0x3E000000 >> (8 * n))
#define P5_CCN_PLL_RAT_SFT(n)       (25 - (8 * n))
#define P5_CCN_PLL_RAT(base,n)      \
        ((*P5_RCWSR(base,2) & P5_CCN_PLL_RAT_MSK(n)) >> P5_CCN_PLL_RAT_SFT(n))

#define P5_CN_PLL_SEL_MSK(n)        (0xF0000000 >> (4 * n))
#define P5_CN_PLL_SEL_SFT(n)        (28 - (4 * n))
#define P5_CN_PLL_SEL(base,n)       \
        ((*P5_RCWSR(base,3) & P5_CN_PLL_SEL_MSK(n)) >> P5_CN_PLL_SEL_SFT(n))

#define P5_SRDS_PRTCL(base)         ((*P5_RCWSR(base,4) & 0xfc000000) >> 26)

/* Timebase enable register */

#define P5_CTBENR(base)             (CAST(VUINT32 *)((base) + 0xE2084))
...
#define P4080_CTBENR        P5_CTBENR
#define P4080_LAWAR0        P5_LAWAR0
#define P4080_LAWAR1        P5_LAWAR1
#define P4080_LAWAR3        P5_LAWAR3
#define P4080_LAWAR8        P5_LAWAR8
#define P4080_LAWARL8       P5_LAWARL8
#define P4080_LAWBARL0      P5_LAWBARL0
#define P4080_LAWBARL1      P5_LAWBARL1
#define P4080_LAWBARH1      P5_LAWBARH1
#define P4080_LAWBARL3      P5_LAWBARL3
#define P4080_LAWBARL8      P5_LAWBARL8
#define P4080_OR0           P5_OR0
#define P4080_BR0           P5_BR0
#define P4080_OR3           P5_OR3
#define P4080_BR3           P5_BR3
#define P4080_LBCR          P5_LBCR
#define P4080_LCRR          P5_LCRR
#define P4080_LAWBARL30     P5_LAWBARL30
#define P4080_LAWBARH30     P5_LAWBARH30
#define P4080_LAWAR30       P5_LAWAR30
#define P4080_LAWBARL29     P5_LAWBARL29
#define P4080_LAWBARH29     P5_LAWBARH29
#define P4080_LAWAR29       P5_LAWAR29

#define P5020_EPICWHOAMI    P5_EPICWHOAMI
