/* wrSbc834x.h - Wind River SBC834x board header */

/*
 * Copyright (c) 2005-2006, 2009 Wind River Systems, Inc.
 *
...
--------------------
01c,06jul09,z_l  Add definitions for VxBus PCI driver. (WIND00088032)
01b,08mar06,kds  Add USB registers.
01a,22jun05,j_b  adapted from ads834x (rev 01a); remove extraneous NvRAM macros
*/
...
#define M83XX_GP1DIR(base)    (CAST(VUINT32 *)((base) + GPIO1_REG_BA + 0x00))
#define M83XX_GP1DAT(base)    (CAST(VUINT32 *)((base) + GPIO1_REG_BA + 0x08))
...
#define NUM_PCI_SLOTS           0x1            /* One PCI slot */
...
#define PCI_SLOT1_DEVNO        0x11            /* PCI SLOT Device no */
...
#define EEPROM_BASE_ADRS    0xF8000000      /* EEPROM base address */
#define EEPROM_SIZE      0x00002000         /* 8K of address space */
#define EEPROM_MASK      ~(EEPROM_SIZE - 1) /* 8K mask for EEPROM */
...
#define OCCR_DEFAULT_VAL                0x80000000
...
#define LBLAWBAR1_DEFAULT_VAL           EEPROM_BASE_ADRS
...
#define BR1_DEFAULT_VAL                 (EEPROM_BASE_ADRS|0x801)
#define OR1_DEFAULT_VAL                 0xffff60f6
