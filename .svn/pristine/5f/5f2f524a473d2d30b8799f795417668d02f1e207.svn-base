/* romInit.s - Freescale HPC-II ROM initialization module */
...
CPU_IS_750:
	/* Also handles 750, 7400, 7410, 744x, 745x */
        mfspr   r3,HID0
...
do_tsi108_init:
	...
	/* Tsi108 Errata 19: Disable PVT for any real Tsi108 board */
...
wait_init_complete:
	...
	LOADPTR(r5, 0x00000011)  /* BA=0,Size=512MB,ENable,No Addr.Transl */
	...
	/*
	 * PB_SDRAM_BAR2:
	 * provides non-cacheable alias (via the direct path) to main system
	 * memory: Size = 512MB, ENable, Addr.Translation - ON,
	 * BA = 0x0_40000000, TA = 0x0_00000000
	 */

	LOADPTR(r5, 0x40010011)
...
spd_fail:
	li	r3,0x0bad
	sync
err_hung:   /* hang here fo debugging */
	nop
	nop
	b	err_hung
