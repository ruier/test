...
--------------------
01f,16jan10,x_s  Add symbolic definitions of some DDR and chip-select fields.
...
#define	CS_BNDS_LOW_MASK		0x0FFF0000
#define	ADRS_TO_CS_BNDS_HIGH_SHIFT	24
#define	CS_BNDS_HIGH_MASK		0x00000FFF
...
#define CS_ODT_WR_CFG_CS   0x00010000
#define CS_BA_BITS_CS_2    0x00000000
#define CS_BA_BITS_CS_3    0x00004000
#define CS_LOGICAL_BANK_COUNT(fieldVal) (((fieldVal) >> 14) + 2)

#define	CS_ROW_BITS_12	0x00000000
#define	CS_ROW_BITS_13	0x00000100
#define	CS_ROW_BITS_14	0x00000200
#define	CS_ROW_BITS_15	0x00000300
#define	CS_ROW_BITS_16	0x00000400
...
#define	DDR_SDRAM_TYPE_DDR2		0x03000000  /* always set this */
...
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_1	0x01000000	/* 1/8 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_2	0x02000000	/* 1/4 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_3	0x03000000	/* 3/8 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_4	0x04000000	/* 1/2 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_5	0x05000000	/* 5/8 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_6	0x06000000	/* 3/4 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_7	0x07000000	/* 7/8 cycle delay */
#define	DDR_SDRAM_CLK_CNTL_CLK_ADJST_8	0x08000000	/* 1 cycle delay */
...
#define DDR_ERR_TYPE_ACE	0x00000080	/* Automatic calibration error */
