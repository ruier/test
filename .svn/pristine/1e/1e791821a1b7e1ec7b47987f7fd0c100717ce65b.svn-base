/* p2020.h - Freescale P2020DS board header */
...
--------------------
01d,28jan11,agf  add magic no. for signaling cache flushed during shutdown
01c,26may10,syt  add external interrupt macros.
01b,27jul09,syt  update openPicTimer support.
01a,23mar09,syt  derived from version 01k of ads8572/ads8572.h
*/

/*
 * This file contains I/O addresses and related constants for the
 * FreeScale P2020 DS board.
*/
...
/*
 * Define DDR_III DRAM memory type
 *
 * MACRON_DDR_III_1G  -- for Micron's MT9JSF12872AY-1G4D1 1GB size DDRIII memory
 * ELPIDA_DDR_III_2G  -- for Elpida's EBJ21EE8BAFA-AE-E 2GB size DDRIII memory
 * DEFAULT_DDR_III_2G -- only tested on SAMSUMG's M378B5673DZ1-CH9  2GB size
 *                       DDRIII memory
 *
 * It's recommend to use Elpida's EBJ21EE8BAFA-AE-E 2GB size DDRIII memory with
 * the macro "ELPIDA_DDR_III_2G", we not assure the "DEFAULT_DDR_III_2G" or
 * "DEFAULT_DDR_III_1G" are available and stable for other 1GB or 2GB size
 * DDRIII memory.
 *
 */

#define MACRON_DDR_III_1G       FALSE   /* Micron MT9JSF12872AY-1G4D1 */
#define DEFAULT_DDR_III_1G      FALSE   /* Default DDR_III_1G */
#define ELPIDA_DDR_III_2G       FALSE   /* Elpida EBJ21EE8BAFA-AE-E */
#define DEFAULT_DDR_III_2G      TRUE    /* Default DDR_III_2G */

#define DDR_1G_SIZE             0x40000000
#define DDR_2G_SIZE             0x80000000

#if (MACRON_DDR_III_1G || DEFAULT_DDR_III_1G)
#   define  PHY_MEM_SIZE        DDR_1G_SIZE
#elif (ELPIDA_DDR_III_2G || DEFAULT_DDR_III_2G)
#   define  PHY_MEM_SIZE        DDR_2G_SIZE
#endif  /* MACRON_DDR_III_1G || DEFAULT_DDR_III_1G */
...
#define EPIC_EXT_IRQ8_INT_VEC           (EPIC_EXT_IRQ8_INT_NUM +  \
                                         EPIC_VEC_EXT_IRQ0)
#define EPIC_EXT_IRQ9_INT_NUM           9
#define EPIC_EXT_IRQ9_INT_VEC           (EPIC_EXT_IRQ9_INT_NUM +  \
                                         EPIC_VEC_EXT_IRQ0)
#define EPIC_EXT_IRQ10_INT_NUM          10
#define EPIC_EXT_IRQ10_INT_VEC          (EPIC_EXT_IRQ10_INT_NUM +  \
                                         EPIC_VEC_EXT_IRQ0)
#define EPIC_EXT_IRQ11_INT_NUM          11
#define EPIC_EXT_IRQ11_INT_VEC          (EPIC_EXT_IRQ11_INT_NUM +  \
                                         EPIC_VEC_EXT_IRQ0)
