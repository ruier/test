...
--------------------
01f,29aug06,jb3  Fix for WIND00056331 TFFS Build Errors.
...
#define	FLASH_BASE_ADRS		0xf8000000	   /* Flash memory base address */
#endif
#define	FLASH_SIZE		0x01000000    /* must be a power of 2 (1,2,4,8,16,32,...) */
...
#define MV5500_FLASH_WRITE_ENABLE 0xdf
...
STATUS sysTffsErase
    ...
    UINT32 temp ;
            ...
            temp = FLASH_BASE_ADRS ;
            while ( temp < (FLASH_BASE_ADRS+FLASH_SIZE) )
                {
                ptr = (UINT8*)temp ;
#ifdef TFFS_DEBUG
...
void sysFlashWriteEnable (void)
     {
      volatile UCHAR * flashwp = (volatile UCHAR *) (MV64260_DEVCS1_BASE_ADDR + 1);
      *flashwp &= MV5500_FLASH_WRITE_ENABLE;
      } 
