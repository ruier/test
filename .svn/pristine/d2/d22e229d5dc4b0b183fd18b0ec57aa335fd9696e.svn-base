...
FUNC_BEGIN(sysInit)
	...
	/* Memory mapped region base address */
        ...
        lis     r6, HIADJ(M85XX_LAWBAR3(CCSBAR))
        addi    r6, r6, LO(M85XX_LAWBAR3(CCSBAR))
	
	/* Initialise the Local Address Windows */
        lis     r7, HIADJ(FLASH1_BASE_ADRS >> LAWBAR_ADRS_SHIFT)
        addi    r7, r7, LO(FLASH1_BASE_ADRS >> LAWBAR_ADRS_SHIFT)
	stw     r7, 0x0(r6)

        lis     r6, HIADJ(M85XX_LAWAR3(CCSBAR))
        addi    r6, r6, LO(M85XX_LAWAR3(CCSBAR))
