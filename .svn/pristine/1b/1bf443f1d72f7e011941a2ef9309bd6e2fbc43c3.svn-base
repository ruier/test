...
--------------------
01c,16aug07,y_w  Add support for text-only L2 caches (WIND00101523)
...
FUNC_BEGIN(sysL2CacheGlobalInv)
	...
	mfspr   r3, L2CR_REG
	rlwinm  r4, r3, 0, L2CR_EN_BIT, L2CR_EN_BIT  /* save enabled bit */
	rlwinm  r3, r3, 0, (L2CR_EN_BIT+1), 31       /* disable L2 cache */
	mtspr   L2CR_REG, r3
...
invalidate_in_progress:
	...
	sync
	mfspr   r3, L2CR_REG
	rlwinm  r3, r3, 0, (L2CR_GBL_INV_BIT+1), (L2CR_GBL_INV_BIT-1)
	                                        /* zero out the invalidate bit */
	or      r3, r3, r4                      /* restore enabled state */
	mtspr   L2CR_REG, r3
	sync
	blr
...
*     (
*     CACHE_TYPE cache         /@ type of L1 cache being enable (not used)@/
*     )
* \se
*
* RETURNS: N/A
...
FUNC_BEGIN(sysL2CacheInit)
	...
	sync
	mfspr   r3, L2CR_REG
#if ((L2CR_CFG & 0xffff0000) != 0)
	oris    r3, r3, HI(L2CR_CFG)
#endif
#if ((L2CR_CFG & 0x0000ffff) != 0)
	ori     r3, r3, LO(L2CR_CFG)
#endif
	mtspr   L2CR_REG, r3
	sync
	isync
