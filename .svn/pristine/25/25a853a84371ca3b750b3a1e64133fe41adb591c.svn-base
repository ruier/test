/* rdb8323.h - Motorola MPC8323 RDB board header */
...
--------------------
01e,23sep09,x_z  remove QE_MURAM_POOL1_SIZE and QE_MURAM_POOL2_SIZE.
01d,15jul09,b_m  add QE MURAM defines.
01c,26jun09,e_d  change timer and interrupt legacy driver to vxBus driver
01b,17mar08,wap  Add definitions for clock routing registers
01a,07nov06,pmr  adapted from mds8360.h
*/
...
#ifndef __INCrdb8323h
#define __INCrdb8323h
...
#define UCC1_PRAM_BASE         0x8400
#define UCC2_PRAM_BASE         0x8500
#define UCC3_PRAM_BASE         0x8600
#define UCC4_PRAM_BASE         0x9000
#define UCC5_PRAM_BASE         0x8000
#define UCC6_PRAM_BASE         0x8100
#define UCC7_PRAM_BASE         0x8200
#define UCC8_PRAM_BASE         0x8300

#define QE_MUX                 (QUICC_ENGINE_BA + 0x400)

/* CPM mux FCC clock route register */

#define QE_CMXGCR(base)    (CAST(VUINT32 *)((base) + QE_MUX + 0x00))
...
/* CMXGCR general clock routing register */

#define QE_CMXGCR_TS1CLS            0x70000000
#define QE_CMXGCR_TS2CLS            0x07000000
#define QE_CMXGCR_CTCLS             0x00700000
#define QE_CMXGCR_MEM               0x00070000
#define QE_CMXGCR_RTC               0x00007000
...
#define QE_CMXUCR3_UCC2_RX_DIS      0x00000000
#define QE_CMXUCR3_UCC2_RX_BRG9     0x00100000
#define QE_CMXUCR3_UCC2_RX_BRG10    0x00200000
#define QE_CMXUCR3_UCC2_RX_BRG15    0x00300000
#define QE_CMXUCR3_UCC2_RX_BRG16    0x00400000
#define QE_CMXUCR3_UCC2_RX_CLK3     0x00500000
#define QE_CMXUCR3_UCC2_RX_CLK4     0x00600000
#define QE_CMXUCR3_UCC2_RX_CLK17    0x00700000
#define QE_CMXUCR3_UCC2_RX_CLK18    0x00800000
#define QE_CMXUCR3_UCC2_RX_CLK7     0x00900000
#define QE_CMXUCR3_UCC2_RX_CLK8     0x00A00000
#define QE_CMXUCR3_UCC2_RX_CLK16    0x00B00000

#define QE_CMXUCR3_UCC2_TX_DIS      0x00000000
#define QE_CMXUCR3_UCC2_TX_BRG9     0x00010000
#define QE_CMXUCR3_UCC2_TX_BRG10    0x00020000
#define QE_CMXUCR3_UCC2_TX_BRG15    0x00030000
#define QE_CMXUCR3_UCC2_TX_BRG16    0x00040000
#define QE_CMXUCR3_UCC2_TX_CLK3     0x00050000
#define QE_CMXUCR3_UCC2_TX_CLK4     0x00060000
#define QE_CMXUCR3_UCC2_TX_CLK17    0x00070000
#define QE_CMXUCR3_UCC2_TX_CLK18    0x00080000
#define QE_CMXUCR3_UCC2_TX_CLK7     0x00090000
#define QE_CMXUCR3_UCC2_TX_CLK8     0x000A0000
#define QE_CMXUCR3_UCC2_TX_CLK16    0x000B0000
#define QE_CMXUCR3_UCC2_TX_TBIRX1   0x000C0000

#define QE_CMXUCR3_UCC4_RX_DIS      0x00000000
#define QE_CMXUCR3_UCC4_RX_BRG9     0x00000010
#define QE_CMXUCR3_UCC4_RX_BRG10    0x00000020
#define QE_CMXUCR3_UCC4_RX_BRG15    0x00000030
#define QE_CMXUCR3_UCC4_RX_BRG16    0x00000040
#define QE_CMXUCR3_UCC4_RX_CLK3     0x00000050
#define QE_CMXUCR3_UCC4_RX_CLK4     0x00000060
#define QE_CMXUCR3_UCC4_RX_CLK17    0x00000070
#define QE_CMXUCR3_UCC4_RX_CLK18    0x00000080
#define QE_CMXUCR3_UCC4_RX_CLK7     0x00000090
#define QE_CMXUCR3_UCC4_RX_CLK8     0x000000A0
#define QE_CMXUCR3_UCC4_RX_CLK16    0x000000B0

#define QE_CMXUCR3_UCC4_TX_DIS      0x00000000
#define QE_CMXUCR3_UCC4_TX_BRG9     0x00000001
#define QE_CMXUCR3_UCC4_TX_BRG10    0x00000002
#define QE_CMXUCR3_UCC4_TX_BRG15    0x00000003
#define QE_CMXUCR3_UCC4_TX_BRG16    0x00000004
#define QE_CMXUCR3_UCC4_TX_CLK3     0x00000005
#define QE_CMXUCR3_UCC4_TX_CLK4     0x00000006
#define QE_CMXUCR3_UCC4_TX_CLK17    0x00000007
#define QE_CMXUCR3_UCC4_TX_CLK18    0x00000008
#define QE_CMXUCR3_UCC4_TX_CLK7     0x00000009
#define QE_CMXUCR3_UCC4_TX_CLK8     0x0000000A
#define QE_CMXUCR3_UCC4_TX_CLK16    0x0000000B

#define QE_CMXUCR1_UCC3_RX_DIS      0x00000000
#define QE_CMXUCR1_UCC3_RX_BRG1     0x00000010
#define QE_CMXUCR1_UCC3_RX_BRG2     0x00000020
#define QE_CMXUCR1_UCC3_RX_BRG7     0x00000030
#define QE_CMXUCR1_UCC3_RX_BRG8     0x00000040
#define QE_CMXUCR1_UCC3_RX_CLK9     0x00000050
#define QE_CMXUCR1_UCC3_RX_CLK10    0x00000060
#define QE_CMXUCR1_UCC3_RX_CLK11    0x00000070
#define QE_CMXUCR1_UCC3_RX_CLK12    0x00000080
#define QE_CMXUCR1_UCC3_RX_CLK15    0x00000090
#define QE_CMXUCR1_UCC3_RX_CLK16    0x000000A0

#define QE_CMXUCR1_UCC3_TX_DIS      0x00000000
#define QE_CMXUCR1_UCC3_TX_BRG1     0x00000001
#define QE_CMXUCR1_UCC3_TX_BRG2     0x00000002
#define QE_CMXUCR1_UCC3_TX_BRG7     0x00000003
#define QE_CMXUCR1_UCC3_TX_BRG8     0x00000004
#define QE_CMXUCR1_UCC3_TX_CLK9     0x00000005
#define QE_CMXUCR1_UCC3_TX_CLK10    0x00000006
#define QE_CMXUCR1_UCC3_TX_CLK11    0x00000007
#define QE_CMXUCR1_UCC3_TX_CLK12    0x00000008
#define QE_CMXUCR1_UCC3_TX_CLK15    0x00000009
#define QE_CMXUCR1_UCC3_TX_CLK16    0x0000000A
...
#define M83XX_DDRCDR(base) (CAST(VUINT32 *)((base) + SCCFG_REG_BA + 0x28))
...
#define  M8323_I2C_BASE         0x03000
#define  I2CADR                 0x03000
#define  I2CFDR                 0x03004
#define  I2CICR                 0x03008
#define  I2CISR                 0x0300c
#define  I2CIDR                 0x03010
#define  I2CDFSRR               0x03014

#define  M8323_I2CADR(base)    (CAST(VUINT8 *)((base) | I2CADR))
#define  M8323_I2CFDR(base)    (CAST(VUINT8 *)((base) | I2CFDR))
#define  M8323_I2CICR(base)    (CAST(VUINT8 *)((base) | I2CICR))
#define  M8323_I2CISR(base)    (CAST(VUINT8 *)((base) | I2CISR))
#define  M8323_I2CIDR(base)    (CAST(VUINT8 *)((base) | I2CIDR))
#define  M8323_I2CDFSRR(base)  (CAST(VUINT32 *)((base) | I2CDFSRR))
...
#define OR0_DEFAULT_VAL         0xfe006ff7
...
extern UINT32   sysBaudClkFreq(void);
