...
--------------------
01c,29oct04,mdo  Documentation fixes for apigen
01b,10mar03,cak Added IPMC serial support.
01a,01oct02,scb Adapted from hxeb100 base (ver 01b).
*/
...
void sysSerialHwInit (void)
    ...
    /* initialize the chips device descriptors */
