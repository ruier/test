/* sysDuart.h - MPC8641 duart driver configlette header file */
...
--------------------
01a,06mar06,dtr  modified from cds8548/sysDuart.h/01c
*/
...
#define N_DUART_CHANNELS 	3       	      /* 2 serial ports  */
#else
...
#define DUART_BAUD              115200   //9600          /* default baud rate */
#define DUART_REG_ADDR_INTERVAL 1                     /* duart vector register distance */

#if FALSE
#define XTAL                    1843200
#else
#define XTAL                    333000000 /* 66666666 */
#endif
