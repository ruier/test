/* romInit.s - ROM bootcode for ads8544 BSP */
...
--------------------
01c,09apr08,x_f  Added tlb for PIXIS.
...
start:    
    ...
    addis   r4, 0, 0x1004           /* TLBSEL = TLB1(CAM) , ESEL = 2 */
    ori     r4, r4, 0x0000
    mtspr   MAS0, r4
    addis   r5, 0, 0xc000           /* V = 1, IPROT = 1, TID = 0 */
    ori     r5, r5, _MMU_TLB_SZ_1M  /* TS = 0, TSIZE = 1 MByte page size */
    mtspr   MAS1, r5
    addis   r6, 0, HI(PIXIS_BASE)   /* EPN = PIXIS_BASE address */
    ori     r6, r6, 0x001a          /* WIMGE = 11010 */
    mtspr   MAS2, r6
    addis   r7, 0, HI(PIXIS_BASE)   /* RPN = PIXIS_BASE address */
    ori     r7, r7, 0x0015          /* Supervisor XWR*/
    mtspr   MAS3, r7
    isync   
    msync   
...
ccsrbarWait:
    ...
    WRITEADR(r6, r7, M85XX_LAWBAR0(CCSBAR), 0xf8000)
...
dllDelay4:
    ...
    /* PIXIS - registers */
    /* load OR3 */
    WRITEADR(r6,r7,M85XX_OR3 (CCSBAR),
             (LBC_CS3_LOCAL_SIZE_MASK & 0xffff0000) | 0x0ff7)

    /* load BR3 */
    WRITEADR(r6,r7,M85XX_BR3 (CCSBAR), \
             (LBC_CS3_LOCAL_ADRS & 0xffff0000) | 0x0801)
...
DDRInit400:    
    ...
    WRITEOFFSET(r6, r7, (DDR_SDRAM_INTERVAL), 0x06180100)
    WRITEOFFSET(r6, r7, (0xf08), 0x0000200)
