...
--------------------
01x,14jul09,my_  made 1st param of sysSectorErase() volatile,
                 use (FLASH_DEF *) to cast 1st param passed to sysFlashWrite()
                 (WIND173188)
01w,11jan07,b_m  Add Lite5200B S29GL128N support.
...
/* defines */
#define FLASH_29GL128N          0x7e

#define FLASH_SECTOR_MASK		0xfffe0000      /* sector size = 0x20000 */
