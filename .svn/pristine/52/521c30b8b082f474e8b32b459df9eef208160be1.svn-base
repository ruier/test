...
/*#ifndef PRJ_BUILD*/
#undef INCLUDE_MTD_I28F016_new             /* Intel: 28f016 */
 ...
 */
/* Flash memory size */
#define	FLASH_AVAILABLE_SIZE (LOGICPD_FLASH_BANK0_SIZE )
...
/* add by ff 2010.07.27  */
extern int sysGetCpuID(void);
unsigned int flash_baseAddr;
/*******************************************************************************
*
...
#if 0 /* ff 20100901  1111  */
    switch(sysGetCpuID())  /* add by ff 2010.07.27  */
    {
    case 0:
    	flash_baseAddr = 0xf0000000;
    	break;
    case 1:
    	flash_baseAddr = 0xf4000000;
    	break;
    case 2:
    	flash_baseAddr = 0xf8000000;
    	  break;
    case 3:
    	flash_baseAddr = 0xfc000000;
		break;
    default:
    	break;
    }
#endif 
    flash_baseAddr = FLASH_BASE_ADRS;
 
    tffsSocket[noOfDrives] =	"RFA";
    vol.window.baseAddress =	 flash_baseAddr >> 12;   /*  FLASH_BASE_ADRS  ff 20100901  2222   */
...
LOCAL void rfaSetWindow
    ...
    vol.window.baseAddress = flash_baseAddr >> 12;   /* FLASH_BASE_ADRS  ff 20100901  3333*/

    flSetWindowSize (&vol, FLASH_AVAILABLE_SIZE >> 12);
    }
...
#ifdef	HALF_FORMAT
	{0x80000l, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2, 0, NULL},
#else
	{RESERVER_FOR_IMAGE_SIZE, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2, 0, NULL},
#endif	/* HALF_FORMAT */
	FTL_FORMAT		
	};
