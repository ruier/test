...
/*
 * Copyright (c) 2000-2001, 2003-2005, 2008 Wind River Systems, Inc.
 *
...
--------------------
01m,28sep08,y_w  code clean up
01l,17mar08,mdg  Updated for mv7100.
...
void sysTffsMountDevs ()
    ...
    /* TFFS Devices are only mounted for core 0 */
    if (CPU1CHECK) 
        {
        return;
        }
