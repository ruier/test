...
/*
 * Copyright (c) 2007, 2008, 2012, 2013 Wind River Systems, Inc.
 *
...
--------------------
01k,04mar13,d_l  add function sysFslErrataCpuA005125. (WIND00403379)
                 code clean.
01j,21aug12,l_z  Better implementation for sysPCGet. (WIND00076160)
...
01e,11jan08,dtr  Remove enable branch prediction from sysInit, put in
                 sysHwInit.
...
#include <arch/ppc/mmuE500Lib.h>
    ...
    FUNC_EXPORT(sysFslErrataCpuA005125)
...
/******************************************************************************
*
* sysFslErrataCpuA005125 - This routine implements workaround
* to Errata A-005125.
*
* This routine reconfigures the SPR976 of the current CPU.
*
* RETURNS: N/A
*
* void sysFslErrataCpuA005125 (void)
*/

FUNC_BEGIN(sysFslErrataCpuA005125)

    /* A-005125 required core register SPR976 set bits 40:41 to 10 */
