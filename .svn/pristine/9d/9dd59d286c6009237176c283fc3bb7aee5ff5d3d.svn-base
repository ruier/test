...
/* device types */
	...
	#define MPC834X_I2C_CONTROLLER		0
	#define I2C_DRV_TYPE 				MPC834X_I2C_CONTROLLER
 ...
 */
	#define I2C_CYCLE_START(x)		i2cCycleMpc834xStart(x)
	#define I2C_CYCLE_STOP(x)		i2cCycleMpc834xStop(x)
	#define I2C_CYCLE_READ(x,ad,y)	i2cCycleMpc834xRead(x,ad,y)
	#define I2C_CYCLE_WRITE(x,wd)	i2cCycleMpc834xWrite(x,wd)
	#define I2C_CYCLE_ACKIN(x)		i2cCycleMpc834xAckIn(x)
	#define I2C_CYCLE_ACKOUT(x)	    i2cCycleMpc834xAckOut(x)
	#define I2C_KNOWN_STATE(x)		i2cCycleMpc834xKnownState(x)
	#define I2C_DELAY(d)		    i2cCycleMpc834xDelay(d)
