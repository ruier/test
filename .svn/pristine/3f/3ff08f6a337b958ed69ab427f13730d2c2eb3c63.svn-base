...
--------------------
01c,18apr11,liu  Fix SPI_LOOP define error. (WIND00253070)
01b,10dec10,y_y  fix the integer conversion warning
...
#define SPI_EN_BIT          0
#define SPI_EN              ((unsigned int)0x01 << (31 - SPI_EN_BIT))
#define SPI_LOOP_BIT        1
#define SPI_LOOP            (0x01 << (31 - SPI_LOOP_BIT))
