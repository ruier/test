...
#define CCSR   				0xff70      /*used for rominit.s   add by dongyang*/
#define CCSR_REDIRECT			(CCSBAR >> 16)
...
/* changed by dongyang */
#define PHY_MEM_SIZE   0x40000000   /*1GB*/
...
#define TIMING_CFG_3            0x100    /*8548ÖÐ½Ð×ö: EXTENDED_REF_REC*/
...
#define DMA1_REGBASE1               (CCSBAR + 0x21180)
#define DMA1_REGBASE2                (CCSBAR + 0x21200)
#define DMA1_REGBASE3                (CCSBAR + 0x21280)
