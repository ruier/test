...
--------------------
01h,14may12,d_l  Added support for P2020RDB-PCA board with DDR3. 
...
#else /* P2020RDB_PCA */
#   ifdef INCLUDE_DDR_ECC
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG),        0x67000008)
#   else  /* INCLUDE_DDR_ECC */
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG),        0x47000008)
#   endif  /* INCLUDE_DDR_ECC */
    ...
    WRITEOFFSET(r6, r7, (TIMING_CFG_1),         0x6F6B8846)
    WRITEOFFSET(r6, r7, (TIMING_CFG_2),         0x0FA8C8CC)
    WRITEOFFSET(r6, r7, (TIMING_CFG_4),         0x00220001)
    WRITEOFFSET(r6, r7, (TIMING_CFG_5),         0x02401400)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG_2),      0x24401040)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG),   0x00441421)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MODE_CFG_2), 0x00000000)
    WRITEOFFSET(r6, r7, (DDR_SDRAM_MD_CNTL),    0x00000000)
...
#else /* P2020RDB_PCA */
#   ifdef INCLUDE_DDR_ECC
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG),        0xe7000008)
#   else  /* INCLUDE_DDR_ECC */
    WRITEOFFSET(r6, r7, (DDR_SDRAM_CFG),        0xc7000008)
#   endif  /* INCLUDE_DDR_ECC */
#endif /* P2020RDB_PCA */
