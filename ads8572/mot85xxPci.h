/* mot85xxPci.h - Motorola cds8548 PCI Bridge setup header file */
...
--------------------
01c,30jun08,dtr  Mod Pci base address.
...
#define PCIEX2_REGBASE          (CCSBAR + 0x9000) /* Slot1 */
#define PCIEX3_REGBASE          (CCSBAR + 0x8000) /*ULi */
