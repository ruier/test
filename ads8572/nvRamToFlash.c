...
--------------------
01b,07dec12,d_l  remove erase align check in sysNvRamInit();
                 add erase align in FLASH_NVRAM_ERASE. (WIND00381792)
...
#define FLASH_NVRAM_ERASE     \
        ...
        (nvRamFlashInfo.offset & (~(nvRamFlashInfo.pFlashChip->uEraseSize - 1))), 1)
