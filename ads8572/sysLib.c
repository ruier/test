...
--------------------
02i,07mar13,d_l  add workaround for erratum A-005125. (WIND00403379)
02h,08nov12,l_z  Fix the AMP device filter. (WIND00387440)
02g,02jul12,mpc  Add support for TrueFFS. (WIND00202696)
02f,27jun12,l_z  Merge AMP support
...
#if defined(FSL_ERRATA_CPU_A005125)
IMPORT void sysFslErrataCpuA005125 (void);
#endif /* FSL_ERRATA_CPU_A005125 */
...
void sysHwInit (void)
    ...
    /*
     * Errata: A-005125 (In a very rare condition, a system hang is possible 
     * when the e500 core initiates a guarded load to PCI/PCIe/sRIO 
     * while the PCI/PCIe/sRIO performs a coherent write to memory.
     * No plan to fix.
     *
     * Workaround: Set SPR976[40:41] to b’10. This setting does not impact 
     * performance.
     */

    sysFslErrataCpuA005125();
#endif /* FSL_ERRATA_CPU_A005125 */
...
#   endif  /* VX_ENABLE_CPU_TIMEOUT */
    ...
    /*
     * For future reference:  DEVDISR is internal to the 8572 chip.
     * Platforms using multiple 8572's (i.e. more than two CPUs) cannot
     ...
     * access each 8572's CCSR space; and the &= operation below
