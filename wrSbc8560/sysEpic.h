...
#define EPIC_GCR_RESET		BIT(31)
#define EPIC_GCR_MODE_MIXED	BIT(29)

/* IPI Vector/Priority registers */

#define EPIC_IPIVPR_INTR_MSK        BIT(31)
#define EPIC_IPIVPR_INTR_ACTIVE     BIT(30)
#define EPIC_IPIVPR_PRIORITY_MSK    (BIT(19) | BIT(18) | BIT(17) | BIT(16))
...
#define EPIC_GTVPR_INTR_MSK        BIT(31)
#define EPIC_GTVPR_INTR_ACTIVE     BIT(30)
#define EPIC_GTVPR_PRIORITY_MSK    (BIT(19) | BIT(18) | BIT(17) | BIT(16))
...
#define EPIC_IRQSR0_MSG_INT(n)  (BIT(15-(n)) & EPIC_IRQSR0_MSG_INT_MSK)
#define EPIC_IRQSR0_EX_INT_MSK  0xfff
#define EPIC_IRQSR0_EX_INT(n)   (BIT(11-(n)) & EPIC_IRQSR0_EX_INT_MSK)
#define EPIC_IRQSR1_IN_INT(n)   BIT(31-(n))
#define EPIC_CISR0_MSG_INT_MSK  0xf000
#define EPIC_CISR0_MSG_INT(n)   (BIT(15-(n)) & EPIC_CISR0_MSG_INT_MSK)
#define EPIC_CISR0_EX_INT_MSK   0xfff
#define EPIC_CISR0_EX_INT(n)    (BIT(11-(n)) & EPIC_CISR0_EX_INT_MSK)
#define EPIC_CISR1_IN_INT(n)    BIT(31-(n))

/* Message registers */

#define EPIC_MER_EN_MSK         0xf
#define EPIC_MER_EN(n)          (BIT(n) & EPIC_MER_EN_MSK)
#define EPIC_MSR_ST_MSK         0xf
#define EPIC_MSR_ST(n)          (BIT(n) & EPIC_MER_ST_MSK)

/* EIVPR registers */

#define EPIC_EIVPR_INTR_MSK         BIT(31)
#define EPIC_EIVPR_INTR_ACTIVE      BIT(30)
#define EPIC_EIVPR_INTR_POLARITY    BIT(23)
#define EPIC_EIVPR_INTR_SENSE       BIT(22)
#define EPIC_EIVPR_POLARITY(p)      ((p) << 23)
#define EPIC_EIVPR_SENS(s)          ((s) << 22)
#define EPIC_EIVPR_PRIORITY_MSK	    (BIT(19) | BIT(18) | BIT(17) | BIT(16))
...
#define EPIC_EIDR_EX_PIN        BIT(31)
#define EPIC_EIDR_CRIT_INT      BIT(30)
...
#define EPIC_IIVPR_INTR_MSK         BIT(31)
#define EPIC_IIVPR_INTR_ACTIVE      BIT(30)
#define EPIC_IIVPR_INTR_POLARITY    BIT(23)
#define EPIC_IIVPR_POLARITY(p)      ((p) << 23)
#define EPIC_IIVPR_PRIORITY_MSK     (BIT(19) | BIT(18) | BIT(17) | BIT(16))
...
#define EPIC_IIDR_EX_PIN        BIT(31)
#define EPIC_IIDR_CRIT_INT      BIT(30)

/* MIVPR registers */

#define EPIC_MIVPR_INTR_MSK         BIT(31)
#define EPIC_MIVPR_INTR_ACTIVE      BIT(30)
#define EPIC_MIVPR_PRIORITY_MSK     (BIT(19) | BIT(18) | BIT(17) | BIT(16))
...
#define EPIC_MIDR_EX_PIN        BIT(31)
#define EPIC_MIDR_CRIT_INT      BIT(30)

/* IPIDR registers */

#define EPIC_IPIDR_P0           BIT(0)

/* CTPR register */

#define EPIC_CTPR_TASKPRI_MSK   (BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define EPIC_CTPR_TASKPRI(p)    ((p) & EPIC_CTPR_TASKPRI_MSK)

/* WHOAMI register */

#define EPIC_WHOAMI_ID_MSK      (BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define EPIC_RESV15_INT_NUM         15
#define EPIC_RESV15_INT_VEC         (EPIC_RESV15_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RESV16_INT_NUM         16
#define EPIC_RESV16_INT_VEC         (EPIC_RESV16_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RESV17_INT_NUM         17
#define EPIC_RESV17_INT_VEC         (EPIC_RESV17_INT_NUM + EPIC_VEC_IN_IRQ0)
...
#define EPIC_RESV21_INT_NUM         21
#define EPIC_RESV21_INT_VEC         (EPIC_RESV21_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RESV22_INT_NUM         22
#define EPIC_RESV22_INT_VEC         (EPIC_RESV22_INT_NUM + EPIC_VEC_IN_IRQ0)
#define EPIC_RESV23_INT_NUM         23
#define EPIC_RESV23_INT_VEC         (EPIC_RESV23_INT_NUM + EPIC_VEC_IN_IRQ0)
