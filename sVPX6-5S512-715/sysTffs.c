...
--------------------
01b,13nov09,rab  Use MAIN_FLASH_SIZE for P4080DS.
01a,14may09,syt  derived from version 01a of fsl_mds8536_ds/sysTffs.c.
*/
...
LOCAL void rfaRegister (void)
    ...
    vol.window.baseAddress = TFFS_FLASH_BASE_ADDR>> 12;
