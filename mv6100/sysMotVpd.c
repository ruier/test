...
01e,05feb03,cak  Fixed an old bug in the sysMotVpdPktGet() routine.
01d,07jan03,cak  Removed check for Product Configuration Options packet from
		 sysMotVpdInit.
01c,11sep02,cak  Modified sysMotI2cRead call.
01b,29aug02,cak  Modified following debug on hxeb100. 
01a,03jun02,cak  Created from ver 01b, mcp820/sysMotVpd.c and ver 01b,
		 mcp820/sysMotVpdUtil.c.
*/
