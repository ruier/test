...
--------------------
01j,25sep07,pdg  Fixed doc errors
01i,05sep07,jrp  APIGEN updates
01h,30jul06,tor  merge PCI support modifications
...
void sysEpicIntrEntryShow(int vec)
    {
    INT_HANDLER_DESC * pEnt;
    ...
    while ( pEnt != NULL )
        {
	printf("\tfunc @ 0x%08x arg = 0x%08x\n", pEnt->vec, pEnt->arg);
	pEnt = pEnt->next;
	}
    }

int sysEpicIntrShow(int vec)
    { 
    int vector;
	...
	for (vector = 0; vector < INTERRUPT_TABLESIZE; vector++)
	    sysEpicIntrEntryShow(vector);
	}
    else
        {
	sysEpicIntrEntryShow(vec);
	}
...
* 
* This routine returns the vector register address
* 
* RETURNS: ERROR or vector register address
*/
...
/*******************************************************************************
*
* epicCrtIntSet - set EPIC interrupt bit
*
* This function sets the interrupt bit of the EPIC interrupt controller
*
...
/*******************************************************************************
*
* epicCrtIntUnset - unset EPIC interrupt bit
*
* This function unsets the interrupt bit of the EPIC interrupt controller
*
* RETURNS: OK or an error
*
*/
...
/*******************************************************************************
*
* epicCrtIntGet - get the EPIC interrupt bit
*
* This function gets the interrupt bit of the EPIC
*
...
/*******************************************************************************
*
* sysEpicCrtIntSet - set EPIC interrupt bit
*
* This function sets the interrupt bit of the EPIC interrupt controller
*
* RETURNS: OK or an error
...
/*******************************************************************************
*
* sysEpicCrtIntUnset - unset EPIC interrupt bit
*
* This function unsets the interrupt bit of the EPIC interrupt controller
*
* RETURNS: OK or an error
...
/*******************************************************************************
*
* sysEpicCrtIntGet - get the EPIC interrupt bit for the vector address
*
* This function gets the interrupt bit of the EPIC
*
* RETURNS: interrupt bits
*
*\NOMANUAL
*/
...
/*******************************************************************************
*
* epicEOI - signal end of interrupt on the EPIC
*
...
/*******************************************************************************
*
* epicSrcAddrCheck - check VPR address
*
* check if the VPR address passed in is external, internal, timer, message, or
* IPI.
*
* NOMANUAL
* 
