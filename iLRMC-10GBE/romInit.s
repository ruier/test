...
skipCcfRecfg:
    ...
    addis  r6, 0, HI(LAWAR0_BASE_ADRS)   /* EPN */
    ori    r6,r6,MMU_ROM_ACCESS
    addis  r7, 0, HI(LAWAR0_BASE_ADRS)   /* RPN */
    ori    r7,r7,0x0015          /* Supervisor XWR*/
...
ccsrbarWait:
    ...
    WRITEADR(r6,r7,P4080_LAWBARL0(CCSBAR),LAWAR0_BASE_ADRS)
    sync
...
dllDelay4:
	...
	lis	r9,0xFE00
	ori	r9,r9,17664
	li	r0,183 /*44 for 400M*/
	stb	r0,0(r9)

	lis	r9,0xFE00
	ori	r9,r9,17665
	li	r0,12 /*10 for 400M*/
	stb	r0,0(r9)
