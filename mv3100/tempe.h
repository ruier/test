...
--------------------
01b,07may13,d_l Fixed build warnings.
...
#define TEMPE_VEAT_VES_MASK		((UINT32)(1<<TEMPE_VEAT_VES_BIT))
...
#define TEMPE_EDPAT_EDPST_MASK		((UINT32)(1<<TEMPE_EDPAT_EDPST_BIT))
...
#define TEMPE_OTATx_EN_MASK		((UINT32)(1<<TEMPE_OTATx_EN_BIT))
#define TEMPE_OTATx_EN_VAL_ENABLED	((UINT32)(1<<TEMPE_OTATx_EN_BIT))
...
#define TEMPE_ITATx_EN_MASK		((UINT32)(1<<TEMPE_ITATx_EN_BIT))
#define TEMPE_ITATx_EN_VAL_ENABLED	((UINT32)(1<<TEMPE_ITATx_EN_BIT))
...
typedef struct 
    {
    int intLvl;			/* intConnect() interrupt level */
    int bit;			/* bit position in register */
    } TEMPE_INTLVL_BIT;
...
#define FSET32(img,val,bitPos) img |= (UINT32)(val << bitPos)
...
typedef struct  vmeOutWindowCfg
    ...
    rdPrefetchSize_t  rdPrefetchSize;      /* Prefetch Read Size (in 
					      Cache Lines) */
