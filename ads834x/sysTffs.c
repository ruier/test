...
--------------------
01d,23jan08,z_l  Support MDS8349EA, routines are derived from version 01b
                 of fsl_mds8568/sysTffs.c.
01c,17aug05,dtr  Add cfiscs.c driver include for ease of build.
01b,21jun05,pcm  removed #include "dosFsLib.h"
...
#ifndef MPC8349EA_MDS
/* globals */
char pcDriveNo[2] = {0, 0};	/* drive number of the sockets */
#endif
...
LOCAL void rfaRegister (void)
    ...
    vol.window.baseAddress = (FLASH_BASE_ADRS + 0x300000) >> 12;
...
LOCAL void rfaSetWindow
    ...
    vol.window.baseAddress = (FLASH_BASE_ADRS + 0x400000) >> 12;

    flSetWindowSize (&vol, FLASH_WINDOW_SIZE >> 12);

#else
    /* Physical base as a 4K page */
    flSetWindowSize (&vol, (FLASH_SIZE / 2) >> 12);
#endif
    }
...
STATUS sysTffsFormat (void)
	...
	{
	{0x00000l, 10, 1, 0x10000l, NULL, {0,0,0,0}, NULL, 2, 0, NULL},
...
STATUS sysTffsFormat (void)
    ...
    tffsDevFormatParams params =
    {
        {FLASH_SIZE / 2, 99, 1, 0x10000l, PROGRESS_CB, {0,0,0,0}, NULL, 2, 0, NULL},
