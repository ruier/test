/* sysALib.s - mv7100 system-dependent assembly routines */
...
--------------------
01m,21apr10,e_d  Store cpuId to PIR for both SMP and AMP.
01l,10feb09,e_d  Add support for wrload.
01k,06feb09,e_d  Change _WRS_VX_SMP to _WRS_CONFIG_SMP
...
FUNC_BEGIN(sysCpu1Start)
        WRITEADR(r4, r5, (CCSBAR + CCSR_MCM_PCR), 0x03000000)
        isync
        sync
        eieio
        blr
...
FUNC_BEGIN(sysCpu1Stop)
        WRITEADR(r4, r5, (CCSBAR + CCSR_MCM_PCR), 0x01000000)
        isync
        sync
        eieio
        blr
