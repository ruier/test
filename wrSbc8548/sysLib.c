...
--------------------
01m,21nov11,ers  Moved L1 parity handling to arch. (WIND00309426)
01l,26may10,yjw  Fix incorrect static TLB entries for flash. (WIND00212654)
...
TLB_ENTRY_DESC sysStaticTlbDesc [] =
{
    ...
    { FLASH_BASE_ADRS & FLASH_ADRS_MASK, 0x0, FLASH_BASE_ADRS & FLASH_ADRS_MASK, _MMU_TLB_TS_0 | BOOT_FLASH_TLB_SIZE |
...
#ifdef INCLUDE_TFFS   
    ,
    { FLASH1_BASE_ADRS & FLASH1_ADRS_MASK, 0x0, FLASH1_BASE_ADRS & FLASH1_ADRS_MASK, _MMU_TLB_TS_0 | TFFS_FLASH_TLB_SIZE |
        _MMU_TLB_ATTR_I | _MMU_TLB_ATTR_G | _MMU_TLB_PERM_W
    }
#endif
