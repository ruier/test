/* usrCoprocSimnt.c - SIMNT coprocessor discovery & initialization */
...
This module implements the process of discovery and initialization for SIMNT
family coprocessors.
...
void coprocDescriptorsInit
    ...
    for (pDesc = pDescList; pDesc != NULL; pDesc = pDesc->next)
		...
		pDesc->pEnableRtn     = fppEnable;
		pDesc->pDisableRtn    = fppDisable;
