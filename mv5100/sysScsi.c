...
--------------------
01t,22jun05,pcm  modified for use with new FS framework
01s,01sep04,jyo  Fixing SPR 100119: Removing references to RT11.
01r,31jan02,pmr  added setting of sym895DelayCount to sysScsiInit() (SPR 72961)
01q,08mar01,rhk  Additional code cleanup.
01p,16aug00,dmw  Cleanup following Wind River coding standards review.
01o,19jun00,dmw  Made pSysScsiCtrl point to 895 device.
01n,27mar00,bsp  added sysSym895PciInit() for SYMBIOS 895 SCSI Host adapter.
                 added SYM895 controller create routines to sysScsiInit().
01m,03may99,srr  updated with new WRS naming conventions.
...
/* 
 * The following MACRO definitions will be done in config.h after SYM895 is
 * componentiaed. Temporarily done here.
 */
...
STATUS sysSym895PciInit(void)
    ...
    sym895PciMemOffset = PCI2DRAM_BASE_ADRS;
...
*
* This routine includes two configuration examples that demonstrate
...
STATUS sysScsiConfig (void)
     ...
     *
     * In order to configure a hard disk and initialise a file system, 
     * the following initialisation code will serve as an example.
     */
     ...
     * arguments like mode parameters are highly devcie and vendor specific.
