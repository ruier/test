/* sysLib.c - IBM750CL Evaluation Board system-dependent library */
...
--------------------
01l,21jul10,liu  fixed VIP with INCLUDE_SIO_UTILS build fail.(WIND00224257)
01k,30apr10,dhy  delete _MMU_UBAT_VP attribute(WIND00162540)
01j,15jul09,my_  fixed diab compiler warnings (WIND00173188)
01i,17oct08,x_f  fix vxWorks build error.(WIND00134545)
01h,03jul08,y_w  added VxBus support and code cleanup
01g,23oct07,y_w  added complete support for booting from big flash.
...
UINT32 sysBatDesc [2 * (_MMU_NUM_IBAT + _MMU_NUM_DBAT +_MMU_NUM_EXTRA_IBAT+_MMU_NUM_EXTRA_DBAT)] =
     ...
     * They are not supported on the IBM750CL at present.
...
#ifdef  INCLUDE_FLASH
/*
 * When booting from big flash, 
 * 0xe6000000 - 0xe6008000, for small flash, 512KB
 * 0xfe000000 - 0xffffffff, for big flash, 32MB
 ...
 *      AD9: 10-11
 *
 * When booting from small flash,
 * 0xe6000000 - 0xe7ffffff, for big flash, 32MB
 * 0xfff00000 - 0xfff80000, for small flash, 512KB
 * Jumpers configuration:
 * J14: 3-1
 * J15: 3-4
 * J1 : AD2: 1-2
 ...
 */
    ...
    ,
    {
    (VIRT_ADDR) SMALL_FLASH_ADRS,
    (PHYS_ADDR) SMALL_FLASH_ADRS,
    SMALL_FLASH_SIZE,
    VM_STATE_MASK_VALID | VM_STATE_MASK_WRITABLE | VM_STATE_MASK_CACHEABLE  |
    VM_STATE_MASK_GUARDED,
    VM_STATE_VALID      | VM_STATE_WRITABLE      | VM_STATE_CACHEABLE_NOT   |
...
/* NVRAM init and access routines */
...
void sysHwInit (void)
    ...
    /* Initialize Tsi109/110 switching fabric and BARs (other than SDRAM). */
...
*
* The bspSerialChanGet() routine returns a pointer to the SIO_CHAN
