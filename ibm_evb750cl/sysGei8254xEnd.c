/* sysGei8254xEnd.c - Intel 82540/82543/82544/82545/82546 END support */

/*
 * Copyright (c) 2004-2006, 2008 Wind River Systems, Inc.
 *
...
--------------------
01f,18oct08,x_f  Fix the procedure of PCI enable.(WIND00134545)
01e,13mar06,dtr  Add 82545EM to list - treat as 82544.
01d,27jan06,dtr  Tidyup - coding conventions.
01c,10nov05,mdo  Documentation fixes for apigen
01b,22mar05,dtr  Fix typos.
01a,04nov04,jln  ported from 01n/sysGei82543End.c/pc386
*/
...
SEE ALSO: ifLib,
\tb RS82543GC GIGABIT ETHERNET CONTROLLER NETWORKING SILICON DEVELOPER'S MANUAL 

INCLUDE FILES: drv/end/gei82543End.h
*/
...
#define PRO1000_545_PCI_DEVICE_ID_EM    (0x100f) /* Copper */
...
#define PRO1000_545_PCI_DEVICE_ID_MT    (0x1026) /* Copper */
...
LOCAL int geiUnits = 0;     /* number of GEIs we found */

/* This table defined board extended resources */

LOCAL GEI_RESOURCE geiResources [GEI_MAX_DEV] =
    {
    {FALSE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, GEI_EEPROM_SZ_64, 0, 0, 
	 {(UCHAR)NONE}, (UINT32)GEI0_SHMEM_BASE, GEI0_SHMEM_SIZE, GEI0_RXDES_NUM, 
	 GEI0_TXDES_NUM, FALSE, GEI0_USR_FLAG, ERROR
    },

    {FALSE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, GEI_EEPROM_SZ_64, 0, 0, 
     {(UCHAR)NONE}, (UINT32)GEI1_SHMEM_BASE, GEI1_SHMEM_SIZE, GEI1_RXDES_NUM, 
     GEI1_TXDES_NUM, FALSE, GEI1_USR_FLAG, ERROR
    },

    {FALSE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, GEI_EEPROM_SZ_64, 0, 0, 
     {(UCHAR)NONE}, (UINT32)GEI2_SHMEM_BASE, GEI2_SHMEM_SIZE, GEI2_RXDES_NUM, 
     GEI2_TXDES_NUM, FALSE, GEI2_USR_FLAG, ERROR
    },

    {FALSE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, GEI_EEPROM_SZ_64, 0, 0, 
     {(UCHAR)NONE}, (UINT32)GEI3_SHMEM_BASE, GEI3_SHMEM_SIZE, GEI3_RXDES_NUM, 
     GEI3_TXDES_NUM, FALSE, GEI3_USR_FLAG, ERROR
    }
    };
...
LOCAL PCI_BOARD_RESOURCE geiPciResources [GEI_MAX_DEV] =
    {
    {NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
	 (UINT32)NONE, (UINT8)NONE, (UINT32)NONE, (UINT8)NONE, (UINT32)NONE,
     {(UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
      (UINT32)NONE}, (void * const)(&geiResources[0])
    },

    {NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
     (UINT32)NONE, (UINT8)NONE, (UINT32)NONE, (UINT8)NONE, (UINT32)NONE,
     {(UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
      (UINT32)NONE}, (void * const)(&geiResources[1])
    },

    {NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
     (UINT32)NONE, (UINT8)NONE, (UINT32)NONE, (UINT8)NONE, (UINT32)NONE,
     {(UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
      (UINT32)NONE}, (void * const)(&geiResources[2])
    },

    {NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
     (UINT32)NONE, (UINT8)NONE, (UINT32)NONE, (UINT8)NONE, (UINT32)NONE,
     {(UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, (UINT32)NONE, 
      (UINT32)NONE}, (void * const)(&geiResources[3])
    }
    };
...
LOCAL void      sysGei543UsDelay (void);

STATUS sys543PciInit (UINT32,UINT32,UINT32,UINT32,UINT32,UINT8,UINT32,int);  
...
STATUS sys82543BoardInit
    ...
    if (pRsrc->boardType == PRO1000_546_BOARD)
	    ...
	    devId == PRO1000_546_PCI_DEVICE_ID_XT) 
	    {        
            UINT8 headerType;
    ...
    pBoard->regBaseLow  = (UINT32)PCI_MEMIO2LOCAL(pReso->memBaseLow);
    pBoard->flashBase   = (UINT32)PCI_MEMIO2LOCAL(pReso->flashBase);
    ...
    pBoard->delayFunc     = (FUNCPTR) sysGei543UsDelay;
...
/*************************************************************************
*
* sys543eepromReadBits - read bits from the EEPROM
*
* This routine reads bit data from the EEPROM.
*
* RETURNS: 16-bit value read a bit at a time
*
* ERRNO: N/A
*/
...
/*************************************************************************
*
* sys543eepromWriteBits - writes a bits to EEPROM
*
...
*
* This routine gets an Ethernet address from EEPROM.
*
* RETURNS: OK or ERROR
*
* ERRNO: N/A
...
*
* This routine performs the EEPROM checksum.
*
* RETURNS: OK, or ERROR
*
* ERRNO: N/A
...
/**************************************************************************
*
* sys543PhySpecRegsInit - initializes PHY specific registers
*
...
/*****************************************************************************
*
* sys543IntAck - acknowledge an 8254x interrupt  - placeholder unused
*
* RETURNS: OK
*
* ERRNO: N/A
...
/*****************************************************************************
*
* sys543IntEnable - enable 8254x chip interrupts - placeholder unused
*
* RETURNS: OK
*
* ERRNO: N/A
...
LOCAL STATUS sys543IntEnable
    ...
    /* Enable global request from PCI block here */

    sysTsi108MpicIntUnmask(INT_VEC_PCI);
...
/*****************************************************************************
*
* sys543IntDisable - disable 8254x chip interrupts - placeholder unused
*
*
* RETURNS: OK
*
...
/*****************************************************************************
*
* sys543Show - show 8254x chip configuration 
*
...
void sys543Show
    ...
    printf ("  PCI sys no.= %d, PCI bus no.= %d, device no.= %d, function no.= %d\n", 
             pRsrc->pciSysNum, pRsrc->pciBus, pRsrc->pciDevice, pRsrc->pciFunc);
...
/*******************************************************************************
*
* sysGei543UsDelay - 1 micro second delay
* 
* This function delays one microsecond.
* 
* RETURNS: N/A
*
* ERRNO: N/A
...
LOCAL UINT32 sysGeiDevToType
    ...
    if (vendorId == PRO1000_PCI_VENDOR_ID)
	    ...
	    case PRO1000_545_PCI_DEVICE_ID_MT:
