...
/*
 * Copyright (c) 1994-2013 Wind River Systems, Inc.
 *
...
--------------------
32w,28apr13,ghs  Add support of USB message (WIND00411952)
32v,18jan13,y_y  Added support for multi tffs devices mount.
32u,21dec12,cww  Added taskCreateHookInit (WIND00395260)
32t,01nov12,x_s  Replaced cacheEnable() with usrCacheEnable().
32s,26jun12,jpb  Defect WIND00347614.  Fixed warnings for implicit
                 declarations.
32r,26apr12,mpc  Removed usrNetworkInit (WIND00347629)
32q,03feb12,l_z  Add EEPROM support
32p,31jan12,jdw  Conditionally include usrNetworkInit() for default VSB,
                 WIND00329604
32o,13jan12,zl   initialize sysExcMsg string (WIND00318907).
32n,04jan12,d_c  Defect WIND00202474 Fix WIND00318218: Remove
                 INCLUDE_BOOT_VXBUS component code
32n,07dec11,cww  Ensure sysExcMsg is updated when ED&R is invoked prior to
                 usrRoot (WIND00111567)
32m,30dec11,zly  WIND00217466: add a direct mode for xbd.  
32l,09aug11,w_x  Added call to usrUsbOtgInit (WIND00291850)
32k,05jul11,rdl  WIND00255358 rework power management initialization
32j,28jun11,jxu  Added a parameter to pipeDrv (WIND00271309).
32i,20jun11,rec  change INCLUDE_DEV_POWER_MANAGEMENT to INCLUDE_DEV_PWR_MGMT
32h,20jun11,rec  change INCLUDE_POWER_MGMT_CPU_BSP_SUPPORT to 
                 INCLUDE_TICKLESS_IDLE
32g,01jun11,rec  WIND00255358 add device power management
32f,19may11,scm  WIND0023899, Adjust for 64 bit support...
32e,22mar11,ghs  Add command line build support for USB serial emulator(WIND00262317)
32d,18jan11,w_x  Initial USB OTG support changes (WIND00211541)
32c,04jan11,rec  add add sleepFilterInterval
32b,22nov10,rec  add odgPolicyMgrLib
32a,19oct10,rec  add cpuPwrArchLibInit prototype
20z,06jan11,pgh  Update bootUsbFsLoadInit() in include bulk device name.
20y,07dec10,ghs  Change initialization order of class driver (WIND00245236)
20x,07dec10,???  Fix INCLUDE_SECURITY vs INCLUDE_IPCOM init order
20x,12nov10,jb  Fix for Defect WIND00236404 - USB included
20w,22oct10,rlp  Added system debug flag initialization.
		 Removed ED&R debug flag initialization.
20v,13aug10,pgh  Add include of caviumLib.h
20u,28jul10,d_c  Add call to initialize Cavium support library
30u,24jun10,pmr  support extended vectors in bootrom (PPC)
32b,16jul10,v_r  Fixed macro error around INCLUDE_SECURITY initialization.
32a,06jul10,v_r  Added login security facility boolean (req CQ:WIND00190686).
		 Overhauled security component initialization.
31z,27jul10,cww  Delayed kprintf initialization for 64-bit
31y,27jul10,pgh  Add ELF memory map component to MIPS bootrom
31v,19jun10,pch  small footprint
31u,14jun10,jb   Enable bootrom USB nvram for IA
31t,10jun10,ghs  Add usb serial init
31s,20may10,jpb  Updated name of boot flag.
31r,14apr10,rlp  Renamed vxdbgTaskCreateHooksInit() to vxdbgHooksInit().
31q,26feb10,kk   remove duplicate calls to envLibInit() (WIND00201819)
31p,18feb10,d_c  Defect WIND00200672 Fix WIND00200673 - add prototype for
		 vxCpuLibInit()
31o,26jan10,d_c  SMP M-N updates: Add call to vxCpuLibInit().
31n,08jan10,s_s  Calling envLibInit() soon after initializing the memory in
                 usrRoot() (defect CQ:WIND00194940)
31m,04may10,rec  CPU performance management support
31l,04apr10,j_l  Added INCLUDE_BOOT_GO_OVERRIDE.
31k,01apr10,jpb  Added support for user-reserved memory.
31j,25feb10,rlp  Added VxDBG component.
31i,18feb10,d_c  Defect WIND00200672 Fix WIND00200673 - add prototype for
		 vxCpuLibInit()
31h,26jan10,d_c  SMP M-N updates: Add call to vxCpuLibInit().
31g,20jan10,zl   added INCLUDE_PG_MGR_BASIC and INCLUDE_MMAP
31f,14jan10,cwl  Remove the function aimMmuShowInit(). (WIND00184839)
31d,04nov09,pcs  Updated to reflect the name changes to the 64bit heaps.
31c,04nov09,h_k  added VxBus disk drive create method call. (WIND00189354)
31b,30sep09,cww  Added sysHwInit1
31a,23oct09,s_s  added kprintf defines to support BSP build (WIND00186733)
30z,15oct09,hui  Updated call to usrHrfsInit() for remove commit policy stuff
30y,25sep09,pcs  Rename memInit2 to memSysHeapCreate, pass additional
                 parameters to support heap growth.
30x,22sep09,h_k  added INCLUDE_CACHE_DMA32_LIB.
30w,16sep09,jmp  removed shell commands prototypes: replaced shellCmdP.h
                 inclusion.
30v,08sep09,pcs  Updated to add support for multiple heaps for 64bit vxWorks.
30u,24aug09,cww  Added deferred interrupt enable and reorder hwInit for 64-bit
30t,13aug09,cww  Reorder usrRoot for early VM initialization
30s,21sep09,v_r  Now including loginLibP.h (part of def CQ:WIND00155318 fix).
30r,08sep09,y_l  Fix compile error(usb macro definition error) (WIND00180571).
30q,14aug09,jpb  Defect# 161788. Removed setLib references.
30p,14aug09,hps  update dosfs cache name
30o,06aug09,zly  Added initialization code for TRFS(WIND00108098)
30n,28jul09,e_d  Removed the name detection for ATA device.(WIND00139792)
30m,02jul09,s_z  Remove GEN2 USB-Ethernet hardware related initialization
30l,14apr09,v_r  Added private shell-related includes.
30k,01apr09,zl   renamed jobLibInit() to jobTaskLibInit() entries.
30j,21apr09,jpb  Replaced setLib.h with setLibP.h.
30i,05mar09,s_z  Added USB GEN2 Usb-Ethernet class driver support
30h,17mar09,w_x  Added INCLUDE_SER_EMULATOR_INIT for USB CDC serial emulation
30g,03feb09,zl   unified usrKernelInit() for project and BSP builds
...
#include <usrKernelCore.c>		/* core kernel configuration */
...
#ifdef INCLUDE_ACPI_BOOT_OP
#include <hwif/fw/acpiLib.h>
#include <bootApp.h>
#endif	/* INCLUDE_ACPI_BOOT_OP */
...
# endif	/* INCLUDE_IO_REMOVABLE */
# ifndef INCLUDE_SET
#  define INCLUDE_SET
# endif	/* INCLUDE_SET */
#endif	/* INCLUDE_IO_FILE_SYSTEM */

#if defined(INCLUDE_IO_REMOVABLE) && !defined(INCLUDE_IO_BASIC)
# define INCLUDE_IO_BASIC
#endif

#ifdef INCLUDE_EEPROMDRV
extern STATUS eepromDrv(void);
#endif /* INCLUDE_EEPROMDRV */
...
#if	defined(INCLUDE_PG_MGR_LIB) || defined(INCLUDE_PG_MGR_BASIC)
#include <private/pgMgrLibP.h>
#endif /* INCLUDE_PG_MGR_LIB || INCLUDE_PG_MGR_BASIC */
...
#endif	/* INCLUDE_SHELL_HISTORY_FILE */
#endif	/* INCLUDE_SHELL */
...
#include <private/eventPointLibP.h>	    /* eventPointLibInit */
#endif /* INCLUDE_EVENTPOINT */

#ifdef INCLUDE_SV_DATACOLLECTOR
#include <private/svDataCollectorLibP.h>    /* svDataCollectorLibInit */
#endif /* INCLUDE_SV_DATACOLLECTOR */
...
#endif /* INCLUDE_VXBUS && INCLUDE_VXB_CMDLINE */

#ifdef INCLUDE_CAVIUM_LIB
#include "arch/mips/caviumLib.h"
#endif /* INCLUDE_CAVIUM_LIB */
...
#endif	/* INCLUDE_BOOT_EXC_HANDLER */
...
#endif	/* INCLUDE_BOOT_INIT || INCLUDE_BOOT_DELAYED_INIT */
#ifdef INCLUDE_ELF
STATUS bootElfInit (void);
#endif	/* INCLUDE_ELF */
#ifdef INCLUDE_ELF_MEMORY_MAP
void elfMemMapInit(void);
#endif /* INCLUDE_ELF_MEMORY_MAP */
#ifdef INCLUDE_BOOT_SHELL
STATUS bootAppShellInit (void);
#ifdef INCLUDE_BOOT_MEM_CMDS
STATUS bootAppMemInit (void * memBase);
#endif	/* INCLUDE_BOOT_MEM_CMDS */
#ifdef INCLUDE_BOOT_EDR_SUPPORT
STATUS bootAppEdrInit (void);
#endif	/* INCLUDE_BOOT_EDR_SUPPORT */
...
# endif /* CPU_FAMILY == PPC && defined(INCLUDE_EXC_EXTENDED_VECTORS) */
...
#ifdef INCLUDE_CAVIUM_LIB
    cavLibInit();		               /* initialize Cavium support */
#endif /* INCLUDE_CAVIUM_LIB */
...
#ifdef	INCLUDE_VXMEMPROBE_INIT
    vxMemProbeInit ();
#endif /* INCLUDE_VXMEMPROBE_INIT */

#ifdef	INCLUDE_WINDVIEW
    /* 
     * wvLibInit should be called before any objects are created. This is
     * to allow it to log object creation. 
     */

    wvLibInit ();			/* initialize windview */
#endif	/* INCLUDE_WINDVIEW */

    /* initilaize class, object, semaphore, etc */

    usrKernelCorePreInit();
    ...
    /* we do not return from usrKernelInit() */
    }
...
void usrRoot
    ...
    char tffsName [16];
#endif
#endif  /* INCLUDE_{TTY_DEV,PC_CONSOLE,STAT_SYM_TBL,ATA,TFFS_MOUNT} */
...
# else	/* INCLUDE_MEM_MGR_FULL */
    memPartLibInit (pMemPoolStart, memPoolSize);
# endif /* INCLUDE_MEM_MGR_FULL */

#ifdef INCLUDE_KERNEL_PROXIMITY_HEAP
    /*
     * Since Kernel System Proximity is included in the system,
     * we need to explictly initialize the Kernel Proximity Heap.
     */
    kProxHeapInit (pMemPoolStart, memPoolSize);
#endif	/* INCLUDE_KERNEL_PROXIMITY_HEAP */
...
#ifdef INCLUDE_KERNEL_COMMON_HEAP
    /*
     * Since Kernel System heap is included in the system,
     * we need to explictly initialize the Kernel Application Heap.
     */
    kCommonHeapInit (KERNEL_COMMON_HEAP_INIT_SIZE, 
                      KERNEL_COMMON_HEAP_INCR_SIZE);
#endif	/* INCLUDE_KERNEL_COMMON_HEAP */

#ifdef INCLUDE_UEFI_BOOT_SUPPORT
    /* MMU enabled; no more UEFI operations on the physMemDesc table */
    uefiMmuNotEnabled=0;
#endif	/* INCLUDE_UEFI_BOOT_SUPPORT */

    /* Kernel object creation routines */
...
#define USER_RESERVED_MEM		0x0  /* default to 0 */
#endif /* !USER_RESERVED_MEM */
#ifndef CLEAR_USER_RESERVED_MEMORY_ON_COLD_BOOT
#define CLEAR_USER_RESERVED_MEMORY_ON_COLD_BOOT   TRUE
#endif /* !CLEAR_USER_RESERVED_MEMORY_ON_COLD_BOOT */
    userReservedMemInit (USER_RESERVED_MEM, 
...
/*
     * Initialize environment variable. putenv() and getenv() now use
     * semaphores for thread saftey, so this library needs to be initialized 
     * before it is called by any other function. (CQ:WIND00194940)
     */
...
#ifdef INCLUDE_BOOT_EDR_SUPPORT
    sysDebugModeSet (FALSE);  /* always run in deployed mode */
#endif
...
#ifdef	INCLUDE_VXDBG
    vxdbgHooksInit ();	/* task hooks for the debug library */
#endif	/* INCLUDE_VXDBG */

#ifdef	INCLUDE_TRIGGERING		/* initialize event triggering */
    trgLibInit ();
#ifdef INCLUDE_SHOW_ROUTINES
    trgShowInit ();			/* event triggering show routine */
#endif	/* INCLUDE_SHOW_ROUTINES */
#endif	/* INCLUDE_TRIGGERING */

#ifdef INCLUDE_SHOW_ROUTINES
    memShowInit ();				/* initialize memShow routine */
    usrKernelCoreShowInit();
#endif	/* INCLUDE_SHOW_ROUTINES */
...
#ifdef INCLUDE_PG_MGR_BASIC
    pgMgrBaseLibInit();
#endif /* INCLUDE_PG_MGR_BASIC */
...
#endif  /* INCLUDE_RTP_SHOW && INCLUDE_SHOW_ROUTINES */
...
#endif /* INCLUDE_ADR_SPACE_SHOW || INCLUDE_SHOW_ROUTINES */
...
#endif  /* INCLUDE_BOOT_APP && INCLUDE_BOOT_ADDMEM */
 ...
 */
  cacheCreateInternalDataRAM((UINT32 *)FD_ORIGIN, FD_NUMLINES);
	...
	for (ix = 0; ix < NUM_TTY; ix++)	/* create serial devices */
		...
		continue;
#endif	/* defined(INCLUDE_WDB) && (WDB_COMM_TYPE == WDB_COMM_SERIAL) */
	    sprintf (tyName, "%s%d", "/tyCo/", ix);
    ...
    jobTaskLibInit (JOB_TASK_STACK_SIZE);
...
#ifdef INCLUDE_MMAP
    mmanLibInit();			/* initialize mmap() support */
#endif	/* INCLUDE_MMAP */
...
#ifdef	INCLUDE_PIPES
    pipeDrv (PIPE_MAX_OPEN_FDS);        /* install pipe driver */
#endif	/* INCLUDE_PIPES */
...
xbdBlkDevLibInit (XBD_BLK_DEV_TASK_PRIORITY,
...
#ifdef	INCLUDE_VXBUS_DISK
    /* create disk drive(s) supported by VxBus disk driver(s) */

    usrVxbDiskDrv ();
#endif	/* INCLUDE_VXBUS_DISK */
    ...
    if (noOfDrives > 0)
        ...
        for (ix = 0; ix < noOfDrives; ix++)
            {
            sprintf (tffsName, "/tffs%d", ix);
            usrTffsConfig (ix, TFFS_REMOVABLE, tffsName);
            }
        }
 ...
 */
    ...
    /*
     * Initialize the system security facility. Note that this
     * component does not depend on the shell nor the network.
     */

    ipcom_usr_create();
    usrSecurity ();
#endif /* !INCLUDE_NETWORK && INCLUDE_SECURITY */
...
#else   /* INCLUDE_NETWORK || INCLUDE_COMMON_NET */
...
#ifdef INCLUDE_USB
    /* initialize asynchronous message library for USB */
    usbMsgAsynLibInit ();
    /* call USB class driver init routine */
    usbHstClassInit ();
#endif

#ifdef INCLUDE_USB_TGT_FUNC_INIT
    usrUsbTgtFuncInit();
#endif

#ifdef INCLUDE_USB_OTG
    usrUsbOtgInit();
#endif /* INCLUDE_USB_OTG */
...
#ifdef INCLUDE_CPU_TURBO
    cpuPwrArchTurboSet ();
#endif

#ifdef INCLUDE_CPU_PERFORMANCE_MGMT 

    perfMgrInit             /* CPU performance management */
        (
        SELECT_PRIORITY_PERF,
        ISR_PSTATE,   
        DEF_PROFILE_INDEX,
        PERF_MGR_PROF0, 
        PERF_MGR_PROF1,
...
#if (defined INCLUDE_CPU_ODG_POLICY_MGMT) && (!defined INCLUDE_BOOT_APP)

    odgPolicyMgrInit        /* CPU Ondemand-Governor policy management */
        (
        ODG_SAMPLE_INTERVAL,
        ODG_LOW_FILTER_INTERVAL,
        ODG_HIGH_FILTER_INTERVAL,
        ODG_SLEEP_FILTER_INTERVAL,
        ODG_LOW_HEADROOM_THRESH,
        ODG_HIGH_HEADROOM_THRESH,
        ODG_LOW_HEADROOM_ALARM_THRESH,
        ODG_IDLE_MAX_INTERRUPTS,
        ODG_SLEEP_HEADROOM,
        ODG_MIN_PSTATE,
        ODG_MAX_PSTATE,
        ODG_DAEMON_PRIORITY
...
#ifdef INCLUDE_CPU_LIGHT_PWR_MGR
    cpuPwrLightMgrInit ();  /* lightweight power management (idle-halt) */
    cpuPwrMgrEnable (TRUE);
#endif /* INCLUDE_CPU_LIGHT_PWR_MGR */

#ifdef INCLUDE_DEV_PWR_MGMT  
    pwrDeviceLibStart (TRUE);                 /* device power management */
#endif /* INCLUDE_DEV_PWR_MGMT */
...
#endif	/* INCLUDE_CTORS_DTORS */
#endif	/* INCLUDE_CPLUS || INCLUDE_CPLUS_MIN */
...
/* If WindView included, must have a timestamp of some sort */
    ...
    /* initialize the VxWorks debug library */

#ifdef	INCLUDE_VXDBG
    usrVxdbgInit (VXDBG_EVT_TASK_PRIORITY,
    			VXDBG_EVT_TASK_OPTIONS, VXDBG_EVT_TASK_STACK_SIZE);
#endif	/* INCLUDE_VXDBG */
...
# undef INCLUDE_SNS_MP_RTP
    salSnsRtpInit ();
#endif	/* INCLUDE_SNS_RTP */

#ifdef INCLUDE_SNS_MP
# undef INCLUDE_SNS_MP_RTP
    salSnsTaskInit ();
#endif	/* INCLUDE_SNS_MP */
...
#if (!defined(INCLUDE_SHELL_EMACS_MODE) && !defined(INCLUDE_SHELL_VI_MODE)) \
    || defined (INCLUDE_SHELL_VI_MODE)
    /*
...
#endif	/* INCLUDE_HISTORY_FILE_SHELL_CMD */
...
#endif	/* INCLUDE_DEMO */			/* mips cpp no elif */
    ...
    bootAppInit (FALSE, BOOT_DISABLE_MMU_BEFORE_ENTRY);
#elif defined(INCLUDE_BOOT_DELAYED_INIT)
    bootAppInit (TRUE, BOOT_DISABLE_MMU_BEFORE_ENTRY);
#endif	/* INCLUDE_BOOT_INIT, INCLUDE_BOOT_DELAYED_INIT */
#ifdef INCLUDE_ELF
    bootElfInit ();
#endif	/* INCLUDE_ELF */
    ...
    bootAppShellInit ();
#ifdef INCLUDE_BOOT_MEM_CMDS
    bootAppMemInit ((void *)LOCAL_MEM_LOCAL_ADRS);
#endif	/* INCLUDE_BOOT_MEM_CMDS */
#ifdef INCLUDE_BOOT_EDR_SUPPORT
    bootAppEdrInit ();
#endif	/* INCLUDE_BOOT_EDR_SUPPORT */
...
#endif	/* INCLUDE_BOOT_FD_LOADER */
#ifdef INCLUDE_BOOT_USB_FS_LOADER
    bootUsbFsLoadInit (BOOT_USB_OPEN_ATTEMPTS, BOOT_USB_ATTEMPT_DELAY, BULK_DRIVE_NAME);
#endif	/* INCLUDE_BOOT_USB_FS_LOADER */
#ifdef INCLUDE_BOOT_TSFS_LOADER
    bootTsfsLoadInit ();
#endif	/* INCLUDE_BOOT_TSFS_LOADER */
...
#if defined(INCLUDE_BOOT_GO_OVERRIDE) && \
    defined(BOOT_GO_OVERRIDE_FUNCTION)
    bootGoOverrideFuncAdd ((void *)BOOT_GO_OVERRIDE_FUNCTION);
#endif /* INCLUDE_BOOT_GO_OVERRIDE && BOOT_GO_OVERRIDE_FUNCTION */
...
#ifdef INCLUDE_ACPI_BOOT_OP
    bootCommandHandlerAdd("vxMpTablePrint", vxMpTablePrint, 
      BOOT_CMD_MATCH_STRICT,
			  "vxMpTablePrint",
			  "- print vx MP table code fragment");
#endif  /* INCLUDE_ACPI_BOOT_OP */

#if (defined INCLUDE_MPAPIC_DEBUG) && (defined INCLUDE_USR_MPAPIC)
    void vxbMpBiosShow (void);
    bootCommandHandlerAdd("vxbMpBiosShow", vxbMpBiosShow, 
      BOOT_CMD_MATCH_STRICT,
     "vxbMpBiosShow",  "- show vx MP table");    
#endif	/* INCLUDE_MPAPIC_DEBUG && INCLUDE_USR_MPAPIC */
...
void usrDemo (void)
	...
	{
	    printf ("WARNING - UEFI data block at 0x%X "
		    "has invalid header size of %u\n",
				pSysUefiMemAddr, pSysUefiMemAddr->HeaderSize );
	}
    else if (pSysUefiMemAddr->PhysMemoryMapBuffer
	     != (EFI_PHYSICAL_ADDRESS) (int)pSysUefiMemAddr)
	{
	    printf ("WARNING - UEFI data block at 0x%X, "
		    "but table value is 0x%lX",
