...
--------------------
03r,09aug12,rjq  move IPNET_MAX_SOCK from VIP to VSB config for WIND00363851.
03q,24apr12,xhs  Fox for WIND00346638.
03p,07dec11,xhs  Support drop hostroute for RIPv2
03o,27oct11,rjq  Added FTPC_BIND_ADDRESS
03n,27may11,rjq  Fix for WIND00277167.
03m,07jan11,hfc  fix for defect WIND00248902
03l,15dec10,sic  Removed IPTCP defines
03k,18oct10,ggz  Change values for IPCOM_AUTH_HASH_HOOK and
                 IPCOM_AUTH_HASH_HOOK_DIGEST
03j,30sep10,uol  Add TCP_PERSIST_TMO.
03i,19Aug10.ggz  Added IPCOM_AUTH_HASH_HOOK_DIGEST and password salt
03h,25jun10,rjq  Add INCLUDE_IPNTP
03f,22jan10,dlk  Add IPNET_MEMORY_LIMIT and IPNET_MAX_REASSEMBLY_LIST_LEN.
03g,11dec09,rjq  Fix for defect WIND00185613 
03f,27nov09,uol  Fixed WIND00159634: INCLUDE_PTYDRV must be included when
                 INCLUDE_IPTELNETS is selected. CQID: WIND00192381.
...
#define IPCOM_AUTH_HASH_HOOK     ipcom_auth_default_hash_rtn  /* Custom hash routine */
#endif

#ifndef IPCOM_AUTH_HASH_HOOK_DIGEST
#define IPCOM_AUTH_HASH_HOOK_DIGEST   32     /* Digest length of custom hash routine */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD1_SALT
#define AUTH_USER_PASSWD1_SALT   NULL  /* Salt for password #1 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD2_SALT
#define AUTH_USER_PASSWD2_SALT   NULL  /* Salt for password #2 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD3_SALT
#define AUTH_USER_PASSWD3_SALT   NULL  /* Salt for password #3 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD4_SALT
#define AUTH_USER_PASSWD4_SALT   NULL  /* Salt for password #4 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD5_SALT
#define AUTH_USER_PASSWD5_SALT   NULL  /* Salt for password #5 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD6_SALT
#define AUTH_USER_PASSWD6_SALT   NULL  /* Salt for password #6 */
#endif
...
#define INET_MIN_MTU_SIZE                  576  /* Minimum mtu size */
#endif
...
#ifndef RLOGIN_MAXCLIENTS
#define RLOGIN_MAXCLIENTS        2  /* Default limit for simultaneous sessions */
#endif
#endif

#ifdef INCLUDE_IPFTPC
#ifndef FTPC_BIND_ADDRESS
#define FTPC_BIND_ADDRESS         NULL  /* FTP client bind address */
#endif
#endif /* INCLUDE_IPFTPC */
 ...
 * specified, internal authenticaion callback routine will be used. 
 */
...
#define INCLUDE_PTYDRV                   /* telnet server requires pty driver */
#endif
...
#ifdef INCLUDE_IPNTP
#ifndef NTP_CONFIG_PARAM
#define NTP_CONFIG_PARAM           "server	127.127.1.0;fudge 127.127.1.0 stratum 10;disable auth"
#endif
#ifndef NTP_INIT_PARAM
#define NTP_INIT_PARAM             NULL
#endif
#ifndef NTP_CONFIG_FILENAME
#define NTP_CONFIG_FILENAME        NULL  /* NTP config filename */
#endif
#endif /* INCLUDE_IPNTP */
...
#endif
#ifndef IPRIP_DROP_HOSTROUTE
#define IPRIP_DROP_HOSTROUTE      "0"    /* Drop host route */
#endif
#endif /* INCLUDE_IPRIP */
...
#ifndef IPRIP_IFCONFIG_3
#define IPRIP_IFCONFIG_3                    NULL
#endif
#endif /* INCLUDE_IPRIP_IFCONFIG_3 */

#ifdef INCLUDE_IPRIP_IFCONFIG_4
#ifndef IPRIP_IFCONFIG_4
#define IPRIP_IFCONFIG_4                    NULL
#endif
