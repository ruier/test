...
--------------------
01y,07mar13,y_y  update BSP_REV.
01x,27jun12,l_z  Merge AMP support
 ...
 * LEGACY_AMP
 *
 * For AMP support, low memory offset mode must be enabled on
...
/* Shared memory is set up for LEGACY_AMP not RAPIDIO */
