...
doCcsr:
	...
	isync
	sync
	lis     r6,HI(0x000f8000)
	ori     r6,r6,LO(0x000f8000)
	stw     r6, 0(r7)
	isync
	sync
...
ccsrbarWait:
	...
	WRITEADR(r6,r7,M85XX_LAWAR0(CCSBAR),
		 LAWAR_ENABLE | LAWAR_TGTIF_LBC | LAWAR_SIZE_512MB )
	...
	/* load OR2 */
	WRITEADR(r6,r7,M85XX_OR2 (CCSBAR),0xFFF06E65)
	isync
	sync
	eieio
	isync
	/* load BR1 */
	WRITEADR(r6,r7,M85XX_BR1 (CCSBAR),0xF0000801)
	/* load OR1 */
	WRITEADR(r6,r7,M85XX_OR1 (CCSBAR),0xFFFF6E65)
	isync
	sync
	eieio
	isync
	...
	/* load OR0 */
	WRITEADR(r6,r7,M85XX_OR0 (CCSBAR),0xFF006E65)
	isync
	sync
	eieio
	...
	li      r4,0x2000
	mtctr   r4
	WRITEADR(r6,r7,M85XX_LCRR(CCSBAR),0x80000004)
	isync
	sync
	eieio
dllDelay4:
	...
	WRITEADR(r6,r7,M85XX_LAWAR1(CCSBAR),
		 LAWAR_ENABLE | LAWAR_TGTIF_DDR1 | LAWAR_SIZE_256MB )
...
ddrDelay:
	...
	WRITEADR(r6,r7,M85XX_LAWBAR2(CCSBAR),
		 0x10000000 >> LAWBAR_ADRS_SHIFT)

	WRITEADR(r6,r7,M85XX_LAWAR2(CCSBAR),
		 LAWAR_ENABLE | LAWAR_TGTIF_DDR2| LAWAR_SIZE_256MB )
	...
	WRITEOFFSET(r6,r7,(CS0_BNDS), 0x0010001F)
	WRITEOFFSET(r6,r7,(CS1_BNDS), 0x00000000)
	WRITEOFFSET(r6,r7,(CS2_BNDS), 0x00000000)
	WRITEOFFSET(r6,r7,(CS3_BNDS), 0x00000000)
	WRITEOFFSET(r6,r7,(CS0_CONFIG), 0x80010102)
