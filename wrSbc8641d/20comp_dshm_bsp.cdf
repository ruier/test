...
--------------------
01j,11oct07,mze  change references to hpcNet to wrSbc WIND00104857
01i,29aug07,mze  re-added SOURCE_ONLY option to fix GNU compiler issue
...
Component INCLUDE_DSHM_BUS_CTLR_8641 {
    NAME        wrSbc8641d - DSHM virtual bus controller for wrSbc8641d
...
Parameter DSHM_SM_POOL_BASE {
    ...
    SYNOPSIS    The base address on the wrSbc8641d is at 0x10010000. The \
shared memory extends up to 0x10100000. Both SM and DSHM must share that \
...
Component INCLUDE_DSHM_VX8641 {
    NAME        wrSbc8641d - Peer driver
    SYNOPSIS    Peer-to-peer driver for wrSbc8641d
