/* p10xxrdb.h - Freescale P10xxRDB board header */
...
01b,09aug12,syt  added support for P1021RDB
01a,19jun12,syt  derived from version 01d of fsl_p1020_rdb/p1020rdb.h
*/

/*
 * This file contains I/O addresses and related constants for the
 * Freescale P10xxRDB board.
*/

#ifndef __INCp10xxrdbh
#define __INCp10xxrdbh
...
#define CCSBAR_RESET_DEFAULT    0xff700000
#define CCSBAR_RESET_P1023      0xff600000
#define CCSBAR                  0xff600000
#define CCSR_SIZE               0x00200000
...
#define FREQ_64_MHZ             64000000
#define FREQ_66_MHZ             66666600
#define FREQ_50_MHZ             50000000
#define FREQ_267_MHZ            266666667
#define FREQ_333_MHZ            333333000
#define FREQ_400_MHZ            400000000

#define SYS_CLK_FREQ            FREQ_66_MHZ
#define SYS_CLK_FREQ_P1023      FREQ_64_MHZ
#define DDR_CLK_FREQ            FREQ_66_MHZ
#define DEFAULT_SYSCLKFREQ      FREQ_267_MHZ

/* Clock rates */

#define SYS_CLK_RATE_MIN        1       /* minimum system clock rate */
#define SYS_CLK_RATE_MAX        8000    /* maximum system clock rate */
#define P1025RDB_FIT_CLK_RATE_MIN       (FREQ_267_MHZ / (1 << 24))
#define P1025RDB_FIT_CLK_RATE_MAX       (FREQ_267_MHZ / (1 << 13))
#define P1024RDB_FIT_CLK_RATE_MIN       (FREQ_267_MHZ / (1 << 24))
#define P1024RDB_FIT_CLK_RATE_MAX       (FREQ_267_MHZ / (1 << 13))
#define P1021RDB_FIT_CLK_RATE_MIN       (FREQ_400_MHZ / (1 << 24))
#define P1021RDB_FIT_CLK_RATE_MAX       (FREQ_400_MHZ / (1 << 13))
#define P1023RDB_FIT_CLK_RATE_MIN       (FREQ_333_MHZ / (1 << 24))
#define P1023RDB_FIT_CLK_RATE_MAX       (FREQ_333_MHZ / (1 << 13))

#define P1025RDB_WDT_RATE_MIN           (FREQ_267_MHZ / (1 << 29))
#define P1025RDB_WDT_RATE_MAX           (FREQ_267_MHZ / (1 << 21))
...
#define FSL_ENET0               0x00  /* WR specific portion of MAC (MSB->LSB) */
#define FSL_ENET1               0x04
#define FSL_ENET2               0x9F
#define CUST_ENET3              0x01
#define CUST_ENET4              0xEA
#define CUST_ENET5_0            0x9F
#define CUST_ENET5_1            0xA0
#define CUST_ENET5_2            0xA1
#define CUST_ENET5_3            0xA2
#define CUST_ENET5_4            0xA3
#define CUST_ENET5_5            0xA4
#define CUST_ENET5_6            0xA5
 ...
 * 0   Enable window
 * 1-7 Reserved
 * 8-11 Target interface - 0000 Reserved
 *                       - 0001 PCIEX2
 *                       - 0010 PCIEX1
 *                       - 0011 Reserved
 *                       - 0011 Reserved
...
#define PCIEX3_LAW_BASE             0xb0000000          /* PCI LAW window */
...
#define EPIC_QMAN_PORTAL0_INT_VEC       25
#define EPIC_QMAN_PORTAL1_INT_VEC       27
#define EPIC_QMAN_PORTAL2_INT_VEC       29

#define EPIC_BMAN_PORTAL0_INT_VEC       26
#define EPIC_BMAN_PORTAL1_INT_VEC       28
#define EPIC_BMAN_PORTAL2_INT_VEC       30
...
#define VSC7385_BASE                    0xf4000000
...
/* GUTS_PMUXCR register bit defines */
...
#define CPLD_REV_MAJOR(base)            (CAST(VUINT8 *)((base) + 0x00))
#define PCBA_REV(base)                  (CAST(VUINT8 *)((base) + 0x01))
#define WD_CFG(base)                    (CAST(VUINT8 *)((base) + 0x02))
#define RST_BPS_SW(base)                (CAST(VUINT8 *)((base) + 0x03))
#define LOAD_DEFAULT_N(base)            (CAST(VUINT8 *)((base) + 0x04))
#define RST_BPS_WD(base)                (CAST(VUINT8 *)((base) + 0x05))
#define BYPASS_ENABLE(base)             (CAST(VUINT8 *)((base) + 0x06))
#define BPS_LED(base)                   (CAST(VUINT8 *)((base) + 0x07))
#define STATUS_LED(base)                (CAST(VUINT8 *)((base) + 0x08))
#define FXO_LED(base)                   (CAST(VUINT8 *)((base) + 0x09))
#define FXS_LED(base)                   (CAST(VUINT8 *)((base) + 0x0a))
#define SYSTEM_RST(base)                (CAST(VUINT8 *)((base) + 0x0d))
#define BPS_OUT(base)                   (CAST(VUINT8 *)((base) + 0x0e))
#define CPLD_REV_MINOR(base)            (CAST(VUINT8 *)((base) + 0x12))
...
#define QMAN_BMAN_RESERVED_MEM           0x00400000
#define QMAN_MEM_BASE                    (PHYS_MEM_START + PHYS_MEM_SIZE_P1023 \
                                          - QMAN_BMAN_RESERVED_MEM)
#define BMAN_MEM_BASE                    (PHYS_MEM_START + PHYS_MEM_SIZE_P1023 \
                                          - 0x00200000)

#define DTSEC0_PHY_ADDR                  0x1
#define DTSEC1_PHY_ADDR                  0x2

#define MPC85xx_PMUXCR_DTSEC1_1          0x10000000
